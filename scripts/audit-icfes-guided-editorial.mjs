...
check('confirmed-critical-keys', 'Las claves críticas de los mocks publicados permanecen corregidas', criticalKeyFailures.length === 0, 'critical', criticalKeyFailures.map(([id]) => id).join(', ') || '4/4', 'Restaurar las correcciones confirmadas por doble revisión.');
