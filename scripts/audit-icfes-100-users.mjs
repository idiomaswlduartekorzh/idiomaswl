...
check('attributed-practice-truth', 'Las muestras atribuidas declaran procedencia y alcance histórico', source.workbookGuided.includes('Muestra histórica atribuida') && source.workbookGuided.includes('elaboración editorial de Idiomas WeLearn') && source.workbookGuided.includes('predice un puntaje oficial') && source.workbookGuided.includes('no implica afiliación o aval'), 'critical', 'Atribución, autoría de explicación y límites visibles', 'Separar el banco atribuido y la explicación propia.');
