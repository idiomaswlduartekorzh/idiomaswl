...
check('inventory-language', 'La portada diferencia recursos únicos de modos', mockGrid.includes('34 recursos distintos') && mockGrid.includes('62 rutas o modos de uso, pero no 62 exámenes diferentes') && examGuide.includes('Por qué ves 62 rutas, pero solo 34 recursos'), 'critical', '34 recursos = 23 propios + 10 atribuidos + 1 guiado; 62 modos', 'No contar modos como exámenes distintos.');
