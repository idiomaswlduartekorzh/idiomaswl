...
check('metadata-truth', 'La portada de cuadernillos comunica alcance real', workbookCatalogPage.includes('cinco muestras tienen 145 explicaciones guiadas') && !workbookCatalogPage.includes('análisis guiado en el cuadernillo 2023'), 'high', '145 explicaciones en cinco muestras', 'Actualizar snippets cuando cambie el inventario.');
