...
test('Set 1 old tabs fail closed; historical W/S remains reviewable', () => {
  ...
  assert.equal(isIeltsSubmissionVersionCurrent('set-2','ielts-set-2-v2'),false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-2',null),false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-2','ielts-set-2-v3'),true);
  assert.deepEqual(getIeltsReviewBlueprint('set-2').reviewableContentVersions, ['ielts-set-2-v1', 'ielts-set-2-v2', 'ielts-set-2-v3']);
  ...
  assert.deepEqual(getIeltsReviewBlueprint('set-5').reviewableContentVersions, ['ielts-set-5-v1', 'ielts-set-5-v2', 'ielts-set-5-v3']);
  ...
  assert.equal(isIeltsSubmissionVersionCurrent('set-8', null), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-8', 'ielts-set-8-v1'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-8', 'ielts-set-8-v2'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-8').reviewableContentVersions, ['ielts-set-8-v1', 'ielts-set-8-v2']);
  assert.equal(isIeltsSubmissionVersionCurrent('set-9', 'ielts-set-9-v2'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-9', 'ielts-set-9-v3'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-9').reviewableContentVersions, ['ielts-set-9-v1', 'ielts-set-9-v2', 'ielts-set-9-v3']);
  assert.equal(isIeltsSubmissionVersionCurrent('set-10', 'ielts-set-10-v2'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-10', 'ielts-set-10-v3'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-10').reviewableContentVersions, ['ielts-set-10-v1', 'ielts-set-10-v2', 'ielts-set-10-v3']);
  assert.equal(isIeltsSubmissionVersionCurrent('set-11', 'ielts-set-11-v2'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-11', 'ielts-set-11-v3'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-11').reviewableContentVersions, ['ielts-set-11-v1', 'ielts-set-11-v2', 'ielts-set-11-v3']);
  assert.equal(isIeltsSubmissionVersionCurrent('set-12', 'ielts-set-12-v2'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-12', 'ielts-set-12-v3'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-12').reviewableContentVersions, ['ielts-set-12-v1', 'ielts-set-12-v2', 'ielts-set-12-v3']);
  assert.equal(isIeltsSubmissionVersionCurrent('set-13', 'ielts-set-13-v1'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-13', 'ielts-set-13-v2'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-13').reviewableContentVersions, ['ielts-set-13-v1', 'ielts-set-13-v2']);
  assert.equal(isIeltsSubmissionVersionCurrent('set-14', 'ielts-set-14-v1'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-14', 'ielts-set-14-v2'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-14').reviewableContentVersions, ['ielts-set-14-v1', 'ielts-set-14-v2']);
  assert.equal(isIeltsSubmissionVersionCurrent('set-15', 'ielts-set-15-v1'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-15', 'ielts-set-15-v2'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-15').reviewableContentVersions, ['ielts-set-15-v1', 'ielts-set-15-v2']);
  assert.equal(isIeltsSubmissionVersionCurrent('set-16', 'ielts-set-16-v2'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-16', 'ielts-set-16-v3'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-16').reviewableContentVersions, ['ielts-set-16-v1', 'ielts-set-16-v2', 'ielts-set-16-v3']);
  assert.equal(isIeltsSubmissionVersionCurrent('set-17', 'ielts-set-17-v1'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-17', 'ielts-set-17-v2'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-17').reviewableContentVersions, ['ielts-set-17-v1', 'ielts-set-17-v2']);
  assert.equal(isIeltsSubmissionVersionCurrent('set-18', 'ielts-set-18-v1'), false);
  assert.equal(isIeltsSubmissionVersionCurrent('set-18', 'ielts-set-18-v2'), true);
  assert.deepEqual(getIeltsReviewBlueprint('set-18').reviewableContentVersions, ['ielts-set-18-v1', 'ielts-set-18-v2']);
