...
test('31 available resources produce 56 routes or modes while held drafts stay hidden', () => {
  ...
  assert.match(grid, /\{icfesModes\} rutas o modos de uso, pero no \{icfesModes\} exámenes diferentes/);
