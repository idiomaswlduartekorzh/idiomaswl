...
test('all 20 Listening papers preserve authored evidence and pin the timing-density reference', async () => {
  ...
  for (let setNumber = 1; setNumber <= 20; setNumber += 1) {
    ...
    assert.ok(listeningWords >= 2800, `${mock.id} Listening density`);
