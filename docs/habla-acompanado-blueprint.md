...
Estado: **motor, Inglés completo y A2 de Coreano, Francés, Italiano, Portugués, Alemán, Ruso y Japonés integrados el 25 de agosto de 2026.**
El registro vivo sirve 200 escenarios, 400 fichas separadas, diez cajas propias, rutas
estáticas por rol y guardián estructural. La fase 2 quedó completa; la fase 3 continúa con A1.
...
| **Habla acompañada** | **Otra persona real**: un compañero, el profesor, un amigo, la pareja. | 200 de 480 escenarios publicados; meta cerrada en §1.1 |
...
| Japonés | `japones` | 20 | 20 | 20 | 60 | 20 | 40 |
| **Total** | — | **160** | **160** | **160** | **480** | **200** | **280** |
