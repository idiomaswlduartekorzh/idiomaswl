...
David confirmó que José David Duarte Silva, C.C. 1.098.685.591, y Zhanna Korzh, C.E. 480.406, ofrecen las clases como independientes bajo la marca WeLearn. Indicó `david_duarte182@hotmail.com` para notificaciones; ese correo quedó también como canal de solicitudes relacionadas con la inscripción, el pago o el curso. Falta confirmar el domicilio contractual y definir quién actúa como responsable del tratamiento de datos. La web ya publica Calle 47 # 29-33, Sotomayor, Bucaramanga, `info@idiomaswl.com` y +57 300 500 4253, pero no se presume que esos datos sean el domicilio y canal legal sin confirmación.
...
| Horario después del pago | Dar salida expresa si no se acuerda: devolución completa antes de iniciar. Falta aprobar esta propuesta y fijar el plazo operativo de coordinación. |
...
- `/reglamento` y panel desplegable antes de aceptar: borrador explícito, texto legible y opción del navegador para guardar/imprimir.
...
- El cobro de los planes nuevos queda desactivado mientras falten datos y reglas. No se modifica el reglamento original ni se habilita el borrador en producción.

## Antes de activar

Confirmar domicilio contractual y responsable del tratamiento, resolver el plazo para acordar horario, establecer atención y devolución con radicado consultable, comprobar autorización de menores y confirmar el alcance de certificados. Recomendada revisión de abogado colombiano del texto final, especialmente responsabilidad conjunta de los independientes, cancelaciones y datos de menores. No se ha enviado el documento a ningún tercero.
