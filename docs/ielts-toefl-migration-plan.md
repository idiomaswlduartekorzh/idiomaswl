...
Current status: the IELTS Reading skills hub is live as the cluster index with official-format vs WeLearn-strategy guidance, recommended study order, FAQ schema and skill-to-question transfer links. Skimming, Scanning, Paraphrase Recognition, Inference and Word-limit control now implement the complete practice blueprint: explicit decisions, held-back independent passages, six-level local Progress Engines, source boundaries, draft persistence and error review. Time management remains on the earlier guided-practice contract and must be migrated next without losing its existing source and review gates. These pages include a direct answer, official-format vs WeLearn-strategy note, guided practice, independent practice, answers/explanations, common mistakes/checklists, FAQs, next lessons and internal links back to IELTS Reading and official task-type pages.
