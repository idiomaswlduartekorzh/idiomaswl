...
Current status: the IELTS Reading skills hub is live as the cluster index with official-format vs WeLearn-strategy guidance, recommended study order, FAQ schema and skill-to-question transfer links. Skimming and Scanning now implement the complete practice blueprint: explicit decisions, held-back independent passages, six-level local Progress Engines, source boundaries, draft persistence and error review. Inference, paraphrase recognition, word-limit control and time management remain earlier guided-practice implementations and must be migrated one at a time without losing their existing source and review gates. These pages include a direct answer, official-format vs WeLearn-strategy note, guided practice, independent practice, answers/explanations, common mistakes/checklists, FAQs, next lessons and internal links back to IELTS Reading and official task-type pages.
