...
**Palabra que se examina**: **stood**, en «The bakery stood at the top of the hill».

> ⚠️ **Corrección (19 ago 2026, cuarta versión).** Antes fueron *carried* (v1 y v2) y *called* (v3), y las tres se cayeron por lo mismo, que es lo que recoge R1 del blueprint §4 bis: en ese hueco las acepciones candidatas no comparten régimen. Con *carried* solo caben dos familias intransitivas; con *called*, detrás del verbo va una subordinada con *that* y dos opciones de manual —*named*, *summoned*— exigen sintagma nominal, así que se podaban sin leer una línea del pasaje. **Con *stood* sí lo comparten**: las cuatro opciones son verbos intransitivos con complemento de lugar y las cuatro producen oración gramatical al sustituir —«The bakery towered / ranked / remained / perched at the top of the hill»—. El texto no se tocó: la palabra ya estaba dentro, en la primera oración. *carried* y *called* siguen ahí como prosa, y «Her voice carried farther than the bell did» es justamente lo que deja sin apoyo la lectura de altura.

**Cómo lo fija el contexto**: Sentido: «estar situado». La oración que la contiene da el lugar y el pasaje entero vive de ese lugar —desde la puerta se ve «the whole town», las familias de «the lanes below» no ven la panadería, y para llegar «they started up the hill»—. Lo que el texto **nunca** da es lo que necesitaría cada una de las otras tres acepciones: altura o volumen del edificio (*towered*), una escala o un grupo con el que compararlo (*ranked*), y un tramo de tiempo o una amenaza que sortear (*remained*), porque su único reloj es «Each morning at six», la rutina de un día.

> ⚠️ **Nota de diseño (19 ago 2026).** Este apartado presentaba antes la poda por complemento como la virtud del ítem, y era su defecto: se podía hacer conociendo la palabra, sin mirar el pasaje, que es lo que castiga la puerta 6. La versión actual copia la forma de q01: cuatro verbos del mismo régimen, ninguno descartable por sintaxis, y el pasaje decidiendo cuál. Las cuatro opciones miden además 6-8 letras, así que tampoco hay pista de longitud, y la clave no es la más larga.
