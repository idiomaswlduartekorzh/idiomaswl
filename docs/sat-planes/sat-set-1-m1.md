...
| 3 | q03 | CS | words-in-context | historia | 2 | A | **Palabra examinada: `cloudy`** (era *qualified*; cambiada el 19 ago 2026 tras medirla en 12/16). Con *qualified* fallaban dos reglas: dos opciones no eran acepciones del lema —se podaban sabiendo inglés— y entre las dos restantes, *conditional* es la glosa canónica de *qualified support*. Con `cloudy` las cuatro son acepciones reales (cielo · veteado · turbio · confuso) y la que «suena a examen» —la figurada— es un distractor. La pista no está una oración antes: está en de qué sustantivo cuelga el adjetivo y en la lógica del párrafo. |
| 4 | q04 | CS | words-in-context | humanidades | 3 | C | **Palabra examinada: `state`** (era *economy*; cambiada el 19 ago 2026 tras tres mediciones). Con *economy* la fuga era irreducible: su glosa de examen —«parquedad»— **es** la clave, así que el estudiante entrenado la marca sin leer. Con *state*, tres de las cuatro opciones son glosas de diccionario del verbo y la clave NO lo es: solo sirve porque el párrafo habla de marcas que se retiran. Es la receta de q01 y q02, los dos que cayeron a 0/8. |
