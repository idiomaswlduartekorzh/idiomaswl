...
Set 3 avanzó después a v2: Reading se amplió dentro de sus secciones temáticas. Ruta de la Seda presenta una red descentralizada, matiza los relatos de los monjes y la peste y explica cómo se reconstruye la evidencia histórica. Plástico oceánico sustituye la cifra anual no delimitada de ocho millones por la estimación OECD de 2019; Q19 cambia a `1.7` y el texto diferencia detección, exposición y daño demostrado. IA médica limita las comparaciones con especialistas a tareas concretas, incorpora validación externa, cambio de distribución, sesgo de automatización, flujo clínico y gobernanza OMS; Q36 evalúa directamente el sesgo codificado. El MP3 ajeno sigue siendo un bloqueo crítico y debe reemplazarse y alinearse de Q1 a Q40.
