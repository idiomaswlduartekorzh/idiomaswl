...
El gate `geo-aeo-ai` evalúa condiciones controlables del snapshot, no la decisión de un buscador o modelo externo. Para pasar exige:

1. una respuesta inicial visible y directa que describa qué es la práctica y qué resultado entrega;
2. procedencia, autoría, método y límites visibles, incluida la ausencia de afiliación o predicción oficial;
3. paridad entre el contenido visible, metadata, FAQ y cualquier dato estructurado;
4. exclusión de runners privados, respuestas, rationales y feedback pago de sitemap, indexación y payload anónimo;
5. afirmaciones de descubrimiento sustentadas solo en mediciones fechadas.

Se bloquea ante falsa atribución, claims sin fuente, datos estructurados invisibles o divergentes, filtración de contenido privado o frases que garanticen posición, indexación, citación o inclusión en respuestas generativas. Un `PASS` local acredita el contrato técnico; no predice que Google, Bing, ChatGPT u otro sistema vaya a mostrar o citar una página.
...
| Referencias observadas desde motores de respuesta o asistentes | pendiente | — | — | — | Registrar fuente y fecha; ausencia o presencia no equivale a garantía futura. |
| Leads tras terminar un simulacro | pendiente | — | — | — | Medir por sesión y excluir pruebas internas. |
| Compras de detalle de COP 12.900 | 0 | — | — | — | Solo después de habilitar pagos de forma autorizada. |
| Membresías de COP 49.900 | 0 | — | — | — | Atribuir el primer contacto y la conversión final. |
| Membresías de COP 99.900 | 0 | — | — | — | Separar ventas de capacidad disponible para aprobación humana del feedback asistido. |
...
- **Detener el experimento comercial:** una respuesta privada se indexa, una
  atribución sugiere afiliación oficial, el checkout concede acceso incorrecto,
  el copy omite la asistencia de IA o atribuye autoría a un docente, o se vende
  feedback asistido sin capacidad reservada ni evidencia de aprobación humana.
