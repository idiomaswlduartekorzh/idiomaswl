...
titleEs: La heurística del afecto
titleEn: When feelings become evidence
collection: Juicio y decisión
...
> Emotions make us irrational; good decisions are purely logical.

### Afirmación defendible

Las reacciones afectivas pueden hacer el juicio más rápido y, en ciertos contextos, útil. También
pueden funcionar como una fuente común para estimar riesgo y beneficio, incluso cuando esas dos
variables deberían evaluarse por separado. El efecto depende de la tarea, la información y la
presión temporal; no significa que toda emoción sea un error.

### Objetivos

Al terminar, el estudiante podrá:

1. explicar `affect` y `affect heuristic` sin reducirlos a “emotion is bad”;
2. distinguir sentimiento, riesgo percibido y riesgo medido;
3. reconocer cómo el formato de una estadística puede evocar imágenes diferentes;
...
> about benefits, examples come easily. When asked about risks, they feel remote. Another company
> produces the opposite reaction: its name is linked to an accident you remember vividly, so its
> risks feel large and its benefits seem doubtful. In both cases, one emotional evaluation may be
> answering two different questions.
>
> Researchers call this the affect heuristic. Affect is the quick sense that something is good or
> bad. That sense can help us respond efficiently when time is limited, but it can also become a
> common shortcut for judging both risk and benefit. Experiments have found that the inverse
> relationship between perceived risk and perceived benefit becomes stronger under time pressure.
...
|---|---|---|---|
| AH-01 | Las evaluaciones afectivas pueden guiar juicios de riesgo y beneficio. | supported | Finucane et al. (2000) |
| AH-02 | La presión temporal puede fortalecer la relación inversa entre riesgo y beneficio percibidos. | supported | Finucane et al. (2000) |
| AH-03 | Frecuencia y probabilidad equivalentes pueden generar reacciones distintas. | supported | Slovic, Monahan & MacGregor (2000) |
...
- Slovic, P., Monahan, J., & MacGregor, D. G. (2000).
  [Violence risk assessment and risk communication](https://doi.org/10.1023/A:1005595519944).
- Slovic, P., Finucane, M. L., Peters, E., & MacGregor, D. G. (2007).
  [The affect heuristic](https://doi.org/10.1016/j.ejor.2005.04.006).
- Zajonc, R. B. (1980).
...
editorialRisk: high
centralQuestion: Can generosity remain a virtue if it destroys the giver's capacity to act?
sourceStatus: author and original work still need confirmation
```

Tesis aprovechable del fragmento:

- la fuerza es capacidad efectiva;
- la firmeza dirige esa capacidad a preservar la propia agencia;
- la generosidad la dirige a ayudar a otros;
- la intención generosa sin posibilidad de efecto no basta para la tesis del texto.

Tensiones que la lectura debe examinar:

1. ¿Toda ayuda debe ser efectiva para ser virtuosa?
2. ¿Cómo se diferencia firmeza de egoísmo o rigidez?
3. ¿Cómo se diferencia generosidad de autosacrificio y complacencia?
4. ¿Quién define “ayuda” y “mejora”?
5. ¿Puede una persona proteger su capacidad y seguir respondiendo a necesidades ajenas?
