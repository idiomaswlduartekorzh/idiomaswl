...
export const alt = 'Clases de Francés Online — Preparación DELF/DALF | WeLearn';
...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Glows */}
        <div style={{ position: 'absolute', top: -80, left: '20%', width: 500, height: 400, borderRadius: '50%', background: '#1a2ecc', opacity: 0.12, filter: 'blur(100px)' }} />
        <div style={{ position: 'absolute', bottom: -60, right: -60, width: 380, height: 380, borderRadius: '50%', background: '#1a2ecc', opacity: 0.08, filter: 'blur(80px)' }} />
        ...
        <div style={{ display: 'flex', gap: 12, marginBottom: 32, alignItems: 'center' }}>
          ...
          <div style={{ background: 'rgba(79,111,255,0.12)', border: '1px solid rgba(79,111,255,0.25)', color: '#7b93ff', fontSize: 13, fontWeight: 700, padding: '5px 14px', borderRadius: 999 }}>
            FRANCÉS ONLINE · PREPARACIÓN DELF/DALF
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 10, marginBottom: 28 }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: 15, fontWeight: 700, color: '#7b93ff' }}>DELF · DALF</span>
          </div>
        </div>
