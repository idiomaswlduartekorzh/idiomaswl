            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '1rem' }}>
              {[...BLOG_POSTS]
                ...
                .map(post => (
                  ...
                  >
                    <span style={{ display: 'inline-block', fontSize: '0.68rem', fontWeight: 800, letterSpacing: '0.06em', textTransform: 'uppercase', color: ({IELTS:'#0f3d8c',Coreano:'#c8202e',ICFES:'#0f7c3e',TOEFL:'#1a6e3c',Alemán:'#1a2ecc',Francés:'#1a2ecc',Portugués:'#166534',Método:'#7c3aed',Migración:'#0369a1',Inglés:'#1a4fcc'}[post.category]??'#1a4fcc'), background: ({IELTS:'rgba(15,61,140,0.1)',Coreano:'rgba(200,32,46,0.1)',ICFES:'rgba(15,124,62,0.1)',TOEFL:'rgba(26,110,60,0.1)',Alemán:'rgba(26,46,204,0.1)',Francés:'rgba(26,46,204,0.1)',Portugués:'rgba(22,101,52,0.1)',Método:'rgba(124,58,237,0.1)',Migración:'rgba(3,105,161,0.1)',Inglés:'rgba(26,79,204,0.1)'}[post.category]??'rgba(26,79,204,0.1)'), padding: '2px 8px', borderRadius: 100, marginBottom: '0.5rem' }}>
                      {post.category}
                    </span>
