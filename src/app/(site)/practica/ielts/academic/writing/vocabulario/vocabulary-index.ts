 ...
 *
 * Task 1 tiene tres de sus seis subpartes. Faltan procesos, mapas y comparaciones, y luego las
 * cuatro de Task 2 y el traslado de las ocho funciones desde `task2/academic-vocabulary`. Se
...
export const VOCAB_UNITS: VocabUnit[] = [...TASK1_UNITS];
