...
export const metadata: Metadata = {
  title: 'IELTS Writing Task 1 — Mapas — Descripción de cambios espaciales | Idiomas WeLearn',
  ...
  openGraph: {
    title: 'IELTS Task 1: Mapas — Descripción de cambios espaciales | Idiomas WeLearn',
    description: 'Ejercicios para describir mapas en el IELTS Writing Task 1. Vocabulario de cambio espacial, comparaciones temporales y estructura Band 7.',
