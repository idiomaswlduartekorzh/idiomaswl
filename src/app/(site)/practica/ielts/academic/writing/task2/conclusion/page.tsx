...
export const metadata: Metadata = {
  title: 'IELTS Writing Task 2 — Conclusión — Cierre efectivo sin nueva información | Idiomas WeLearn',
  ...
  openGraph: {
    title: 'IELTS Task 2: Conclusión — Cierre efectivo sin nueva información | Idiomas WeLearn',
    description: 'Aprende a escribir conclusiones del IELTS Writing Task 2: restating the thesis, resumen de puntos y posición final. Técnica Band 7 sin repetición literal.',
...
export default function Page() { return <ConclusionTask2Client />; }
