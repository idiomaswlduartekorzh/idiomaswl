...
export const metadata: Metadata = {
  title: 'IELTS Writing Task 2 — Linking Language — Conectores académicos | Idiomas WeLearn',
  ...
  openGraph: {
    title: 'IELTS Task 2: Linking Language — Conectores académicos | Idiomas WeLearn',
    description: 'Practica los conectores y linking words del IELTS Writing Task 2: adición, contraste, causa-efecto, ejemplificación y conclusión. Vocabulario cohesivo Band 7.',
...
export default function Page() { return <LinkingLanguageClient />; }
