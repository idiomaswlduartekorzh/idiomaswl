...
export const metadata: Metadata = generateGrammarIndexMetadata('ruso', 'a2')
...
export default function GrammarIndexPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'A2', item: 'https://www.idiomaswl.com/practica/ruso/a2' },
      { '@type': 'ListItem', position: 4, name: 'Gramática A2', item: 'https://www.idiomaswl.com/practica/ruso/a2/gramatica' },
    ],
  }
      ...
      <div className="gram-page" style={{ '--topic-color': '#1a2ecc' } as React.CSSProperties}>
        <div className="wrap">
          <nav aria-label="breadcrumb" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '1.5rem 0 0', fontSize: '0.82rem', fontFamily: 'var(--mono)', color: 'var(--muted)', flexWrap: 'wrap' }}>
            ...
            <span>/</span>
            <Link href="/practica/ruso/a2" style={{ color: 'var(--muted)', textDecoration: 'none' }}>A2</Link>
            <span>/</span>
          ...
          <section className="topic-hero" style={{ paddingBottom: '1.5rem' }}>
            <p className="eyebrow" style={{ marginBottom: '0.5rem' }}><span className="ink-line" />Gramática · Ruso A2</p>
          ...
          <div style={{ paddingBottom: '2rem' }}>
            <Link href="/practica/ruso/a2" style={{ color: 'var(--muted)', fontFamily: 'var(--mono)', fontSize: '0.82rem', textDecoration: 'none' }}>← Volver a Ruso A2</Link>
          </div>
        </div>
      </div>
    </>
