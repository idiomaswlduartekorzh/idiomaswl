...
export const metadata: Metadata = {
  title: 'Herramientas para hablar ruso A2 | Idiomas WeLearn',
  description: 'Frases de apoyo para abrir y cerrar conversaciones, pedir repetición, ganar tiempo, explicar límites y negociar con cortesía en ruso A2.',
