...
export const metadata: Metadata = {
  title: 'Roleplays de ruso A2 en pareja | Idiomas WeLearn',
  description: `${scenarioCount} conversaciones A2 para practicar ruso en pareja con fichas separadas, información oculta, complicaciones y cierres verificables.`,
