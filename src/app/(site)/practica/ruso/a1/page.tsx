...
const HABILIDADES = [
  { id: 'lectura', emoji: '📖', name: 'Lectura', eng: 'Чтение', desc: '5 textos A1 en cirílico con transliteración y vocabulario interactivo. Priviet! Знакомство, семья, дом, еда.', count: '5 textos · 25 preguntas', href: '/practica/ruso/a1/lectura' },
  { id: 'gramatica', emoji: '📐', name: 'Gramática', eng: 'Грамматика', desc: 'Alfabeto cirílico, pronombres, género, posesivos, conjugaciones, casos (acusativo, preposicional, genitivo), números, pasado, futuro y negación. Con transliteración.', count: '15 temas · 180+ ejercicios', href: '/practica/ruso/a1/gramatica' },
  { id: 'escritura', emoji: '✍️', name: 'Escritura', eng: 'Письмо', desc: '5 tareas guiadas: presentarse, describir la familia, tu ciudad, actividades y gustos. En cirílico o transliteración.', count: '5 prompts guiados', href: '/practica/ruso/a1/escritura' },
  { id: 'habla', emoji: '🗣️', name: 'Expresión oral', eng: 'Разговор', desc: '12 frases esenciales de supervivencia en ruso: cirílico + transliteración + pronunciación para hispanohablantes.', count: '12 frases esenciales', href: '/practica/ruso/a1/habla' },
  { id: 'vocabulario', emoji: '📚', name: 'Vocabulario', eng: 'Словарь', desc: '6 sets temáticos con cirílico + transliteración + español: семья, цвета, еда, дни, тело, числа.', count: '6 sets · 60+ palabras', href: '/practica/ruso/a1/vocabulario' },
  { id: 'escucha', emoji: '🎧', name: 'Escucha', eng: 'Аудирование', desc: `20 episodios narrativos A1: «Красный шарф в метро». Guion dialogado con transliteración, vocabulario, preguntas y transcripción bilingüe.${AUDIO_LISTO ? '' : ' Audio en producción.'}`, count: AUDIO_LISTO ? '20 episodios · 100 preguntas' : '20 episodios · audio en producción', href: '/practica/ruso/a1/escucha' },
];
