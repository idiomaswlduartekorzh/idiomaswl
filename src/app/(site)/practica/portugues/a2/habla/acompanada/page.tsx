...
export const metadata: Metadata = {
  title: 'Roleplays de portugués A2 en pareja | Idiomas WeLearn',
  description: `${scenarioCount} conversaciones A2 para practicar portugués brasileño en pareja con fichas separadas, información oculta, complicaciones y cierres verificables.`,
