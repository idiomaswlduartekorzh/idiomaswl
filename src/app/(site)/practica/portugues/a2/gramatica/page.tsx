...
export default function GrammarIndexPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'A2', item: 'https://www.idiomaswl.com/practica/portugues/a2' },
      { '@type': 'ListItem', position: 4, name: 'Gramática A2', item: 'https://www.idiomaswl.com/practica/portugues/a2/gramatica' },
    ],
  }
      ...
      <div className="gram-page" style={{ '--topic-color': '#166534' } as React.CSSProperties}>
        <div className="wrap">
          ...
          <section className="topic-hero" style={{ paddingBottom: '1.5rem' }}>
            <p className="eyebrow" style={{ marginBottom: '0.5rem' }}><span className="ink-line" />Gramática · Portugués A2</p>
          ...
          <div style={{ paddingBottom: '2rem' }}>
            <Link href="/practica/portugues/a2" style={{ color: 'var(--muted)', fontFamily: 'var(--mono)', fontSize: '0.82rem', textDecoration: 'none' }}>← Volver a Portugués A2</Link>
          </div>
        </div>
      </div>
    </>
