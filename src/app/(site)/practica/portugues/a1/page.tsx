...
const HABILIDADES = [
  ...
  { id: 'escucha', emoji: '🎧', name: 'Compreensão auditiva', eng: 'Escucha', desc: '3 exercícios de compreensão auditiva A1. Áudios de voz nativa brasileira em preparação.', count: '3 áudios em breve', href: '/practica/portugues/a1/escucha' },
];
