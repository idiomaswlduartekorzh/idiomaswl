...
export const metadata: Metadata = {
  ...
  description: `${scenarioCount} conversaciones A2 para practicar inglés en pareja con fichas separadas, información oculta, complicaciones y cierres verificables.`,
