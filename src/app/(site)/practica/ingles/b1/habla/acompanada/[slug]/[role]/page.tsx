...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: fitTitle(`${scenario.title}: rol ${role.toUpperCase()} — Speaking B1`),
    description: fitDescription(`Ficha del rol ${role.toUpperCase()} para practicar “${scenario.title}” en inglés B1 con otra persona.`),
