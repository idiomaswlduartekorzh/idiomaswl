...
export default function GrammarIndexPage() {
  ...
  return (
    <>
      ...
      />
      <div className="gram-page" style={{ '--topic-color': '#7c3aed' } as React.CSSProperties}>
        <div className="wrap">
          {/* Breadcrumb */}
          <nav
          ...
          >
            ...
            <span>/</span>
            <span style={{ color: '#7c3aed', fontWeight: 800 }}>Gramática</span>
          </nav>

          {/* Header */}
          <section className="topic-hero" style={{ paddingBottom: '1.5rem' }}>
            <p className="eyebrow" style={{ marginBottom: '0.5rem' }}>
              <span className="ink-line" />Gramática · Inglés A1
            </p>
