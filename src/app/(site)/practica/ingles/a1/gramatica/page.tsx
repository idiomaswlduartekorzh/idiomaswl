...
import { TOPICS, GRAMMAR_COLOR } from '@/data/practica/ingles-a1-gramatica'
...
export default function Page() {
  ...
  return (
    <>
      <CourseSchema
        name="Gramática de Inglés A1 — 15 temas con explicación y ejercicios"
        description="Curso de gramática de inglés nivel A1: artículos, verbo to be, present simple, present continuous, can, preposiciones y más. Explicación, tablas, ejemplos y ejercicios interactivos."
        url="https://www.idiomaswl.com/practica/ingles/a1/gramatica"
        educationalLevel="A1"
        teaches="Gramática del inglés, nivel A1 (MCER)"
        inLanguage="en"
      />
      <section className="wl-section">
        <div className="wrap" style={{ maxWidth: 820 }}>
          ...
          <h1 style={{ fontSize: '2rem', letterSpacing: '-0.03em', margin: '0 0 0.5rem', fontWeight: 700 }}>Gramática de Inglés A1</h1>
          <p style={{ color: 'var(--muted)', fontSize: '1rem', maxWidth: 560, margin: '0 0 2rem' }}>
            {TOPICS.length} temas esenciales del nivel A1. Cada tema tiene explicación clara, tabla, ejemplos
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(330px, 1fr))', gap: '0.85rem' }}>
            {TOPICS.map(t => (
              <Link key={t.slug} href={`/practica/ingles/a1/gramatica/${t.slug}`} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
                <div style={{
          ...
          <div style={{ marginTop: '2rem', padding: '0.9rem 1.2rem', borderRadius: 12, background: `${COLOR}0a`, border: `1px solid ${COLOR}22`, fontSize: '0.84rem', color: 'var(--muted)', lineHeight: 1.6 }}>
            ...
            (artículos, verbo to be) a lo más completo (present continuous, preposiciones). Cada uno te toma 5–10 minutos.
          </div>
        </div>
      </section>
    </>
