...
const HABILIDADES = [
  {
    ...
    count: '5 textos · 25 preguntas', href: '/practica/ingles/a1/lectura', available: true,
  },
  {
    ...
    count: '5 temas · 50+ ejercicios', href: '/practica/ingles/a1/gramatica', available: true,
  },
  {
    ...
    count: '5 prompts guiados', href: '/practica/ingles/a1/escritura', available: true,
  },
  {
    ...
    count: '15 frases esenciales', href: '/practica/ingles/a1/habla', available: true,
  },
  {
    ...
    count: '6 sets · 60+ palabras', href: '/practica/ingles/a1/vocabulario', available: true,
  },
  {
    ...
    count: '3 audios próximamente', href: '/practica/ingles/a1/escucha', available: true,
  },
];
    ...
    <section className="wl-section">
      <div className="wrap" style={{ maxWidth: 900 }}>
        ...
        <p style={{ color: 'var(--muted)', fontSize: '1rem', maxWidth: 580, margin: '0.5rem 0 2.5rem' }}>
          Seis habilidades para un inglés sólido desde cero. Puedes practicarlas en cualquier orden.
        </p>
