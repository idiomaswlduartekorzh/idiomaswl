...
export const metadata: Metadata = {
  title: 'Roleplays de inglés A1 en pareja | Idiomas WeLearn',
  description: `${scenarioCount} conversaciones A1 para practicar inglés en pareja con fichas separadas, información oculta, complicaciones y cierres verificables.`,
