...
export const metadata: Metadata = {
  title: 'Roleplays de alemán A2 en pareja | Idiomas WeLearn',
  description: `${scenarioCount} conversaciones A2 para practicar alemán en pareja con fichas separadas, información oculta, complicaciones y cierres verificables.`,
