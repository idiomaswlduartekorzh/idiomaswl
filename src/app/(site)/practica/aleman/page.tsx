...
const NIVELES = [
  ...
  { nivel: 'B1', name: 'Mittelstufe', desc: 'Konjunktiv II, Passiv, Relativsätze, Konjunktoren, Partizip, Wortbildung und mehr.', href: '/practica/aleman/b1', available: true, count: '20 temas · 120+ ejercicios' },
