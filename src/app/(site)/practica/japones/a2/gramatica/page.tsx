...
export default function GrammarIndexPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'A2', item: 'https://www.idiomaswl.com/practica/japones/a2' },
      { '@type': 'ListItem', position: 4, name: 'Gramática A2', item: 'https://www.idiomaswl.com/practica/japones/a2/gramatica' },
    ],
  }
      ...
      <div className="gram-page" style={{ '--topic-color': '#dc2626' } as React.CSSProperties}>
        <div className="wrap">
          <nav aria-label="breadcrumb" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '1.5rem 0 0', fontSize: '0.82rem', fontFamily: 'var(--mono)', color: 'var(--muted)', flexWrap: 'wrap' }}>
            ...
            <span>/</span>
            <Link href="/practica/japones/a2" style={{ color: 'var(--muted)', textDecoration: 'none' }}>A2</Link>
            <span>/</span>
            <span style={{ color: '#dc2626', fontWeight: 800 }}>Gramática</span>
          </nav>

          <section className="topic-hero" style={{ paddingBottom: '1.5rem' }}>
            <p className="eyebrow" style={{ marginBottom: '0.5rem' }}><span className="ink-line" />Gramática · Japonés A2</p>
          ...
          <div style={{ paddingBottom: '2rem' }}>
            <Link href="/practica/japones/a2" style={{ color: 'var(--muted)', fontFamily: 'var(--mono)', fontSize: '0.82rem', textDecoration: 'none' }}>← Volver a Japonés A2</Link>
          </div>
        </div>
      </div>
    </>
