...
const EXAMS: ExamEntry[] = [
  { slug: 'ielts',  flag: '🇬🇧', name: 'IELTS Academic', tagline: 'Listening, Reading, Writing y Speaking con los 20 sets auditados.', color: 'var(--wl-on-panel-link, #0f3d8c)', href: '/practica/ielts', tools: '4 habilidades · 20 sets' },
  ...
  { slug: 'goethe', flag: '🇩🇪', name: 'Goethe A1',      tagline: 'Práctica independiente de Hören, Lesen, Schreiben y Sprechen, más simulacros completos con resultado sobre 100.', color: 'var(--wl-on-panel-warn, #b8840c)', href: '/practica/goethe', tools: '4 destrezas · 7 simulacros' },
...
const LANGUAGES: LangEntry[] = [
  ...
  { slug: 'french',     flag: '🇫🇷', name: 'Francés',   tagline: 'Lecture, grammaire, écriture y expression orale — nivel A1.',              color: 'var(--wl-on-panel, #003189)', available: true,  href: '/practica/frances',   tools: '4 habilidades A1' },
