...
const EXAMS: ExamEntry[] = [
  ...
  { slug: 'goethe', flag: '🇩🇪', name: 'Goethe A1–B2',   tagline: 'Bibliotecas por nivel: A1 completo y A2 con Lesen, Schreiben y Sprechen en diez sets propios.', color: 'var(--wl-on-panel-warn, #b8840c)', href: '/practica/goethe', tools: '4 niveles · 20 sets listos' },
