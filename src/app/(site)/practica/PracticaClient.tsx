...
const EXAMS: ExamEntry[] = [
  ...
  { slug: 'goethe', flag: '🇩🇪', name: 'Goethe A1',      tagline: 'Práctica independiente de Hören, Lesen, Schreiben y Sprechen, más simulacros completos con resultado sobre 100.', color: 'var(--wl-on-panel-warn, #b8840c)', href: '/practica/goethe', tools: '4 destrezas · 10 sets' },
