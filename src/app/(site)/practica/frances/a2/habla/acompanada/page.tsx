...
export const metadata: Metadata = {
  title: 'Roleplays de francés A2 en pareja | Idiomas WeLearn',
  description: `${scenarioCount} conversaciones A2 para practicar francés en pareja con fichas separadas, información oculta, complicaciones y cierres verificables.`,
