...
export const metadata: Metadata = generateGrammarIndexMetadata('frances', 'a1')
...
export default function GrammarIndexPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'A1', item: 'https://www.idiomaswl.com/practica/frances/a1' },
      { '@type': 'ListItem', position: 4, name: 'Gramática A1', item: 'https://www.idiomaswl.com/practica/frances/a1/gramatica' },
    ],
  }
      ...
      <div className="gram-page" style={{ '--topic-color': SKILL_ACCENT.gramatica.var } as React.CSSProperties}>
        <div className="wrap">
          ...
          >
            ...
            <span>/</span>
            <Link href="/practica/frances/a1" style={{ color: 'var(--muted)', textDecoration: 'none' }}>A1</Link>
            <span>/</span>
          ...
          <section className="topic-hero" style={{ paddingBottom: '1.5rem' }}>
            <p className="eyebrow" style={{ marginBottom: '0.5rem' }}>
              <span className="ink-line" />Gramática · Francés A1
            </p>
