...
export const metadata: Metadata = generateGrammarIndexMetadata('frances', 'b1')
...
export default function GrammarIndexPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Francés', item: 'https://www.idiomaswl.com/practica/frances' },
      { '@type': 'ListItem', position: 3, name: 'B1', item: 'https://www.idiomaswl.com/practica/frances/b1' },
      { '@type': 'ListItem', position: 4, name: 'Gramática B1', item: 'https://www.idiomaswl.com/practica/frances/b1/gramatica' },
    ],
  }
      ...
      <div className="gram-page" style={{ '--topic-color': SKILL_ACCENT.gramatica.var } as React.CSSProperties}>
        <div className="wrap">
          ...
          <section className="topic-hero" style={{ paddingBottom: '1.5rem' }}>
            <p className="eyebrow" style={{ marginBottom: '0.5rem' }}><span className="ink-line" />Gramática · Francés B1</p>
          ...
          <div style={{ paddingBottom: '2rem' }}>
            <Link href="/practica/frances/b1" style={{ color: 'var(--muted)', fontFamily: 'var(--mono)', fontSize: '0.82rem', textDecoration: 'none' }}>← Volver a Francés B1</Link>
          </div>
        </div>
      </div>
    </>
