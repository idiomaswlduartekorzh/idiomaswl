...
export const NARRATOR_PARAGRAPHS = [
...
export const NARRATOR_QS: Question[] = [
  {
    type: 'Vocabulary',
...
export const FINAL_QS: Question[] = [
  {
    type: 'Synthesis',
...
export const ALL_SECTIONS = [
  ...
  { key: 'gf', questions: GF_QS },
  { key: 'bf', questions: BF_QS },
  { key: 'final', questions: FINAL_QS },
];

export const TOTAL_QUESTIONS = ALL_SECTIONS.reduce((n, s) => n + s.questions.length, 0);
