...
const LINKS = [
  { href: '/examenes/icfes', label: 'Simulacros ICFES Inglés', note: 'Catálogo principal: 31 recursos únicos entre prácticas, cuadernillos y un recorrido guiado de 55 preguntas.' },
