 ...
 * el sitio tiene diez simulacros de cuadernillos oficiales.
 */

const LINKS = [
  { href: '/examenes/icfes', label: 'Simulacros oficiales', note: 'Diez cuadernillos de años anteriores, con clave y puntaje al terminar.' },
