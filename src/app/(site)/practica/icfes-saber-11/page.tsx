    ...
    <main className={styles.hubPage}>
      ...
      <div className={styles.hubWrap}>
        ...
        <section className={styles.hubSource}>
          ...
          <div><strong>Criterio editorial</strong><p>Las preguntas propias se identifican como práctica. Los bancos históricos se presentan como atribuciones no cotejadas y no se confunden con la aplicación estándar completa.</p></div>
