...
export const metadata: Metadata = {
  ...
  description:
    'Consulta 10 bancos históricos atribuidos a material ICFES, separados por audiencia. Cinco tienen explicación guiada; la procedencia por ítem aún debe cotejarse.',
