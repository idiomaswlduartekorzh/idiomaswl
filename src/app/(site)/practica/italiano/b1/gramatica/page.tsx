...
export const metadata: Metadata = generateGrammarIndexMetadata('italiano', 'b1')
...
export default function GrammarIndexPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Italiano', item: 'https://www.idiomaswl.com/practica/italiano' },
      { '@type': 'ListItem', position: 3, name: 'B1', item: 'https://www.idiomaswl.com/practica/italiano/b1' },
      { '@type': 'ListItem', position: 4, name: 'Gramática B1', item: 'https://www.idiomaswl.com/practica/italiano/b1/gramatica' },
    ],
  }
  ...
  return (
    <>
      ...
      <div className="gram-page" style={{ '--topic-color': '#009246' } as React.CSSProperties}>
        <div className="wrap">
          <nav aria-label="breadcrumb" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '1.5rem 0 0', fontSize: '0.82rem', fontFamily: 'var(--mono)', color: 'var(--muted)', flexWrap: 'wrap' }}>
            ...
            <span>/</span>
            <Link href="/practica/italiano/b1" style={{ color: 'var(--muted)', textDecoration: 'none' }}>B1</Link>
            <span>/</span>
            <span style={{ color: 'var(--wl-on-panel-ok, #009246)', fontWeight: 800 }}>Gramática</span>
          </nav>

          <section className="topic-hero" style={{ paddingBottom: '1.5rem' }}>
            <p className="eyebrow" style={{ marginBottom: '0.5rem' }}><span className="ink-line" />Gramática · Italiano B1</p>
            <h1 className="gram-h1" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>Temas de gramática B1</h1>
          ...
          <div style={{ display: 'grid', gap: '0.9rem', paddingBottom: '3rem' }}>
            ...
            {topics.length === 0 && (
              <div style={{ padding: '3rem', textAlign: 'center', color: 'var(--muted)', fontSize: '0.95rem', border: '1.5px solid var(--line-soft)', borderRadius: 16 }}>Próximamente: temas de gramática B1.</div>
            )}
          </div>

          <div style={{ paddingBottom: '2rem' }}>
            <Link href="/practica/italiano/b1" style={{ color: 'var(--muted)', fontFamily: 'var(--mono)', fontSize: '0.82rem', textDecoration: 'none' }}>← Volver a Italiano B1</Link>
          </div>
        </div>
      </div>
    </>
