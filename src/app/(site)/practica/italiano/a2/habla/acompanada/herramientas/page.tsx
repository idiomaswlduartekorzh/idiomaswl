...
export const metadata: Metadata = {
  title: 'Herramientas para hablar italiano A2 | Idiomas WeLearn',
  description: 'Frases de apoyo para abrir y cerrar conversaciones, pedir repetición, ganar tiempo, explicar límites y negociar con cortesía en italiano A2.',
