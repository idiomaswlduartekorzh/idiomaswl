...
export const metadata: Metadata = {
  title: 'Roleplays de italiano A2 en pareja | Idiomas WeLearn',
  description: `${scenarioCount} conversaciones A2 para practicar italiano en pareja con fichas separadas, información oculta, complicaciones y cierres verificables.`,
