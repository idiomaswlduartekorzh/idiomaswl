...
export const metadata: Metadata = {
  title: 'Roleplays de coreano A2 en pareja | Idiomas WeLearn',
  description: `${scenarioCount} conversaciones A2 para practicar coreano en pareja con fichas separadas, información oculta, complicaciones y cierres verificables.`,
