...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: fitTitle(`${scenario.title} — Roleplay en coreano A2`),
    description: fitDescription(`${scenario.settingEs} Juego de rol de ${scenario.minutes} minutos para dos personas, con fichas separadas y práctica de coreano A2.`),
