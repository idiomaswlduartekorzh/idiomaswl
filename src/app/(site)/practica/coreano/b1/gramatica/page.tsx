...
export const metadata: Metadata = generateGrammarIndexMetadata('coreano', 'b1')
...
export default function GrammarIndexPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 4, name: 'Gramática B1', item: 'https://www.idiomaswl.com/practica/coreano/b1/gramatica' },
    ],
  }
      ...
      <div className="gram-page" style={{ '--topic-color': '#c60c30' } as React.CSSProperties}>
        <div className="wrap">
          ...
          <section className="topic-hero" style={{ paddingBottom: '1.5rem' }}>
            <p className="eyebrow" style={{ marginBottom: '0.5rem' }}><span className="ink-line" />Gramática · Coreano B1</p>
          ...
          <div style={{ paddingBottom: '2rem' }}>
            <Link href="/practica/coreano/b1" style={{ color: 'var(--muted)', fontFamily: 'var(--mono)', fontSize: '0.82rem', textDecoration: 'none' }}>← Volver a Coreano B1</Link>
          </div>
        </div>
      </div>
    </>
