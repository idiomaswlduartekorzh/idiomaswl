  ...
  return <div className={styles.page}>
    <div className={styles.wrap}>
      ...
      <ol className={styles.steps} aria-label="Pasos para elegir tu curso">
        <li aria-current={!reviewing ? 'step' : undefined}><span>01</span> Tu curso</li>
        <li><span>02</span> Tu ritmo</li>
        <li aria-current={reviewing ? 'step' : undefined}><span>03</span> Tu selección</li>
      </ol>
      ...
      {!reviewing ? <div className={styles.layout}>
        ...
        <p>Revisa tu curso. Puedes copiar el resumen o llevarlo a WhatsApp para continuar la conversación.</p>
        ...
        <p className={styles.small}>Esta selección no reserva un horario ni confirma una inscripción. La preparación de exámenes no incluye la inscripción al examen oficial.</p>
        <a className={styles.primary} href={whatsappLink(selection)} target="_blank" rel="noopener noreferrer">Continuar por WhatsApp <span aria-hidden="true">↗</span></a>
