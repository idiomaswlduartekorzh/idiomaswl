...
import type { IcfesBasicResultDto } from '@/lib/icfes/attempt-contract';
import IcfesLeadResultOffers from '@/components/icfes/IcfesLeadResultOffers';
...
export default function PracticeClient({ exam, mock, secureIcfes }: { exam: Exam; mock: MockExam; secureIcfes?: { offerEnabled: boolean } }) {
  ...
  if (phase === 'results') {
    if (secureIcfes && secureResult) return <IcfesLeadResultOffers result={secureResult} offerEnabled={secureIcfes.offerEnabled} onRetry={handleRetry} />;
    return (
      <div className="prac-shell">
