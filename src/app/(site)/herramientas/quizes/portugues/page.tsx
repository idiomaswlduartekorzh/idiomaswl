...
export const metadata: Metadata = { title: 'Quiz de tiempos y estructuras en portugués — 6 niveles', description: 'Practica 10 formas del portugués brasileño con contexto, aspecto y corrección diferida.', alternates: { canonical: URL } }
