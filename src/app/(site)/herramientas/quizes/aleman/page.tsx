...
export const metadata: Metadata = { title: 'Quiz de tiempos y estructuras en alemán — 6 niveles', description: 'Practica 10 estructuras del alemán: auxiliares, orden verbal, futuro, hipótesis e imperativo.', alternates: { canonical: URL } }
