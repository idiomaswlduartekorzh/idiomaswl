...
export const metadata: Metadata = { title: 'Quiz de tiempo y aspecto en japonés — 6 niveles', description: 'Practica 10 contrastes del japonés: no-pasado, pasado, aspecto, experiencia, condición y petición.', alternates: { canonical: URL } }
