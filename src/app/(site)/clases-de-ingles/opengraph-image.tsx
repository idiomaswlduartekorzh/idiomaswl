...
export const alt = 'Clases de Inglés Online — IELTS, TOEFL, ICFES | WeLearn';
...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Glow */}
        <div style={{ position: 'absolute', top: -80, right: -80, width: 500, height: 500, borderRadius: '50%', background: '#1a2ecc', opacity: 0.12, filter: 'blur(100px)' }} />
        ...
        {/* Headline */}
        <div style={{ fontSize: 58, fontWeight: 800, color: '#fff', lineHeight: 1.15, letterSpacing: '-0.03em', maxWidth: 880, flex: 1 }}>
          Clases de inglés online{' '}
          <span style={{ color: '#6b8cff' }}>que funcionan</span>.
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 32, paddingTop: 24, borderTop: '1px solid rgba(255,255,255,0.1)' }}>
          <div style={{ fontSize: 18, color: 'rgba(255,255,255,0.65)' }}>
            Bucaramanga · 100% online · Para toda Colombia
          </div>
