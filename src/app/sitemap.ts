...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/practica/ielts/listening`, changeFrequency: 'weekly' as const, priority: 0.8 },
    { url: `${BASE}/practica/ielts/listening/simulacros`, changeFrequency: 'weekly' as const, priority: 0.78 },
