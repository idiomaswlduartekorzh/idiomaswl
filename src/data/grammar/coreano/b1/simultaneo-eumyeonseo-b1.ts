...
const topic: GrammarTopic = {
  ...
  seo: [
    ...
    {heading: '-으면서 en contextos cotidianos', paragraphs: ['Comer mientras estudia: "공부하면서 밥을 먹어요". Escuchar música caminando: "걸으면서 음악을 들어요".', 'Muy natural en descripción de actividades diarias con múltiples tareas.']},
  ],
