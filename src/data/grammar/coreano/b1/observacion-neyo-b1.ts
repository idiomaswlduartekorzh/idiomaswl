...
const topic: GrammarTopic = {
  ...
  seo: [
    ...
    {heading: '-네요 con adjetivos (estado)', paragraphs: ['"날씨가 좋네요" (¡qué buen día! veo que el día está bueno). "한국어가 어렵네요" (veo que el coreano es difícil).', '"집이 크네요" (¡qué casa tan grande! veo que es grande). -네요 con adjetivos expresa reacción a características.']},
    ...
    {heading: '-네요 vs -군요 (observación vs sorpresa fuerte)', paragraphs: ['-네요: observación casual. "날씨가 좋네요" (parece que el día está bueno — lo notaste).', '-군요: sorpresa más fuerte o retrospectiva. "날씨가 좋군요!" (¡qué sorpresa! el día está muy bueno — impresión más fuerte).']},
