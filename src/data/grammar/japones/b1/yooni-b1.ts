...
const topic: GrammarTopic = {
  ...
  practice: {levels: [{id: 'level-1', title: '〜ように correcto', tag: 'Múltipla escolha', intro: 'Elige la forma correcta.', type: 'choice', items: [{scene: 'Propósito', lines: [['', 'わかるよ___説明する。']], options: ['うに', 'りに', 'うに', 'れに'], answer: 'うに', explain: 'ように (propósito).'}, {scene: 'Similitud', lines: [['', '鳥のよ___飛ぶ。']], options: ['うに', 'りに', 'いに', 'えに'], answer: 'うに', explain: 'ように (similitud).'}]}, {id: 'level-2', title: '〜ように en contexto', tag: 'Contexto', intro: 'Completa con propósito o similitud.', type: 'guidedText', scene: 'Métodos y comparaciones.', text: 'わかるよ___説明する。 天使のよ___美しい。 誰にでもわかるよ___シンプルにする。', blanks: [{options: ['うに', 'いに'], answer: 'うに', explain: 'ように (propósito).'}, {options: ['うに', 'いに'], answer: 'うに', explain: 'ように (similitud).'}, {options: ['うに', 'いに'], answer: 'うに', explain: 'ように (propósito).'}]}, {id: 'level-3', title: 'Escritura con 〜ように', tag: 'Escritura', intro: 'Expresa propósitos y similitudes.', type: 'freeText', scene: 'Mis explicaciones y comparaciones.', text: '1. [[0]] (Explico para que entienda). 2. [[1]] (Hermosa como flor). 3. [[2]] (Rápido como rayo).', blanks: [{answer: 'わかるように説明する', accepted: ['ように', '説明'], explain: 'ように (propósito).'}, {answer: '花のように美しい', accepted: ['ように', '花'], explain: 'ように (similitud).'}, {answer: '雷のように速い', accepted: ['ように', '雷'], explain: 'ように (similitud).'}]}, {id: 'level-4', title: 'Análise de 〜ように', tag: 'Análise', intro: 'Explica significado.', type: 'write', items: [{scene: '〜ように vs 〜ために', prompt: '"理解するように説明する" と "理解させるために説明する" の違いは何？', answer: '両方ともpropósito を表すが、"ように" は方法・manner に焦点（～するように、つまりこういう方法で）、"ために" は最終目的に焦点（～するために、つまり最終目的として）。どちらも結果は同じだが、視点が異なる。', accepted: ['方法', '目的', 'ため'], explain: 'ように: método/manner; ために: propósito final.'}]}]},
}
