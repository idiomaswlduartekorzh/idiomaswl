...
const topic: GrammarTopic = {
  ...
  seo: [
    ...
    {heading: '¿Cómo se usa 〜ように para similitud y comparación?', paragraphs: ['"天使のように美しい" (hermosa como un ángel). "光のように速い" (rápido como la luz). "葉が落ちるように雪が降る" (la nieve cae como hojas que caen).', 'Expresa SIMILITUD ENTRE DOS COSAS.']},
    ...
    {heading: '¿En qué se diferencian 〜ように y 〜ために?', paragraphs: ['"理解させるようにゆっくり話す" (hablo lentamente PARA QUE entienda — énfasis método) vs "理解させるためにゆっくり話す" (hablo lentamente PARA entienda — énfasis propósito). ように es más METHOD; ために es más PURPOSE.', 'Ambas son correctas pero con énfasis distinto.']},
  ],
