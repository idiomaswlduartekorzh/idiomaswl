...
const topic: GrammarTopic = {
  ...
  seo: [
    ...
    {heading: '¿Cómo expresa 〜ために un propósito voluntario?', paragraphs: ['"キャリアを積むために留学する" (estudio en el extranjero para construir carrera). "健康のために運動する" (hago ejercicio para la salud).', 'Acción realizada CON UN PROPÓSITO CLARO.']},
    ...
    {heading: '¿En qué se diferencian 〜ために y 〜ように?', paragraphs: ['"伝わるようにゆっくり話す" (hablo lentamente PARA que se entienda — método) vs "理解させるために繰り返す" (repito PARA que entienda — propósito). ために es propósito; ように es método/forma.', 'Contextos diferentes, ambas expresan finalidad pero con énfasis distinto.']},
  ],
