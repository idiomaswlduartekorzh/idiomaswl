...
, learnerModes: ['reading', 'typing', 'choosing'], reviewFocus: ['最近', '専ら', '強調']},
  practice: {levels: [{id: 'level-1', title: 'Forma 〜ばかり', tag: 'Múltipla escolha', intro: 'Selecciona forma correcta.', type: 'choice', items: [{scene: 'Pasado reciente', lines: [['', 'コーヒーを飲ん___。']], options: ['ばかり', 'ばかりだ', 'ばかります', 'ばかった'], answer: 'ばかり', explain: 'ばかり (pasado reciente).'}, {scene: 'Énfasis exclusivo', lines: [['', 'ゲーム___ やってる。']], options: ['ばかり', 'ばかった', 'ばかりだ', 'だけ'], answer: 'ばかり', explain: 'ばかり (solo/exclusivo).'}]}, {id: 'level-2', title: 'うち en contexto', tag: 'Reciente/Énfasis', intro: 'Completa 〜ばかり.', type: 'guidedText', scene: 'Oraciones de pasado reciente y énfasis.', text: '飲んだ___ 。 ゲーム___ 。 帰ったばかり___。', blanks: [{options: ['ばかり', 'だけ'], answer: 'ばかり', explain: 'ばかり (reciente).'}, {options: ['ばかり', 'だけ'], answer: 'ばかり', explain: 'ばかり (énfasis).'}, {options: ['です', 'だ'], answer: 'です', explain: '帰ったばかりです (formal).'}]}, {id: 'level-3', title: 'Escritura con 〜ばかり', tag: 'ばかり', intro: 'Escribe con 〜ばかり.', type: 'freeText', scene: 'Acciones recientes y exclusivas.', text: '1. [[0]] (Acabo de desayunar). 2. [[1]] (Solo estudio). 3. [[2]] (Acabo de llegar).', blanks: [{answer: '朝食を食べたばかり', accepted: ['たばかり', '食べ'], explain: '〜たばかり (reciente).'}, {answer: '勉強ばかりしている', accepted: ['ばかり', '勉強'], explain: '〜ばかり (énfasis).'}, {answer: '帰ったばかり', accepted: ['たばかり', '帰っ'], explain: '〜たばかり (reciente).'}]}, {id: 'level-4', title: 'Análise de 〜ばかり', tag: 'Análise', intro: 'Explica 〜ばかり.', type: 'write', items: [{scene: 'Dos significados', prompt: '¿Cuáles son los dos significados principales de 〜ばかり?', answer: '1) 〜たばかり = pasado reciente (acabo de...). 2) 〜ばかり = énfasis en exclusividad (solo..., casi nada más). Ambos son muy comunes en conversación.', accepted: ['最近', '専ら'], explain: '〜ばかり: reciente o exclusivo.'}]}]},
}
