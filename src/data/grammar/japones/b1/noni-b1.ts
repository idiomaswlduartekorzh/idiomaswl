...
const topic: GrammarTopic = {
  ...
  seo: [
    ...
    {heading: '¿Cómo se usa 〜たのに para el contraste en pasado?', paragraphs: ['"勉強したのに、試験に落ちた" (estudié pero reprobé). "一生懸命働いたのに、給料が上がらない" (trabajo duro pero el salario no sube).', 'El speaker esperaba un resultado pero no sucedió.']},
    ...
    {heading: '¿Qué diferencia hay entre 〜のに y けれど?', paragraphs: ['"勉強したのに、落ちた" (estudié pero reprobé — frustración) vs "勉強したけれど、落ちた" (estudié pero reprobé — neutral). のに tiene tono emocional más fuerte.', 'Ambas expresan contraste pero のに es más dramático.']},
  ],
