...
, learnerModes: ['reading', 'typing', 'choosing'], reviewFocus: ['程度', '比例', '尺度']},
  practice: {levels: [{id: 'level-1', title: '〜ほど', tag: 'Múltipla escolha', intro: 'Selecciona forma.', type: 'choice', items: [{scene: 'Grado', lines: [['', '大き___ほどいい。']], options: ['い', 'ける', 'する', 'た'], answer: 'い', explain: '大きいほど (cuanto más grande).'}]}, {id: 'level-2', title: '比例', tag: 'Proporción', intro: 'Completa proporción.', type: 'guidedText', scene: 'Proporciones.', text: '働く___ 稼げます。'
