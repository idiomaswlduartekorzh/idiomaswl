...
const topic: GrammarTopic = {
  ...
  seo: [
    ...
    {heading: '¿Cómo expresa 〜てしまう una finalización enfática?', paragraphs: ['"飲んでしまいました" (me lo bebí todo — énfasis en que se acabó). "作ってしまった" (acabé de hacerlo — lo completé).', 'Expresa que la acción llegó a su fin de manera total.']},
    ...
    {heading: '¿Qué es 〜ちゃう, la forma coloquial de 〜てしまう?', paragraphs: ['"飲んじゃった" (informal de 飲んでしまった — me lo bebí). "忘れちゃった" (olvidé — 忘れてしまった).', 'En conversación casual, ちゃう/じゃう es mucho más natural que てしまう.']},
  ],
