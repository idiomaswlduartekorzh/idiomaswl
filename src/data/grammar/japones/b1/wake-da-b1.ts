...
, learnerModes: ['reading', 'typing', 'choosing'], reviewFocus: ['論理', '必然', '説明']},
  practice: {levels: [{id: 'level-1', title: '〜わけだ', tag: 'Múltipla escolha', intro: 'Selecciona.', type: 'choice', items: [{scene: 'Conclusión', lines: [['', '親切だから___。']], options: ['わけだ', 'から', 'ので', 'わけではない'], answer: 'わけだ', explain: 'わけだ (conclusión lógica).'}]}, {id: 'level-2', title: 'Lógica', tag: 'Razonamiento', intro: 'Completa.', type: 'guidedText', scene: 'Conclusiones.', text: '賢いから成功する___。'
