...
const topic: GrammarTopic = {
  ...
  seo: [
    ...
    {heading: '¿Cómo se forman los adverbios de modo en ruso?', paragraphs: ['"красивый" (hermoso) → "красиво" (hermosamente). "хороший" (bueno) → "хорошо" (bien). "плохой" (malo) → "плохо" (mal).', 'Regla: adjetivo neutro singular = adverbio.']},
    ...
    {heading: '¿Cuáles son los adverbios de cantidad en ruso?', paragraphs: ['"Сколько времени?" (¿Cuánto tiempo? — cantidad). "Я здесь долго" (he estado aquí mucho tiempo — duración). "Он приходит часто" (viene frecuentemente — frecuencia).', 'Expresan duración, cantidad, frecuencia.']},
  ],
