...
const topic: GrammarTopic = {
  ...
  seo: [
    ...
    {heading: '¿Qué es la reflexividad genuina (прямая)?', paragraphs: ['"умываться" — lavarse (sobre sí mismo). "одеваться" — vestirse (sobre sí mismo). "расчёсываться" — peinarse (sobre sí mismo).', 'La acción retorna al sujeto.']},
    ...
    {heading: '¿Cómo cambia el significado de un verbo al añadir -ся?', paragraphs: ['"смотреть" (mirar) vs "смотреться" (parecer, verse). "вешать" (colgar algo) vs "вешаться" (suicidarse — colgar se). El significado puede cambiar completamente.', 'No siempre es predecible, requiere aprendizaje de pares.']},
  ],
