...
const topic: GrammarTopic = {
  ...
  seo: [
    ...
    {heading: 'Comparativos simples regulares', paragraphs: ['"Этот фильм интереснее (того)" — este filme es más interesante. "Она красивее сестры" — ella es más hermosa que su hermana.', 'Formación: raíz + -ее/-е (e se usa si la raíz tiene consonante dura final).']},
    ...
    {heading: 'Superlativos: самый + Adj', paragraphs: ['"самый красивый" (el más hermoso). "самое интересное" (lo más interesante, neutro). "самые большие" (los más grandes, plural).', 'самый concuerda en género/número con el adjetivo.']},
