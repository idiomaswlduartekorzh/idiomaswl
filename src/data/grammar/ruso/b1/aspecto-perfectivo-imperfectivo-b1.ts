...
const topic: GrammarTopic = {
  ...
  seo: [
    ...
    {heading: 'Perfectivo (СВ): acción completada', paragraphs: ['"Я написал письмо" — escribí la carta (está lista). "Она прочитала книгу" — leyó el libro (terminó). СВ enfatiza que la acción fue completada y tiene un resultado.', 'Común en pasado: "Что ты делал вчера?" — "Я смотрел фильм" (НСВ — qué hacías). "Что ты сделал вчера?" — "Я написал письмо" (СВ — qué hiciste/completaste).']},
    {heading: 'Imperfectivo (НСВ): acción en proceso o habitual', paragraphs: ['"Я писал письмо" — escribía la carta (era un proceso). "Она читает книги каждый день" — lee libros cada día (hábito). НСВ enfatiza el proceso, no el resultado.', 'Con duraciones: "Я писал письмо 2 часа" (escribía durante 2 horas — proceso)']},
