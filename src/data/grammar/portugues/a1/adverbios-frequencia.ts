    ...
    levels: [
      ...
      },
      {
        ...
        items: [
          ...
          { scene: 'Geralmente en contexto', lines: [['', '"Generalmente Hugo llega a las ocho": Hugo [[0]] [[1]] às oito.']], blanks: [{ options: ['nunca', 'geralmente', 'sempre', 'às vezes'], answer: 'geralmente', explain: 'Geralmente = generalmente. Adverbio antes del verbo.' }, { options: ['estuda', 'trabalha', 'chega', 'come'], answer: 'chega', explain: 'Hugo geralmente chega às oito = Hugo generalmente llega a las ocho.' }] },
      ...
      },
      {
        ...
        items: [
          ...
          { scene: 'Descrever um colega', prompt: 'Traduce al portugués: "Hugo siempre llega puntual, nunca cancela clases y generalmente prepara materiales innovadores." (pontual = puntual, cancelar = cancelar, preparar = preparar, materiais = materiales)', answer: 'Hugo sempre chega pontual, nunca cancela aulas e geralmente prepara materiais inovadores', accepted: ['sempre', 'nunca', 'geralmente'], explain: 'sempre chega, nunca cancela (sin não), geralmente prepara — todos antes del verbo.' },
