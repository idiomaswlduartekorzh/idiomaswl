...
export const TOEFL_READING_SET2_V2: ToeflReadingExpansionObject = {
  ...
  contentVersion: '2026-08-31.length-v1',
  scoringVersion: 'toefl-reading-local-exact-set2@2026-08-31.length-v1',
...
In the nineteenth century, a German chemist developed a process that coated glass with silver using relatively safe chemicals. It was cheaper, safer, and suitable for large-scale manufacturing, so ordinary people could finally own clear mirrors. Historians suggest that routinely seeing oneself as others did may have influenced fashion and even people's sense of individual identity.`,
    items: [
      {
        type: 'single-select', id: T2_ITEM_IDS[0], legacyId: 't2-r-ap1', contentVersion: '2026-08-31.length-v1',
        prompt: 'How did early humans see their reflections?', alignment: 'official-family-pilot',
        options: [
          option(T2_ITEM_IDS[0], 'A', 'In manufactured glass mirrors coated with silver and protected from tarnishing by artisans'),
      ...
      {
        type: 'single-select', id: T2_ITEM_IDS[1], legacyId: 't2-r-ap2', contentVersion: '2026-08-31.length-v1',
        prompt: 'What were the drawbacks of early metal mirrors?', alignment: 'official-family-pilot',
        options: [
          option(T2_ITEM_IDS[1], 'A', 'They were too cheap to be valued and too easy for ordinary people to obtain.'),
      ...
      {
        type: 'single-select', id: T2_ITEM_IDS[2], legacyId: 't2-r-ap3', contentVersion: '2026-08-31.length-v1',
        prompt: 'Why did glass produce a better mirror than polished metal alone?', alignment: 'official-family-pilot',
        options: [
          option(T2_ITEM_IDS[2], 'A', 'Glass never broke, reflected light without metal, and automatically prevented every mirror surface from becoming dark or tarnished over time without any protective layer.'),
      ...
      {
        type: 'single-select', id: T2_ITEM_IDS[3], legacyId: 't2-r-ap4', contentVersion: '2026-08-31.length-v1',
        ...
        options: [
          ...
          option(T2_ITEM_IDS[3], 'D', 'The Venetian method of coating glass with tin and mercury by hand in costly workshops'),
        ],
      },
      {
        type: 'single-select', id: T2_ITEM_IDS[4], legacyId: 't2-r-ap5', contentVersion: '2026-08-31.length-v1',
        ...
        options: [
          ...
          option(T2_ITEM_IDS[4], 'C', 'They made people dislike their appearance and discouraged any attention to fashion or the development of individual identity.'),
          option(T2_ITEM_IDS[4], 'D', 'They ended the use of glass.'),
        ],
      },
      {
        type: 'multi-select', id: T2_MULTI_ID, legacyId: 't2-r-ap6', contentVersion: '2026-08-31.length-v1',
...
export const TOEFL_READING_SET3_V2: ToeflReadingExpansionObject = {
  id: 'toefl-reading-set3-v2', objectId: 'object:toefl-reading-set3-v2', contentVersion: '2026-08-31.length-v1',
  scoringVersion: 'toefl-reading-local-exact-set3@2026-08-31.length-v1', disclosure: DISCLOSURE,
  academic: {
...
Bats and dolphins are not closely related, yet both independently evolved similar solutions to sensing environments where sight can fail. This pattern is called convergent evolution. Human technologies based on the same principle include sonar used by ships and submarines and some navigation aids for people who are blind.`,
    items: [
      {
        type: 'single-select', id: T3_ITEM_IDS[0], legacyId: 't3-r-ap1', contentVersion: '2026-08-31.length-v1',
        prompt: 'What is echolocation?', alignment: 'official-family-pilot', options: [
          ...
          option(T3_ITEM_IDS[0], 'C', 'The use of reflected light to identify prey and perceive nearby surroundings'), option(T3_ITEM_IDS[0], 'D', 'The use of sound and its echoes to perceive surroundings'),
        ],
      },
      {
        type: 'single-select', id: T3_ITEM_IDS[1], legacyId: 't3-r-ap2', contentVersion: '2026-08-31.length-v1',
        prompt: 'How does an echolocating animal judge how far away an object is?', alignment: 'official-family-pilot', options: [
          option(T3_ITEM_IDS[1], 'A', 'By measuring the time it takes for the echo to return'), option(T3_ITEM_IDS[1], 'B', "By estimating the object's size and shape from the loudness of its call"),
          option(T3_ITEM_IDS[1], 'C', 'By touching it'), option(T3_ITEM_IDS[1], 'D', 'By its color'),
        ],
      },
      {
        type: 'single-select', id: T3_ITEM_IDS[2], legacyId: 't3-r-ap3', contentVersion: '2026-08-31.length-v1',
        prompt: 'What example shows the precision of bat echolocation?', alignment: 'official-family-pilot', options: [
          option(T3_ITEM_IDS[2], 'A', 'Bats can navigate in daylight without changing the timing of their calls near obstacles.'), option(T3_ITEM_IDS[2], 'B', 'Little brown bats reacted to rows of wires only 0.18 millimeters thick.'),
          option(T3_ITEM_IDS[2], 'C', 'Bats can sing loudly.'), option(T3_ITEM_IDS[2], 'D', 'Bats never miss their prey.'),
        ],
      },
      {
        type: 'single-select', id: T3_ITEM_IDS[3], legacyId: 't3-r-ap4', contentVersion: '2026-08-31.length-v1',
      ...
      {
        type: 'single-select', id: T3_ITEM_IDS[4], legacyId: 't3-r-ap5', contentVersion: '2026-08-31.length-v1',
      ...
      {
        type: 'multi-select', id: T3_MULTI_ID, legacyId: 't3-r-ap6', contentVersion: '2026-08-31.length-v1',
...
export const TOEFL_READING_SET4_V2: ToeflReadingExpansionObject = {
  id: 'toefl-reading-set4-v2', objectId: 'object:toefl-reading-set4-v2', contentVersion: '2026-08-31.length-v1',
  scoringVersion: 'toefl-reading-local-exact-set4@2026-08-31.length-v1', disclosure: DISCLOSURE,
  academic: {
...
Circadian timing has practical effects. Jet lag is the discomfort produced when an internal clock is out of step with a new time zone. Shift workers, whose schedules require them to stay awake at night, often experience health effects associated with a disrupted clock. Researchers also study how the timing of meals and medicines changes the body's response.`,
    items: [
      {
        type: 'single-select', id: T4_ITEM_IDS[0], legacyId: 't4-r-ap1', contentVersion: '2026-08-31.length-v1',
        prompt: 'What is the "circadian rhythm"?', alignment: 'official-family-pilot', options: [
          option(T4_ITEM_IDS[0], 'A', 'A yearly cycle of seasons controlled entirely by outside temperature and changing weather'), option(T4_ITEM_IDS[0], 'B', 'A type of music'),
      ...
      {
        type: 'single-select', id: T4_ITEM_IDS[1], legacyId: 't4-r-ap2', contentVersion: '2026-08-31.length-v1',
        prompt: 'What shows that the clock is internal?', alignment: 'official-family-pilot', options: [
          ...
          option(T4_ITEM_IDS[1], 'C', 'People need visible clocks and daylight cues or the body immediately loses every daily rhythm.'), option(T4_ITEM_IDS[1], 'D', 'Even with no time cues, the body continues to follow an approximately 24-hour cycle.'),
        ],
      },
      {
        type: 'single-select', id: T4_ITEM_IDS[2], legacyId: 't4-r-ap3', contentVersion: '2026-08-31.length-v1',
      ...
      {
        type: 'single-select', id: T4_ITEM_IDS[3], legacyId: 't4-r-ap4', contentVersion: '2026-08-31.length-v1',
      ...
      {
        type: 'single-select', id: T4_ITEM_IDS[4], legacyId: 't4-r-ap5', contentVersion: '2026-08-31.length-v1',
        prompt: 'What is jet lag, according to the passage?', alignment: 'official-family-pilot', options: [
          option(T4_ITEM_IDS[4], 'A', 'A lack of sleep caused entirely by loud aircraft noise during a long overnight flight'), option(T4_ITEM_IDS[4], 'B', 'A type of illness caused by flying'),
      ...
      {
        type: 'multi-select', id: T4_MULTI_ID, legacyId: 't4-r-ap6', contentVersion: '2026-08-31.length-v1',
        prompt: 'Select the TWO statements supported by the passage.', selectCount: 2, alignment: 'welearn-supplementary', options: [
...
export const TOEFL_READING_SET5_V2: ToeflReadingExpansionObject = {
  id: 'toefl-reading-set5-v2', objectId: 'object:toefl-reading-set5-v2', contentVersion: '2026-08-31.length-v1',
  scoringVersion: 'toefl-reading-local-exact-set5@2026-08-31.length-v1', disclosure: DISCLOSURE,
  academic: {
...
The relationship was not simply human control. Horses required pasture, water, and care, influencing settlement and movement. Domestication became a mutual adaptation: people changed horses through selective breeding, while horses changed the organization and rhythms of human life.`,
    items: [
      {
        type: 'single-select', id: T5_ITEM_IDS[0], legacyId: 't5-r-ap1', contentVersion: '2026-08-31.length-v1',
      ...
      {
        type: 'single-select', id: T5_ITEM_IDS[1], legacyId: 't5-r-ap2', contentVersion: '2026-08-31.length-v1',
      ...
      {
        type: 'single-select', id: T5_ITEM_IDS[2], legacyId: 't5-r-ap3', contentVersion: '2026-08-31.length-v1',
      ...
      {
        type: 'single-select', id: T5_ITEM_IDS[3], legacyId: 't5-r-ap4', contentVersion: '2026-08-31.length-v1',
      ...
      {
        type: 'single-select', id: T5_ITEM_IDS[4], legacyId: 't5-r-ap5', contentVersion: '2026-08-31.length-v1',
      ...
      {
        type: 'multi-select', id: T5_MULTI_ID, legacyId: 't5-r-ap6', contentVersion: '2026-08-31.length-v1',
