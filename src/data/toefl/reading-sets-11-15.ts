...
export const TOEFL_READING_SET12_V2 = createSet(12, {
  ...
  questions: [
    { prompt: "What does the first paragraph emphasize?", options: ["The entire reef is a single animal that grows by expanding one permanent coral body.", "A vast structure results partly from repeated activity by tiny polyps.", "The reef consists only of islands.", "Coral skeletons disappear immediately."] },
    { prompt: "How does reef structure grow over time?", options: ["Fish carry rocks into place and arrange them into permanent shelters for every reef organism.", "One polyp expands without limit.", "New polyps add skeletons on older skeletal material.", "Waves manufacture calcium carbonate."] },
    { prompt: "Why are corals called ecosystem engineers?", options: ["They regulate all ocean temperatures and prevent changing conditions from affecting other reef species.", "They design machines.", "They consume every competing species.", "Their structure creates habitat used by many organisms."] },
    { prompt: "Why are reef-building corals vulnerable?", options: ["They tolerate a limited range of conditions and face heat and chemistry changes.", "They cannot live in seawater because even normal salinity immediately dissolves their skeletons.", "They grow only on metal.", "They are unaffected by storms."] },
...
export const TOEFL_READING_SET15_V2 = createSet(15, {
  ...
  questions: [
    { prompt: "What central puzzle does the passage address?", options: ["Why adults forget every language once they stop receiving formal grammar lessons in school", "Why every language has identical grammar", "How children acquire complex language without formal grammar lessons", "How schools should grade writing"] },
    { prompt: "What does the nativist account propose?", options: ["Children have better hearing than adults because language development depends entirely on sharper perception.", "Speech depends on one special muscle.", "Vocabulary is present at birth.", "Humans begin with specialized constraints or capacities for language."] },
    { prompt: "What does a form such as “goed” demonstrate?", options: ["A child is generalizing a pattern rather than only copying a heard form.", "A child has learned no grammar and is repeating a random error without applying any pattern.", "Adults routinely say the same form.", "The child cannot detect patterns."] },
    ...
    { prompt: "What conclusion does the passage support?", options: ["Biology has no role because exposure alone explains every feature of language development.", "One theory has settled every question.", "Language emerges through prepared learners interacting with structured input and people.", "Language is purely imitation."] },
  ],
