...
この まちに ひとつ ぐらい なぞが あっても いいです。`,
      ...
      questions: [
        ...
        { type: 'true-false', skill: 'detail', prompt: 'Verdadero o falso: el vecino Yamada sí sabe qué hay detrás de la puerta.',
          options: [['vrai','Verdadero'],['faux','Falso']], answer: 'faux',
          evidence: '山田さんは 「しりません」と いいました。 パンやさんも しりません。 だれも しりません。',
          correct: 'Falso: ni él, ni el panadero, ni nadie.',
          incorrect: 'Busca la respuesta de Yamada. Está entrecomillada.',
