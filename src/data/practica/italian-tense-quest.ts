...
export const ERROR_CHALLENGES: ErrorChallenge[] = [
  ...
  },
  {
    ...
    chunks: [
      { before: 'Dante ', id: 'e3a', form: 'nascé' },
      { before: ' a Firenze, ', id: 'e3b', form: 'scrisse' },
      { before: ' la Commedia e ', id: 'e3c', form: 'morì' },
    ],
    after: ' a Ravenna.', wrongId: 'e3a', answers: ['nacque'],
  ...
  },
  {
    ...
    chunks: [
      { before: 'Domani a quest’ora ', id: 'e5a', form: 'avró finito' },
      { before: ' il rapporto e lo ', id: 'e5b', form: 'invierò' },
      { before: ' appena il direttore ', id: 'e5c', form: 'arriverà' },
    ],
    after: '.', wrongId: 'e5a', answers: ['avrò finito'],
  ...
  },
  {
    ...
    chunks: [
      { before: 'Ogni lunedì Lucia ', id: 'e7a', form: 'da' },
      { before: ' una lezione, poi ', id: 'e7b', form: 'corregge' },
      { before: ' gli esercizi e ', id: 'e7c', form: 'risponde' },
    ],
    after: ' alle domande.', wrongId: 'e7a', answers: ['dà'],
  ...
  },
  {
    ...
    chunks: [
      { before: 'Signore, ', id: 'e8a', form: 'dimmi' },
      { before: ' il suo cognome, ', id: 'e8b', form: 'controlli' },
      { before: ' i dati e poi ', id: 'e8c', form: 'firmi' },
    ],
    after: ' qui.', wrongId: 'e8a', answers: ['mi dica'],
    explanation: 'Con el tratamiento formal Lei, el imperativo de dire es “dica”: mi dica.',
  },
]
