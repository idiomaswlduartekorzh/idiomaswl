...
export const GERMAN_EDITORIAL_PACKS_BY_FORM = {
  praesens: GERMAN_PRESENT_EDITORIAL,
  'perfekt-haben': GERMAN_PERFECT_HABEN_EDITORIAL,
  'perfekt-sein': GERMAN_PERFECT_SEIN_EDITORIAL,
  praeteritum: GERMAN_PRETERITE_EDITORIAL,
  plusquamperfekt: GERMAN_PLUPERFECT_EDITORIAL,
  'futur-eins': GERMAN_FUTURE_ONE_EDITORIAL,
  'futur-zwei': GERMAN_FUTURE_TWO_EDITORIAL,
  'wuerde-form': GERMAN_WOULD_EDITORIAL,
  'konjunktiv-vergangenheit': GERMAN_UNREAL_PAST_EDITORIAL,
  imperativ: GERMAN_IMPERATIVE_EDITORIAL,
} satisfies Record<GermanFormId, typeof GERMAN_PRESENT_EDITORIAL>

export const GERMAN_EDITORIAL_PACKS = GERMAN_FORMS.map((form) => GERMAN_EDITORIAL_PACKS_BY_FORM[form.id])

export const GERMAN_STRUCTURE_QUEST: TenseQuestConfig<GermanFormId> = {
  id: 'german-structure-quest', storageKey: 'wl-german-structure-quest-v9', forms: GERMAN_FORMS,
  presets: [
