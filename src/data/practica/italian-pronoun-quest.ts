...
const SEEDS: readonly PronounSeed<ItalianPronounTopic>[] = [
  {
    ...
    examples: [
      ...
      {
        context: 'Paolo e Anna arrivano dopo; ___ portano il dolce.', answer: 'loro', distractors: ['noi', 'voi', 'lei'],
        cue: 'El pronombre retoma a dos personas ya mencionadas.', functionAnswer: 'sujeto plural', functionDistractors: ['objeto directo plural', 'posesivo plural', 'demostrativo plural'], wrong: 'li',
  ...
  },
  {
    ...
    examples: [
      ...
      {
        context: 'Vedi ___edificio in fondo alla strada?', answer: 'quell’', distractors: ['quest’', 'quello', 'quella'],
        cue: 'El edificio está lejos y la forma va ante vocal.', functionAnswer: 'determinante demostrativo lejano', functionDistractors: ['pronombre sujeto', 'posesivo', 'objeto indirecto'], wrong: 'quello',
  ...
  },
  {
    ...
    examples: [
      ...
      {
        context: 'Hai visto Anna? Sì, ___ ho vista stamattina.', answer: 'l’', distractors: ['le', 'gli', 'la'],
        cue: 'La vocal provoca elisión y el participio concuerda con Anna.', functionAnswer: 'objeto directo elidido', functionDistractors: ['objeto indirecto', 'artículo posesivo', 'sujeto formal'], wrong: 'le',
  ...
  },
  {
    ...
    examples: [
      ...
      {
        context: 'Tu ___ ricordi il numero della pratica?', answer: 'ti', distractors: ['mi', 'si', 'te'],
        cue: 'Ricordarsi exige el reflexivo de segunda persona.', functionAnswer: 'pronombre reflexivo de segunda persona', functionDistractors: ['pronombre tónico', 'objeto indirecto', 'demostrativo'], wrong: 'te',
        transformPrompt: 'Cambia el sujeto a “lei”: Tu ti chiami Laura.', transformAnswer: 'Lei si chiama Laura.',
        transformDistractors: ['Lei ti chiama Laura.', 'Lei la chiama Laura.', 'Lei si chiamo Laura.'],
      },
    ],
    final: { before: 'Prima di uscire noi ', after: ' controlliamo a vicenda i numeri. ', answer: 'ci' },
  },
  {
    id: 'combinati',
