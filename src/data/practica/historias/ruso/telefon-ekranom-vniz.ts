...
const NARRATOR_QS: Question[] = [
  {
    ...
    opts: [
      'Телефон начал гореть',
      'Экран включился сам, потому что пришло уведомление',
      'Дима взял телефон и разблокировал его',
  ...
  },
  {
    ...
    opts: [
      'Аню телефон совсем не интересовал',
      'Аня хотела посмеяться над Димой, чтобы задеть его',
      'Просьба была завёрнута в шутку, но за ней стояло настоящее намерение',
      'Аня уже смотрела телефон раньше на этой неделе',
    ],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Что те, кто отказывается, обычно устали или заняты',
      'Что невиновный согласился бы, значит отказ сам по себе — доказательство вины',
      'Что Дима обещал делиться телефоном',
      'Что отказывать по-русски всегда невежливо',
    ],
    correct: 1,
    explanation:
...
const A_QS: Question[] = [
  {
    ...
    opts: [
      'Прочитать переписку за два года',
      'Узнать, кто прислал уведомление за ужином',
      'Увидеть, как он сам его отдаёт — просьба была проверкой',
      'Проверить историю геолокации',
    ],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Он построен неправильно грамматически',
      'Он приравнивает отказ к вине, поэтому никакой ответ Диму не оправдает',
      'Он показывает, что Аня уже знает, что в телефоне',
      'Он доказывает, что Ане не важны отношения',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      ...
      'Лёгкий и весёлый от начала до конца',
    ],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Вежливо соглашается, что границы важны в отношениях',
      'Повторяет его же слово с сарказмом, чтобы отбросить его как отговорку',
      'Просит объяснить ей это слово',
      'Цитирует психолога',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Она цитирует юридический текст',
      'Она цитирует его слова, чтобы дистанцироваться и показать, что не принимает обвинение',
      'В русском это выражение всегда требует кавычек',
      'Она не знает, как это перевести',
    ],
    correct: 1,
    explanation:
...
const B_QS: Question[] = [
  {
    ...
    opts: [
      'В телефоне есть сообщения, которые он не хочет показывать',
      'Телефон принадлежит его компании',
  ...
  },
  {
    ...
    opts: [
      ...
      'Точная цитата требования Ани',
      'Извинение за поведение за ужином',
      'Изложение уже случившихся фактов',
    ],
    correct: 0,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Полицейские действительно ведут дело против Димы',
      'Дима считает, что платит за поведение бывшего парня Ани',
      'Дима сделал то же самое, что её бывший',
      'Дима хочет, чтобы Аня связалась с бывшим',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'На то, что Аня никогда не задаёт ему вопросов',
      'На то, что просьбу нельзя пройти честно: любая реакция подтверждает подозрение',
      'На то, что он хочет расстаться',
      'На то, что он не понял вопрос',
    ],
    correct: 1,
    explanation:
...
const FINAL_QS: Question[] = [
  {
    ...
    opts: [
      'Диме написала другая женщина',
      'Аня уже прочитала часть переписки',
  ...
  },
  {
    ...
    opts: [
      'Один из них намеренно врёт о том вечере',
      'Одно и то же действие получает противоположные значения в зависимости от того, символом чего его считают',
      'Ни один из них толком не помнит тот вечер',
      'Дима использует более сложную лексику, чем Аня',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Дима что-то скрывает в телефоне',
      'Аня просто ревнивая',
  ...
  },
  {
    ...
    opts: [
      'Они цитируют один и тот же фильм',
      'Оба используют один образ границы, чтобы защищать противоположные позиции — каждый считает себя тем, кто границу защищает',
      '«Граница» означает совершенно разное в двух случаях',
      'Это доказывает, что Дима копирует лексику Ани',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Аня врала, когда говорила, что хочет посмотреть телефон',
      ...
      'Аня уже открывала телефон раньше',
      'Аня не знает пароль',
    ],
    correct: 1,
    explanation:
