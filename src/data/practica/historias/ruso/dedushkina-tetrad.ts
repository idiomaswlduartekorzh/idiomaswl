...
const NARRATOR_QS: Question[] = [
  {
    ...
    opts: [
      'Он покупал недорогие практичные вещи, чтобы не баловать внука лишним',
      'Он тратил очень много, на дорогие вещи высокого класса',
      'Он предпочитал покупать б/у, потому что дети быстро вырастают из вещей',
      'Он покупал только по скидке, выбирая самый выгодный вариант',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Перемена назревала постепенно, и её давно ожидали',
      'Виктор изначально планировал забрать эти вещи обратно',
  ...
  },
  {
    ...
    opts: [
      ...
      'Бюджет семьи Виктора на ближайший месяц',
      'Договор между Виктором и его сыном',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Виктор был по-настоящему щедрым человеком, и никаких скрытых мотивов у него не было',
      'За этой щедростью, возможно, стояло что-то ещё, чего тогда не заметили',
      'Семья всегда знала, что Виктор ставит условия, но молчала об этом',
      'Виктор с самого начала открыто пытался контролировать семью через деньги',
    ],
    correct: 1,
    explanation:
...
const A_QS: Question[] = [
  {
    ...
    opts: [
      'Метафора — он и правда двигал по квартире её мебель, проверяя каждую вещь',
      'Сравнение — он показан холодным и деловым, подарки для него как товар, который можно вернуть',
      'Гипербола — она сильно преувеличивает ради шутки, ведь на самом деле визит свёкра был совершенно обычным',
      'Олицетворение — она наделяет таблицу человеческими чертами, будто бумага сама предъявляет ей счёт',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Что все родители должны хранить чеки от крупных детских покупок',
      'Что свёкор просто очень аккуратный человек и хранит все бумаги подряд',
      'Что чеки доказывают: он с самого начала рассчитывал их забрать',
      'Что Оля потеряла свои чеки и уже ничего не докажет',
    ],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Прийти с подробной таблицей всех купленных подарков',
      'Сразу потребовать назад коляску, кроватку и комод',
      'Спросить, есть ли что-то, из чего Миша уже вырос',
      'Прислать официальное письмо со списком вещей',
    ],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Серьёзно говорит о его бизнесе с недвижимостью, потому что оттуда и взялись все эти деньги',
      'Использует иронию и вдруг переходит на имя-отчество, чтобы подчеркнуть его деловое отношение к семье',
      'Вежливо соглашается с его точкой зрения и обращается к нему по имени-отчеству из уважения',
      'Дословно цитирует таблицу, которую свёкор принёс к ней на кухню',
    ],
    correct: 1,
    explanation:
...
const B_QS: Question[] = [
  {
    ...
    opts: [
      'Вернуть товар в магазин по чеку и получить обратно свои деньги',
      'Семейный обычай передавать вещи от одного члена семьи к другому из поколения в поколение',
      'Официальную процедуру наследования, при которой семейное имущество по закону делят между всеми родственниками в равных долях',
      'Отдать вещи на благотворительность, чтобы они достались тем, кому нужнее',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Каждую вещь из списка, причём вернуть немедленно',
      'Только деньги с накоплений Миши на учёбу',
      'Разговор о том, чтобы поделить некоторые крупные вещи',
      'Письменные извинения от Оли за отказ',
    ],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Он только делает вид, что вещи ему совсем безразличны',
      'Он чувствует, что его не уважают, несмотря на годы щедрости',
      'Он хочет постепенно вытеснить Олю из своей семьи',
      'Он жалеет, что вообще купил все эти подарки',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Настоящее раскаяние: он признаёт, что с таблицей действительно перегнул палку',
      'Саркастическая защита — он не считает, что сделал что-то не так',
      'Растерянность: он искренне не понимает, почему вся семья теперь на него злится',
      'Академический и официальный регистр, уместный при обсуждении крупных денежных сумм',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Он полностью признаёт свою вину и называет себя так совершенно всерьёз, без иронии',
      'Он чувствует, что ему несправедливо дали роль плохого персонажа в чужой истории',
      'Он использует юридический термин, которым в суде называют человека, совершившего преступление',
      'Он ищет жалости через лесть, чтобы Оля почувствовала себя виноватой',
    ],
    correct: 1,
    explanation:
...
const FINAL_QS: Question[] = [
  ...
  },
  {
    ...
    opts: [
      'Рассказчик настроен против Виктора и пересказывает события словами одной только Оли',
      'Между заявленным намерением Виктора и тем, как его просьбу восприняли, огромная разница',
      'Оля почти всё выдумала, потому что сумма в несколько сотен тысяч сильно преувеличена',
      'Рассказчик ошибся в фактах: на самом деле Виктор ничего вернуть не просил',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Обыкновенная жадность Виктора, который решил вернуть себе потраченные деньги',
      'Неблагодарность Оли, которая три года пользовалась чужими деньгами и ни разу не сказала спасибо',
      'Когда подарки дарили, никто не обсудил, чего от этого ждут',
      'Решение Кати родить ребёнка именно тогда, когда денег в семье не хватало',
    ],
    correct: 2,
    explanation:
  ...
  },
  {
    ...
    opts: [
      'Он изображал удивление как заранее продуманный приём',
  ...
  },
  {
    ...
    opts: [
      'Его сын и Оля действительно ещё совсем молодые, почти дети',
      'Виктор видит себя старшим и опорой, а их — менее опытными людьми, которым он помог',
      'Виктор забыл их имена и поэтому говорит о них так неопределённо',
      'В русском языке «эти дети» — это обычное уважительное обращение старшего к младшим членам своей семьи',
    ],
    correct: 1,
    explanation:
