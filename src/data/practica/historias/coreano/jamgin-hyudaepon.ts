...
const NARRATOR_QS: Question[] = [
  ...
  },
  {
    ...
    opts: [
      '거절하는 사람은 보통 피곤하거나 바쁘다',
      '결백한 사람이라면 보여 줬을 것이다 — 그러니까 거절 자체가 증거다',
      '민호가 휴대폰을 공유하겠다고 약속했었다',
      '한국어에서 거절은 언제나 무례하다',
    ],
    correct: 1,
    explanation:
...
const A_QS: Question[] = [
  ...
  },
  {
    ...
    opts: [
      '연애에서 경계가 중요하다고 정중하게 동의하고 있다',
      '민호가 쓴 단어를 그대로 되돌려 주며 핑계로 치부하고 있다',
      '그 단어의 뜻을 설명해 달라고 하고 있다',
      '상담 선생님의 말을 인용하고 있다',
    ],
    correct: 1,
    explanation:
...
const FINAL_QS: Question[] = [
  ...
  },
  {
    ...
    opts: [
      '둘 중 하나가 일부러 거짓말을 하고 있다',
      '같은 행동이라도 각자가 그것을 무엇의 상징으로 보느냐에 따라 정반대의 뜻이 된다',
      '둘 다 그날 밤을 제대로 기억하지 못한다',
      '민호가 지은보다 어려운 어휘를 쓴다',
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    opts: [
      '두 사람이 같은 영화를 인용하고 있다',
      '같은 「선」의 이미지로 정반대의 입장을 지킨다 — 각자 자기가 선을 지키는 사람이라고 믿는다',
      '두 경우에 「선」의 뜻이 완전히 다르다',
      '민호가 지은의 표현을 따라 한다는 증거다',
    ],
    correct: 1,
    explanation:
