...
export const KOREAN_B1_SERIES: A1ListeningSeries = {
  ...
  episodes: [
    ...
    ep({
      ...
      gist: ['세 사람은 카페에서 무엇을 하나요?', '편지함을 열고 안에 있는 편지를 모두 세어요', '오래된 편지를 골라 전부 버려요', '세 사람이 함께 새 편지를 써요', '소피아가 편지함을 열고 편지를 다 세어 보자고 제안해요.'],
      details: [
        ['편지함 뚜껑은 왜 잘 열리지 않나요?', '오래된 뚜껑이기 때문이에요', '열쇠로 잠가 두었기 때문이에요', '새 편지가 가득 찼기 때문이에요', '유나는 뚜껑이 오래됐기 때문에 잘 안 열린다고 말해요.'],
        ['편지는 모두 몇 장인가요?', '삼백스물두 장이에요', '이백두 장이에요', '서른두 장이에요', '소피아가 모두 삼백스물두 장이라고 세어 알려 줘요.'],
        ['유나는 왜 편지를 함부로 보여 줄 수 없나요?', '자기 것이 아닌 편지들이기 때문이에요', '신문에 먼저 공개할 예정이기 때문이에요', '이사 전에 모두 없앨 예정이기 때문이에요', '유나는 편지가 자기 것이 아니기 때문에 함부로 못 보여 준다고 해요.'],
      ],
      consolidation: ['문장을 완성하세요: 안에서 종이 소리가 ___.', '들려요', '들어요', '들었어요', '들리다는 소리가 저절로 귀에 들어오는 피동 표현이에요. 들어요는 일부러 듣는 행동을 나타내요.'],
    ...
    ep({
      ...
      gist: ['미나와 별은 일을 어떻게 나누나요?', '미나는 이웃에게 알리고 별은 학교에 붙일 포스터를 만들어요', '미나는 포스터를 만들고 별은 카페에 커피를 배달해요', '미나는 기사를 쓰고 별은 새 가게의 계약을 준비해요', '미나는 동네 아주머니들에게 알리고, 별은 포스터를 만들어 학교에 붙이겠다고 해요.'],
      details: [
        ['미나는 소피아를 만났을 때 무엇을 하고 있었나요?', '콩이에게 밥을 먹이고 있었어요', '콩이와 동네를 걷고 있었어요', '카페의 편지함을 닦고 있었어요', '미나는 지금 콩이한테 밥을 먹이고 있었다고 말해요.'],
        ['지호는 기사에 무엇을 보여 주겠다고 했나요?', '편지함만 보여 주고 유나의 얼굴은 빼겠다고 했어요', '편지함과 유나의 얼굴을 함께 보여 주겠다고 했어요', '편지함 속의 편지를 한 장씩 보여 주겠다고 했어요', '소피아가 편지함만 보여 주고 얼굴은 안 보여 주기로 했다고 전해요.'],
        ['별은 오늘 밤에 무엇을 할 예정인가요?', '포스터를 만들어 내일 학교에 붙일 거예요', '편지를 써서 내일 편지함에 넣을 거예요', '카페 사진을 찍어 내일 신문사에 보낼 거예요', '별은 오늘 밤 포스터를 만들고 내일 학교에 붙이겠다고 해요.'],
      ],
      consolidation: ['문장을 완성하세요: 별이 어제 저한테 다 ___.', '알려 줬어요', '알았어요', '알고 있었어요', '알리다는 다른 사람이 알게 한다는 뜻이에요. 알았어요는 말하는 사람이 직접 알게 된 것을 뜻해요.'],
    ...
    ep({
      ...
      gist: ['신문에 실린 기사에는 어떤 문제가 있나요?', '유나의 얼굴과 이름이 모두 공개되었어요', '사진과 이름이 모두 빠진 채로 나왔어요', '신문사가 기사를 끝내 싣지 않았어요', '별은 유나의 얼굴이 크게 나왔고 이름도 쓰여 있다고 말해요.'],
      details: [
        ['기사가 실린 신문은 무슨 요일 신문인가요?', '수요일 신문이에요', '일요일 신문이에요', '토요일 신문이에요', '별이 오늘 수요일 신문에 기사가 실렸다고 말해요.'],
        ['지호는 문제가 된 사진에 대해 뭐라고 하나요?', '자기 사진이 아니며 자신은 편지함만 찍었다고 해요', '자기가 실수로 유나의 얼굴을 찍었다고 해요', '유나가 직접 그 사진을 보내 주었다고 해요', '지호는 자기 사진이 아니고 자신은 편지함만 찍었다고 설명해요.'],
        ['지호의 말에 따르면 그 사진은 어디에서 왔나요?', '편집장이 인터넷에서 찾았다고 해요', '카페 벽에 걸린 사진에서 왔어요', '미나가 가진 사진첩에서 왔어요', '지호는 편집장이 인터넷에서 사진을 찾았다고 전해요.'],
      ],
      consolidation: ['문장을 완성하세요: 오늘 수요일 신문에 지호 기사가 ___.', '실렸어', '실었어', '실을 거야', '실리다는 싣다의 피동 표현으로, 누가 실었는지 말하지 않고 기사가 나온 결과에 초점을 둬요.'],
    ...
    ep({
      ...
      gist: ['유나는 지호의 설명에 어떻게 반응하나요?', '지호에게 책임이 있다고 하고 대화를 끝내요', '지호의 사과를 듣자마자 바로 받아들여요', '지호에게 새로운 기사를 써 달라고 부탁해요', '유나는 책임이 지호에게 있다고 한 뒤 오늘은 그만하자고 말해요.'],
      details: [
        ['어제부터 유나에게 어떤 일이 생기고 있나요?', '모르는 사람들이 계속 전화를 하고 있어요', '손님이 한 명도 카페에 오지 않고 있어요', '건물 주인이 월세를 또 올리고 있어요', '유나는 어제부터 모르는 사람들이 계속 전화를 한다고 말해요.'],
        ['소피아는 사진을 누가 넣었다고 설명하나요?', '신문사의 편집장이 넣었다고 해요', '카페에서 일하는 별이 넣었다고 해요', '사진을 찍은 지호가 넣었다고 해요', '소피아는 편집장이 그 사진을 넣었다고 설명해요.'],
        ['유나는 왜 오늘 대화를 그만하고 싶어 하나요?', '지금 계속하면 서로 더 화가 날 것 같아서예요', '카페에서 해야 할 일이 아주 많이 남아서예요', '새로운 손님이 카페 안으로 들어오고 있어서예요', '유나는 지금 이야기하면 서로 더 화가 날 것이라고 생각해요.'],
      ],
      consolidation: ['지호가 실제로 한 말은 무엇인가요?', '제가 먼저 확인해야 됐어요', '제가 먼저 확인해야 돼요', '제가 먼저 확인하고 있어요', '과거형 확인해야 됐어요는 해야 했지만 하지 못한 일을 인정해요. 현재형은 앞으로의 의무를 나타내요.'],
    ...
    ep({
      ...
      gist: ['지호는 신문사에서 어떤 해결책을 얻어 내나요?', '다음 주에 사진 없는 정정 기사를 내기로 해요', '이미 나온 신문을 모두 거두기로 해요', '지호가 새 편집장이 되어 직접 결정하기로 해요', '편집장은 다음 주에 짧은 정정 기사를 내고 사진은 빼라고 해요.'],
      details: [
        ['편집장은 문제가 된 사진을 어떻게 정당화하나요?', '카페의 인터넷 사진이라 문제가 없다고 해요', '유나가 직접 준 사진이라 괜찮다고 해요', '자신이 직접 찍은 사진이라 괜찮다고 해요', '편집장은 카페 인터넷 사진이기 때문에 문제가 없다고 주장해요.'],
        ['이번 주 신문은 평소와 비교해 얼마나 팔렸나요?', '평소보다 두 배로 팔렸어요', '평소 판매량의 절반만 팔렸어요', '평소와 똑같은 수만큼 팔렸어요', '편집장이 이번 주 신문이 평소보다 두 배로 팔렸다고 말해요.'],
        ['소피아의 말에 따르면 카페에는 시간이 얼마나 남았나요?', '이제 한 달밖에 남지 않았어요', '아직 두 달이나 남아 있어요', '이제 일주일만 남아 있어요', '소피아는 카페에 이제 한 달밖에 안 남았다고 알려 줘요.'],
      ],
      consolidation: ['문장을 완성하세요: 저는 그 카페를 ___ 기사를 썼어요.', '도우려고', '도와서', '도우면', '-(으)려고는 어떤 행동을 하는 의도를 나타내요. 돕다는 모음 앞에서 ㅂ이 없어져 도우려고가 돼요.'],
    ...
    ep({
      ...
      gist: ['유나는 사람들이 몰려오자 어떤 결정을 하나요?', '구경거리가 된 편지함을 오늘부터 닫기로 해요', '손님을 관리할 직원을 더 뽑기로 해요', '그날 바로 카페를 다른 사람에게 팔기로 해요', '유나는 편지함이 구경거리가 아니라고 하며 오늘부터 닫겠다고 해요.'],
      details: [
        ['카페 밖에는 사람이 몇 명쯤 기다리고 있나요?', '스무 명쯤 기다리고 있어요', '세 명쯤 기다리고 있어요', '아무도 기다리지 않고 있어요', '미나는 밖에 스무 명쯤 기다리고 있다고 말해요.'],
        ['어떤 손님은 편지함에서 무엇을 가져갔나요?', '편지 세 장을 가져갔어요', '편지함의 뚜껑을 가져갔어요', '카페의 찻잔 하나를 가져갔어요', '별이 어떤 손님이 편지를 세 장이나 가지고 갔다고 알려 줘요.'],
        ['편지함의 나무는 왜 부서졌나요?', '한 아이가 뚜껑 위에 올라갔기 때문이에요', '밤새 내린 비에 젖었기 때문이에요', '미나가 바닥에 떨어뜨렸기 때문이에요', '별은 한 아이가 뚜껑 위에 올라가서 나무가 부서졌다고 설명해요.'],
      ],
      consolidation: ['문장을 완성하세요: 사람들이 줄을 ___ 사진을 찍고 있어요.', '서면서', '서니까', '서지만', '-(으)면서는 같은 사람이 동시에 하는 두 행동을 연결해요. 사람들은 줄을 서는 동시에 사진을 찍어요.'],
    ...
    ep({
      ...
      gist: ['김 선생님은 유나가 편지함을 닫은 이유를 어떻게 보나요?', '화가 나서가 아니라 두려워서 닫았다고 봐요', '소피아에게 화가 나서 닫았다고 봐요', '건물 주인이 명령해서 닫았다고 봐요', '김 선생님은 유나가 무섭기 때문에 문을 닫은 것이라고 설명해요.'],
      details: [
        ['편지함 위의 안내문에는 무엇이 쓰여 있나요?', '당분간 쉽니다라고 쓰여 있어요', '편지를 판매합니다라고 쓰여 있어요', '목요일에 문을 엽니다라고 쓰여 있어요', '별은 편지함 위에 당분간 쉽니다라는 안내가 쓰여 있다고 읽어요.'],
        ['김 선생님은 사람이 많아지면 편지가 어떻게 된다고 하나요?', '조용한 마음이 사라지듯 편지도 사라진다고 해요', '좋은 이야기를 모아 책으로 내야 한다고 해요', '이제 아무도 편지에 관심이 없다고 해요', '김 선생님은 편지가 조용한 마음이라 사람이 많아지면 사라진다고 설명해요.'],
        ['어제 카페에 와서 편지함을 오래 본 사람은 누구인가요?', '문구점 아주머니예요', '신문사의 편집장이에요', '카페 건물 주인이에요', '별은 어제 문구점 아주머니가 와서 편지함을 한참 보았다고 해요.'],
      ],
      consolidation: ['문장을 완성하세요: 유나 씨는 ___ 문을 닫은 거예요.', '무섭기 때문에', '무서우면', '무섭지만', '-기 때문에는 원인을 나타내요. 무서우면은 조건을, 무섭지만은 서로 반대되는 내용을 연결해요.'],
    ...
    ep({
      ...
      gist: ['토론 끝에 세 친구는 무엇을 하기로 하나요?', '신문 대신 직접 다니며 빈 가게를 찾아보기로 해요', '신문사에 카페 기사를 더 써 달라고 부탁하기로 해요', '더 이상 돕지 않고 카페가 닫히게 두기로 해요', '별이 신문 대신 발로 뛰자고 하고 소피아가 부동산에 가자고 제안해요.'],
      details: [
        ['정정 기사가 나온 뒤 어떤 일이 있었나요?', '한 사람이 도와주고 싶다고 연락했어요', '신문사에 아무도 연락하지 않았어요', '카페가 구청에서 벌금을 받았어요', '지호는 어떤 사람이 도와주고 싶다고 연락했다고 말해요.'],
        ['지호는 왜 현실적인 도움이 필요하다고 생각하나요?', '돈이 없으면 새 가게를 구할 수 없기 때문이에요', '편집장이 계속 도우라고 명령했기 때문이에요', '자신이 신문을 통해 유명해지고 싶기 때문이에요', '지호는 돈이 없으면 새 가게도 구하지 못한다고 말해요.'],
        ['세 친구는 다음 날 무엇부터 하기로 하나요?', '동네 부동산 세 군데를 찾아가기로 해요', '신문사 편집장을 다시 만나기로 해요', '카페 편지함을 다시 열기로 해요', '소피아가 다음 날 아침 동네 부동산부터 세 군데 가 보자고 해요.'],
      ],
      consolidation: ['오디오에서 들은 문장을 고르세요.', '유나 씨한테 먼저 물어보는 게 맞다고 생각해', '유나 씨한테 먼저 물어보는 게 맞다고 생각해요', '유나 씨한테 먼저 물어보는 게 맞다고 생각합니다', '세 친구는 1화부터 서로 반말을 써요. 따라서 이 장면에서는 문장 끝에 -요가 붙지 않아요.'],
    ...
    ep({
      ...
      gist: ['문구점 주인은 카페를 돕기 위해 무엇을 제안하나요?', '옆의 빈 가게를 절반의 월세로 알아보라고 해요', '별 그림 편지지를 무료로 계속 주겠다고 해요', '자기가 지금의 카페를 직접 사겠다고 해요', '주인은 옆 빈 가게를 한번 보라고 하며 월세도 반이라고 알려 줘요.'],
      details: [
        ['별 그림 편지지는 서울 어디에서 팔리나요?', '그 문구점에서만 팔려요', '동네 모든 문구점에서 팔려요', '이제는 어디에서도 팔리지 않아요', '문구점 주인은 서울에서 자기 가게에만 있다고 말해요.'],
        ['문구점 주인은 신문 기사를 어떻게 바로 알아보았나요?', '사진 속 편지지가 자기 가게 물건이었기 때문이에요', '신문에 자기 얼굴이 크게 나왔기 때문이에요', '김 선생님이 미리 기사 소식을 전했기 때문이에요', '주인은 사진 속 편지지가 자기 가게 것이어서 금방 알았다고 해요.'],
        ['문구점 주인은 어떤 이야기를 다음으로 미루나요?', '옛날에 자신이 썼던 편지에 관한 이야기예요', '옆 빈 가게의 정확한 월세에 관한 이야기예요', '카페 건물 주인의 이름에 관한 이야기예요', '주인은 그 이야기가 길기 때문에 다음에 해 주겠다고 말해요.'],
      ],
      consolidation: ['문장을 완성하세요: 이 편지지가 아직도 여기에서만 ___?', '팔려요', '팔아요', '팔았어요', '팔리다는 팔다의 피동 표현으로, 누가 파는지보다 물건이 판매되는 상태에 초점을 둬요.'],
    ...
    ep({
      ...
      gist: ['문구점 주인의 이야기에서 어떤 사실이 드러나나요?', '유나가 받은 오래된 편지를 그 주인이 썼어요', '별 카페의 편지함을 그 주인이 처음 만들었어요', '그 주인이 오 년 전에 카페 직원으로 일했어요', '주인은 편지를 책 사이에 넣었고 그때의 직원이 지금 카페 사장이라고 해요.'],
      details: [
        ['문구점 주인이 말한 일은 언제 있었나요?', '오 년 전 겨울에 있었어요', '이 년 전 여름에 있었어요', '바로 지난겨울에 있었어요', '문구점 주인은 오 년 전 겨울에 별 카페에 자주 갔다고 말해요.'],
        ['그날 새 직원은 무엇을 하고 있었나요?', '책을 읽으면서 울고 있었어요', '말없이 커피를 나르고 있었어요', '문구점 편지지에 편지를 쓰고 있었어요', '주인은 새 직원이 책을 읽으면서 울고 있었다고 기억해요.'],
        ['문구점 주인은 왜 그 직원에게 편지를 썼나요?', '울고 있는 직원을 위로해 주려고 썼어요', '자기 가게의 편지지를 팔려고 썼어요', '지난 실수에 대해 사과하려고 썼어요', '주인은 그 직원을 위로해 주려고 편지지에 짧게 썼다고 해요.'],
      ],
      consolidation: ['문장을 완성하세요: ___ 우리 가게 편지지에 짧게 썼어요.', '위로해 주려고', '위로해 줘서', '위로해 주면', '-(으)려고는 행동의 의도를 나타내요. 여기서는 직원을 위로하려는 마음으로 편지를 쓴 것이에요.'],
    ...
    ep({
      ...
      gist: ['유나는 놀라운 이야기를 들은 뒤 어떻게 행동하나요?', '지호에게 사과하고 함께 문구점에 가자고 부탁해요', '지호에게 다시는 카페에 오지 말라고 말해요', '지호와 새로운 신문 기사를 내기로 결정해요', '유나는 너무 심하게 말했다고 사과한 뒤 지호에게 같이 가 달라고 해요.'],
      details: [
        ['유나는 두 사람에게 원래 무슨 말을 하고 싶었나요?', '자기도 미안하다고 말하고 싶었어요', '카페를 더 일찍 닫겠다고 말하고 싶었어요', '다른 도시로 떠나겠다고 말하고 싶었어요', '유나는 두 사람에게 미안하다고 말하고 싶었다고 밝혀요.'],
        ['유나는 자신이 다닌 문구점에 관해 무엇을 깨닫나요?', '편지를 쓴 여자의 가게와 같은 곳이라는 사실이에요', '그 편지지를 이제 더는 팔지 않는다는 사실이에요', '건물 주인이 곧 그 문구점을 산다는 사실이에요', '유나가 자신이 편지지를 산 가게를 떠올리자 소피아가 같은 가게라고 확인해요.'],
        ['소피아는 문구점 주인이 무엇을 모를 것이라고 생각하나요?', '유나의 이름도 모를 것이라고 생각해요', '유나가 편지를 보관한 곳을 모를 것이라고 생각해요', '유나가 카페 사장이라는 사실을 모를 것이라고 생각해요', '소피아는 문구점 주인이 유나의 이름도 모르실 것이라고 말해요.'],
      ],
      consolidation: ['문장을 완성하세요: 제 기사 때문에 유나 씨가 ___.', '힘들게 됐어요', '힘들어야 돼요', '힘든 것 같아요', '-게 되다는 원하지 않았지만 그렇게 된 결과를 나타내요. 다른 두 표현은 의무와 추측을 나타내요.'],
    ...
    ep({
      ...
      gist: ['빈 가게를 둘러본 뒤 유나는 어떤 결정을 하나요?', '팔월 이십오 일에 그곳으로 이사하기로 해요', '가게가 너무 작아서 계약하지 않기로 해요', '문구점을 지금의 카페 자리로 옮기기로 해요', '유나는 마음에 드는 가게를 보고 팔월 이십오 일에 이사하겠다고 해요.'],
      details: [
        ['유나는 새 가게의 어떤 점을 마음에 들어 하나요?', '아침에 창문으로 햇빛이 잘 들어오는 점이에요', '여러 사람이 일할 만큼 부엌이 아주 큰 점이에요', '가게 안에 넓은 창고가 따로 있는 점이에요', '유나는 아침에 햇빛이 잘 들어올 것 같아 마음에 든다고 해요.'],
        ['문구점 주인은 유나에게 어떤 도움을 제안하나요?', '자기 가게의 창고를 쓰게 해 주겠다고 해요', '첫 달 월세를 대신 내 주겠다고 해요', '새 커피 기계를 선물로 주겠다고 해요', '문구점 주인은 자기 가게 창고를 쓰게 해 주겠다고 말해요.'],
        ['부서진 편지함 뚜껑은 누가 고쳐 주나요?', '문구점 주인의 남편이 고쳐 줘요', '별이 혼자서 모두 고쳐 줘요', '신문사에서 보낸 목수가 고쳐 줘요', '문구점 주인은 자기 남편이 부서진 뚜껑을 고쳐 줄 것이라고 해요.'],
      ],
      consolidation: ['문장을 완성하세요: 우리 가게 창고를 ___.', '쓰게 해 줄게요', '쓰고 싶어요', '썼어요', '-게 해 주다는 다른 사람이 어떤 행동을 할 수 있도록 허락하거나 도와준다는 뜻이에요.'],
    ...
    ep({
      ...
      gist: ['이사 일주일 전, 사람들은 카페에서 무엇을 하나요?', '이사를 준비하며 카페의 물건을 모두 정리해요', '새 카페가 문을 연 것을 함께 축하해요', '보관한 편지를 동네 사람들에게 나누어 줘요', '김 선생님은 이사가 일주일 남았기 때문에 오늘 다 정리해야 한다고 해요.'],
      details: [
        ['삼백스물두 장의 편지는 어떻게 보관했나요?', '다섯 개의 상자에 나누어 넣었어요', '큰 비닐봉지 하나에 모두 넣었어요', '문구점 창고의 서랍에 나누어 넣었어요', '소피아가 편지를 상자 다섯 개에 나누어서 넣었다고 말해요.'],
        ['편지 상자는 왜 다른 물건보다 위에 놓아야 하나요?', '편지가 물에 젖으면 안 되기 때문이에요', '상자가 다른 물건보다 가볍기 때문이에요', '차에 더 많은 짐을 넣어야 하기 때문이에요', '김 선생님은 편지가 젖으면 안 되니까 상자를 위에 놓으라고 해요.'],
        ['지호는 이번에 사진을 찍기 전에 무엇을 하나요?', '먼저 유나에게 사진을 찍어도 되는지 물어요', '아무에게도 알리지 않고 바로 사진을 찍어요', '카메라를 가져오지 않아 사진을 포기해요', '지호는 먼저 유나에게 오늘 사진을 찍어도 되는지 물어봐요.'],
      ],
      consolidation: ['문장을 완성하세요: 이사가 일주일 ___ 오늘 다 정리해야 돼요.', '남았기 때문에', '남았지만', '남으면', '-기 때문에는 오늘 정리해야 하는 원인을 나타내요. 남았지만은 대조를, 남으면은 조건을 나타내요.'],
    ...
    ep({
      ...
      gist: ['이사하는 날 편지함에는 어떤 변화가 생기나요?', '수리된 채 새 가게로 옮겨지고 첫 편지도 받아요', '옮기는 중에 완전히 부서져 사용할 수 없게 돼요', '새 가게에 자리가 없어 예전 가게에 남겨 둬요', '별은 뚜껑이 다 고쳐졌다고 하고 미나는 첫 편지가 벌써 들어왔다고 알려 줘요.'],
      details: [
        ['수리한 편지함에는 별이 모두 몇 개 있나요?', '별이 모두 열두 개 있어요', '별이 모두 열 개 있어요', '별이 모두 두 개 있어요', '별은 별 그림이 열 개에서 열두 개가 되었다고 설명해요.'],
        ['별은 왜 별 그림 두 개를 더 그렸나요?', '이 년 전 답장 끝에 별 두 개가 있었기 때문이에요', '함께 일한 친구가 두 명뿐이었기 때문이에요', '편지함에 빈 자리가 두 곳 남았기 때문이에요', '별은 이 년 전 답장 끝에 별이 두 개 있었던 것을 기억하며 그렸다고 해요.'],
        ['새 편지함에 첫 편지를 넣은 사람은 누구인가요?', '별 그림 편지지를 파는 문구점 주인이에요', '세 사람을 가르친 한국어 학원 선생님이에요', '잡지사에서 번역하는 소피아예요', '미나는 문구점 아주머니가 첫 편지를 벌써 넣으셨다고 알려 줘요.'],
      ],
      consolidation: ['문장을 완성하세요: 뚜껑은 다 ___.', '고쳐졌어', '고쳤어', '고칠 거야', '고쳐지다는 피동 표현으로, 누가 고쳤는지 말하지 않고 뚜껑이 수리된 결과를 나타내요.'],
    ...
    ep({
      ...
      gist: ['새 별 카페에서 이야기는 어떻게 끝나나요?', '편지함을 다시 열고 조용하고 천천히 새로 시작해요', '카페와 편지함이 모두 영원히 문을 닫아요', '유나가 편지함을 박물관에 팔기로 결정해요', '마지막에 유나가 편지함을 다시 열고 조용히, 천천히 시작하자고 해요.'],
      details: [
        ['학원 학생들은 편지를 몇 장 써서 가져왔나요?', '편지를 여덟 장 가져왔어요', '편지를 두 장 가져왔어요', '편지를 스물세 장 가져왔어요', '김 선생님은 학생들이 편지를 여덟 장이나 써서 가져왔다고 말해요.'],
        ['문구점 주인은 어떤 사실을 듣고 놀랐나요?', '유나가 오 년 전 편지를 아직 가지고 있다는 사실이에요', '별 카페가 다른 곳으로 이사했다는 사실이에요', '유나가 자신을 전혀 기억하지 못한다는 사실이에요', '주인은 유나가 오 년 전 자신의 편지를 아직 가지고 있다고 들어서 놀랐어요.'],
        ['새 카페의 벽에는 무엇이 걸려 있나요?', '편지함만 나온 지호의 사진이 걸려 있어요', '별이 처음 만든 포스터가 걸려 있어요', '유나의 얼굴이 나온 신문이 걸려 있어요', '별은 벽에 지호의 사진을 걸었으며 편지함만 나온 사진이라고 설명해요.'],
      ],
      consolidation: ['문장을 완성하세요: 그때 아주머니 편지 ___ 저는 서울에 남게 됐어요.', '때문에', '대신에', '전에', '때문에는 서울에 남게 된 원인을 나타내요. 대신에는 대체를, 전에는 앞선 시간을 나타내요.'],
