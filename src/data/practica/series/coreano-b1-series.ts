...
export const KOREAN_B1_SERIES: A1ListeningSeries = {
  ...
  episodes: [
    ep({
      id: 'ko-b1-01-i-nyeon-hu', order: 1, title: '이 년 후', titleEs: 'Dos años después', duration: 56,
      ...
      gist: ['¿Qué cambia en este reencuentro?', 'Cada uno estrena trabajo y los tres deciden tutearse', 'Sofía anuncia que vuelve a Colombia', 'El café acaba de abrir un segundo local', 'Jiho propone 말을 놓는 게 어때요? y desde ahí hablan en banmal.'],
      details: [
        ['¿En qué trabaja ahora Sofía?', 'Traduce en una revista del barrio', 'Da clases de español en la academia', 'Sirve mesas en el café', 'Dice 동네 잡지사에서 번역을 하게 됐어요.'],
        ['¿Cuántas cartas se han juntado en el buzón?', 'Más de trescientas en dos años', 'Veintitrés', 'Justo cincuenta', 'Byeol dice 이 년 동안 삼백 장이 넘었어.'],
        ['¿Qué cuenta Jiho sobre Yuna?', 'Que desde el año pasado es la dueña del café', 'Que dejó el café hace un año', 'Que se mudó a otra ciudad', 'Dice 작년부터 유나 씨가 카페 사장이 됐어.'],
      ],
      consolidation: ['Completa: 저는 이번 달부터 동네 잡지사에서 번역을 ___.', '하게 됐어요', '하고 싶었어요', '한 것 같아요', '-게 되다 presenta un cambio de situación que no se decidió del todo: «acabé haciendo».'],
    ...
    ep({
      id: 'ko-b1-02-wolsega-du-bae', order: 2, title: '월세가 두 배예요', titleEs: 'El alquiler es el doble', duration: 59,
      ...
      gist: ['¿Qué anuncia Yuna?', 'Que el café cierra porque el alquiler se duplica', 'Que va a abrir un local más grande', 'Que deja el café para estudiar', 'Dice 월세가 두 배가 되기 때문에 계약을 다시 못 해요.'],
      details: [
        ['¿Cuánto sube el alquiler?', 'Se pone al doble', 'Sube un poco cada año', 'No sube, baja', 'Se oye 월세가 두 배가 되기 때문에.'],
        ['¿Hasta cuándo tiene que dejar el local?', 'Hasta finales de agosto', 'Hasta finales de julio', 'Hasta fin de año', 'Dice 팔월 말까지 짐을 다 빼기로 했어요.'],
        ['¿Qué es lo que más preocupa a Yuna?', 'El buzón de cartas', 'Las mesas y las sillas', 'Encontrar otro trabajo', 'Dice 그것 때문에 제일 걱정이에요… 편지함은 이 카페의 마음이니까요.'],
      ],
      consolidation: ['Completa: 다음 달부터 월세가 두 배가 ___ 계약을 다시 못 해요.', '되기 때문에', '되지만', '되면', '-기 때문에 presenta la causa como un hecho; 되지만 opondría y 되면 pondría una condición.'],
    ...
    ep({
      id: 'ko-b1-03-omgyeoya-doendago-haeyo', order: 3, title: '가게를 옮겨야 된대요', titleEs: 'Dicen que hay que mudar la tienda', duration: 70,
      ...
      gist: ['¿Qué deciden delante de la academia?', 'Buscar ellos una solución antes de agosto', 'Pedirle dinero a Yuna', 'Cerrar el buzón cuanto antes', 'La profesora dice 우리가 먼저 방법을 찾아야 돼요.'],
      details: [
        ['¿Qué le cuenta Byeol a la profesora?', 'Que Yuna dice que tiene que mudar el local', 'Que Yuna ya encontró un local nuevo', 'Que el café cerró la semana pasada', 'Dice 유나 씨가 가게를 옮겨야 된다고 해요.'],
        ['¿Qué había oído ya la profesora?', 'Que el dueño del edificio subió mucho el alquiler', 'Que el café se vendió', 'Que la academia también cierra', 'Dice 월세를 많이 올렸다고 들었어요.'],
        ['¿Qué dijo Yuna sobre pedir ayuda?', 'Que no quiere pedírsela a nadie', 'Que solo aceptará ayuda de la profesora', 'Que ya la pidió en el barrio', 'Byeol dice 아무한테도 부탁하고 싶지 않다고 했어요.'],
      ],
      consolidation: ['Completa: 그래서 우리가 팔월 전에 새 가게를 ___.', '찾아야 돼요', '찾고 있어요', '찾은 것 같아요', '-아/어야 되다 expresa obligación; las otras dos formas solo describirían lo que pasa.'],
    ...
    ep({
      id: 'ko-b1-04-gisareul-sseuryeogo', order: 4, title: '기사를 쓰려고 해요', titleEs: 'Quiero escribir un reportaje', duration: 45,
      ...
      gist: ['¿Qué se decide en la redacción?', 'Que el reportaje sale sin el nombre pero con foto', 'Que el reportaje no se publica', 'Que lo escribirá Sofía', 'El jefe dice 이름은 빼고 사진만 넣어요.'],
      details: [
        ['¿Qué pone el jefe como condición?', 'Que haya foto y nombre de la dueña', 'Que el texto sea muy corto', 'Que lo firme Sofía', 'Dice 사진하고 주인 이름이 없으면 기사가 안 나가요.'],
        ['¿Qué dice Jiho que quiere Yuna?', 'Vivir tranquila y solo escribir cartas', 'Aparecer en el periódico', 'Vender el café cuanto antes', 'Dice 조용히 살면서 편지만 쓰고 싶어 해요.'],
        ['¿Qué le aconseja Sofía a Jiho?', 'Preguntarle antes a Yuna', 'Publicarlo sin avisar', 'Hablar primero con la profesora', 'Dice 유나 씨한테 먼저 물어보는 게 좋다고 생각해.'],
      ],
      consolidation: ['Completa: 유나 씨는 조용히 ___ 편지만 쓰고 싶어 해요.', '살면서', '살아서', '살면', '-(으)면서 une dos acciones simultáneas del mismo sujeto: vivir tranquila y escribir.'],
    ...
    ep({
      id: 'ko-b1-05-eopseojil-tende', order: 5, title: '없어질 텐데요', titleEs: 'Pero desaparecerá', duration: 54,
      ...
      gist: ['¿En qué quedan Jiho y Yuna?', 'En publicar solo fotos del buzón, sin cara ni nombre', 'En no publicar nada', 'En publicar una entrevista larga con Yuna', 'Yuna dice 편지함 사진만 찍어요. 제 얼굴하고 이름은 넣지 마세요.'],
      details: [
        ['¿Qué teme Yuna que ocurra con el reportaje?', 'Que el buzón pierda su sentido', 'Que nadie lea el periódico', 'Que suba aún más el alquiler', 'Dice 편지함의 의미가 없어질 텐데요.'],
        ['¿Qué argumento usa Byeol?', 'Que sin hacer nada el café desaparece en agosto', 'Que el periódico paga bien', 'Que el buzón ya está lleno', 'Dice 이대로 두면 팔월에 카페가 없어질 텐데요.'],
        ['¿Qué promete Jiho?', 'No escribir nada que Yuna no quiera', 'Escribir el reportaje sin fotos', 'Dejar el trabajo del periódico', 'Dice 유나 씨가 원하지 않는 건 안 쓸게요.'],
      ],
      consolidation: ['Completa: 이대로 두면 팔월에 카페가 ___.', '없어질 텐데요', '없어졌어요', '없어질까요', '-(으)ㄹ 텐데 supone algo muy probable y deja la frase abierta a la objeción del otro.'],
    ...
    ep({
      id: 'ko-b1-06-pyeonjihameul-yeoreoyo', order: 6, title: '편지함을 열어요', titleEs: 'Abrimos el buzón', duration: 60,
    ...
    ep({
      id: 'ko-b1-07-dongnee-allyeoyo', order: 7, title: '동네에 알려요', titleEs: 'Avisamos al barrio', duration: 60,
    ...
    ep({
      id: 'ko-b1-08-gisaga-sillyeosseo', order: 8, title: '기사가 실렸어', titleEs: 'Salió el reportaje', duration: 52,
    ...
    ep({
      id: 'ko-b1-09-hwaga-nasseoyo', order: 9, title: '책임은 지호 씨한테 있어요', titleEs: 'La responsabilidad es tuya', duration: 55,
    ...
    ep({
      id: 'ko-b1-10-jeongjeong-gisa', order: 10, title: '정정 기사', titleEs: 'La rectificación', duration: 49,
    ...
    ep({
      id: 'ko-b1-11-sonnimi-neomu-manayo', order: 11, title: '손님이 너무 많아요', titleEs: 'Hay demasiada gente', duration: 55,
    ...
    ep({
      id: 'ko-b1-12-dangbungan-swimnida', order: 12, title: '당분간 쉽니다', titleEs: 'Cerrado por un tiempo', duration: 66,
    ...
    ep({
      id: 'ko-b1-13-sinmun-daesin-ballo', order: 13, title: '신문 대신 발로', titleEs: 'A pie, en vez de en el periódico', duration: 49,
    ...
    ep({
      id: 'ko-b1-14-mungujeom-ajumeoni', order: 14, title: '문구점 아주머니', titleEs: 'La señora de la papelería', duration: 64,
    ...
    ep({
      id: 'ko-b1-15-o-nyeon-jeon-geu-sonnim', order: 15, title: '오 년 전 그 손님', titleEs: 'Aquella clienta de hace cinco años', duration: 57,
    ...
    ep({
      id: 'ko-b1-16-simhage-malhaesseoyo', order: 16, title: '제가 너무 심하게 말했어요', titleEs: 'Te hablé demasiado duro', duration: 56,
    ...
    ep({
      id: 'ko-b1-17-bin-gagereul-bogo', order: 17, title: '빈 가게를 보러 갔어요', titleEs: 'Fuimos a ver el local vacío', duration: 56,
    ...
    ep({
      id: 'ko-b1-18-iljuil-namasseoyo', order: 18, title: '일주일 남았어요', titleEs: 'Queda una semana', duration: 51,
    ...
    ep({
      id: 'ko-b1-19-isahaneun-nal', order: 19, title: '이사하는 날', titleEs: 'El día de la mudanza', duration: 52,
    ...
    ep({
      id: 'ko-b1-20-sae-byeol-kapeui-pyeonjiham', order: 20, title: '새 별 카페의 편지함', titleEs: 'El buzón del nuevo Café Estrella', duration: 59,
