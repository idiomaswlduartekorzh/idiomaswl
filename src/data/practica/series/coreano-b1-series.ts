...
export const KOREAN_B1_SERIES: A1ListeningSeries = {
  ...
  episodes: [
    ep({
      id: 'ko-b1-01-i-nyeon-hu', order: 1, title: '이 년 후', titleEs: 'Dos años después', duration: 66,
    ...
    ep({
      id: 'ko-b1-02-wolsega-du-bae', order: 2, title: '월세가 두 배예요', titleEs: 'El alquiler es el doble', duration: 68,
    ...
    ep({
      id: 'ko-b1-03-omgyeoya-doendago-haeyo', order: 3, title: '가게를 옮겨야 된대요', titleEs: 'Dicen que hay que mudar la tienda', duration: 66,
    ...
    ep({
      id: 'ko-b1-04-gisareul-sseuryeogo', order: 4, title: '기사를 쓰려고 해요', titleEs: 'Quiero escribir un reportaje', duration: 66,
    ...
    ep({
      id: 'ko-b1-05-eopseojil-tende', order: 5, title: '없어질 텐데요', titleEs: 'Pero desaparecerá', duration: 66,
    ...
    ep({
      id: 'ko-b1-06-pyeonjihameul-yeoreoyo', order: 6, title: '편지함을 열어요', titleEs: 'Abrimos el buzón', duration: 68,
    ...
    ep({
      id: 'ko-b1-07-dongnee-allyeoyo', order: 7, title: '동네에 알려요', titleEs: 'Avisamos al barrio', duration: 66,
    ...
    ep({
      id: 'ko-b1-08-gisaga-sillyeosseo', order: 8, title: '기사가 실렸어', titleEs: 'Salió el reportaje', duration: 66,
    ...
    ep({
      id: 'ko-b1-09-hwaga-nasseoyo', order: 9, title: '책임은 지호 씨한테 있어요', titleEs: 'La responsabilidad es tuya', duration: 66,
    ...
    ep({
      id: 'ko-b1-10-jeongjeong-gisa', order: 10, title: '정정 기사', titleEs: 'La rectificación', duration: 66,
    ...
    ep({
      id: 'ko-b1-11-sonnimi-neomu-manayo', order: 11, title: '손님이 너무 많아요', titleEs: 'Hay demasiada gente', duration: 66,
    ...
    ep({
      id: 'ko-b1-12-dangbungan-swimnida', order: 12, title: '당분간 쉽니다', titleEs: 'Cerrado por un tiempo', duration: 68,
    ...
    ep({
      id: 'ko-b1-13-sinmun-daesin-ballo', order: 13, title: '신문 대신 발로', titleEs: 'A pie, en vez de en el periódico', duration: 66,
    ...
    ep({
      id: 'ko-b1-14-mungujeom-ajumeoni', order: 14, title: '문구점 아주머니', titleEs: 'La señora de la papelería', duration: 66,
    ...
    ep({
      id: 'ko-b1-15-o-nyeon-jeon-geu-sonnim', order: 15, title: '오 년 전 그 손님', titleEs: 'Aquella clienta de hace cinco años', duration: 68,
    ...
    ep({
      id: 'ko-b1-16-simhage-malhaesseoyo', order: 16, title: '제가 너무 심하게 말했어요', titleEs: 'Te hablé demasiado duro', duration: 68,
    ...
    ep({
      id: 'ko-b1-17-bin-gagereul-bogo', order: 17, title: '빈 가게를 보러 갔어요', titleEs: 'Fuimos a ver el local vacío', duration: 66,
    ...
    ep({
      id: 'ko-b1-18-iljuil-namasseoyo', order: 18, title: '일주일 남았어요', titleEs: 'Queda una semana', duration: 64,
    ...
    ep({
      id: 'ko-b1-19-isahaneun-nal', order: 19, title: '이사하는 날', titleEs: 'El día de la mudanza', duration: 68,
    ...
    ep({
      id: 'ko-b1-20-sae-byeol-kapeui-pyeonjiham', order: 20, title: '새 별 카페의 편지함', titleEs: 'El buzón del nuevo Café Estrella', duration: 66,
