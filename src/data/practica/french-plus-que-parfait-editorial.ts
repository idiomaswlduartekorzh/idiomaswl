...
const errors: FrenchEditorialErrorSeed[] = [
  { title: 'Avant le service', pieces: [['Le chef ', 'avait finalisé'], [' le menu. Son équipe ', 'a préparé'], [' les légumes et la responsable ', 'avait confirmé']], after: ' les réservations avant l’arrivée des clients.', wrong: 1, answers: ['avait préparé'], reason: 'Les trois préparatifs sont antérieurs à l’arrivée passée ; le plus-que-parfait reste nécessaire.' },
  { title: 'Avant la police', pieces: [['Les intrus ', 'avaient forcé'], [' une fenêtre, ', 'avaient pris'], [' les ordinateurs et ', 'avaient sortis']], after: ' par la cour avant l’arrivée de la police.', wrong: 2, answers: ['étaient sortis'], reason: 'Le verbe intransitif « sortir » se construit ici avec être.' },
  ...
  { title: 'Avant la reprise', pieces: [['L’ingénieure ', 'avait corrigé'], [' les plans. La mairie ', 'avait signé'], [' le permis et les fournisseurs ', 'avait livré']], after: ' les matériaux.', wrong: 2, answers: ['avaient livré'], reason: 'Le sujet pluriel « les fournisseurs » exige « avaient livré ».' },
