...
const SEPARATION_SEEDS: Record<GermanFormId, SeparationSeed[]> = {
  ...
  'perfekt-haben': [
    ['aufräumen', 'separable', 'Nach dem Umzug hat Lea das Lager ', '.', 'aufgeräumt'],
    ['anrufen', 'separable', 'Hat der Arzt den Patienten schon ', '?', 'angerufen'],
    ['mitbringen', 'separable', 'Zum Termin habt ihr alle Unterlagen ', '.', 'mitgebracht'],
    ['vorbereiten', 'separable', 'Vor Beginn haben wir die Sitzung sorgfältig ', '.', 'vorbereitet'],
    ['teilnehmen', 'separable', 'Milan erzählt, dass er am Workshop ', '.', 'teilgenommen hat'],
    ['besuchen', 'inseparable', 'Am Wochenende hat Nora ihre Tante ', '.', 'besucht'],
    ['verstehen', 'inseparable', 'Nachdem du das Beispiel gesehen hast, hast du die Aufgabe ', '.', 'verstanden'],
    ['erzählen', 'inseparable', 'Die Zeugin hat der Polizei alles ', '.', 'erzählt'],
    ['bekommen', 'inseparable', 'Die Gewinner freuen sich, weil sie ihre Urkunden ', '.', 'bekommen haben'],
    ['entdecken', 'inseparable', 'Hat das Team den Fehler rechtzeitig ', '?', 'entdeckt'],
  ],
  'perfekt-sein': [
    ['ankommen', 'separable', 'Nora ist gestern pünktlich ', '.', 'angekommen'],
    ['abfahren', 'separable', 'Ist der Zug schon ', '?', 'abgefahren'],
    ['aufstehen', 'separable', 'Obwohl der Wecker leise war, ist Mila früh ', '.', 'aufgestanden'],
    ['zurückkehren', 'separable', 'Die Wanderer melden, dass sie sicher ', '.', 'zurückgekehrt sind'],
    ['ausgehen', 'separable', 'Nach dem Konzert sind wir noch zusammen ', '.', 'ausgegangen'],
    ['verschwinden', 'inseparable', 'Seit gestern ist der Schlüssel spurlos ', '.', 'verschwunden'],
    ['erscheinen', 'inseparable', 'Die Autorin freut sich, weil ihr neuer Roman endlich ', '.', 'erschienen ist'],
    ['geschehen', 'inseparable', 'Niemand weiß genau, was in der Nacht ', '.', 'geschehen ist'],
    ['entkommen', 'inseparable', 'Wie ist das Tier aus dem Gehege ', '?', 'entkommen'],
    ['verunglücken', 'inseparable', 'Bei dem Unfall ist ein Fahrer schwer ', '.', 'verunglückt'],
  ],
  praeteritum: [
  ...
  'futur-eins': [
    ['anmelden', 'separable', 'Mara wird das Team morgen ', '.', 'anmelden'],
    ['aufbauen', 'separable', 'Werden die Helfer die Bühne rechtzeitig ', '?', 'aufbauen'],
    ['mitfahren', 'separable', 'Wenn genug Platz ist, wirst du am Samstag ', '.', 'mitfahren'],
    ['vorstellen', 'separable', 'Der Forscher kündigt an, dass er die Ergebnisse ', '.', 'vorstellen wird'],
    ['zurückkommen', 'separable', 'Im Mai wird Nora aus Hamburg ', '.', 'zurückkommen'],
    ['besuchen', 'inseparable', 'Wir versprechen, dass wir euch bald ', '.', 'besuchen werden'],
    ['veröffentlichen', 'inseparable', 'Nach der Schlussredaktion wird das Team den Artikel ', '.', 'veröffentlichen'],
    ['erklären', 'inseparable', 'Der Trainer wird die neue Regel nach der Pause ', '.', 'erklären'],
    ['bekommen', 'inseparable', 'Falls der Antrag genehmigt wird, werdet ihr rechtzeitig Hilfe ', '.', 'bekommen'],
    ['entdecken', 'inseparable', 'Die Forschungsleitung erwartet, dass das Teleskop neue Sterne ', '.', 'entdecken wird'],
  ],
  'futur-zwei': [
    ...
    ['erreichen', 'inseparable', 'Bis zum Abend am Gipfeltag wird die Gruppe ihr Ziel ', '.', 'erreicht haben'],
    ['bestellen', 'inseparable', 'Vor dem Fest wird die Küche alle Zutaten ', '.', 'bestellt haben'],
  ],
  'wuerde-form': [
    ['anrufen', 'separable', 'Mit deiner Nummer ', ' ich die Werkstatt sofort anrufen.', 'würde', 'Mit deiner Nummer ___ ich die Werkstatt sofort ___.'],
    ['aufräumen', 'separable', 'Mit mehr Zeit ', ' Lea den Keller aufräumen.', 'würde', 'Mit mehr Zeit ___ Lea den Keller ___.'],
    ['mitkommen', 'separable', 'Bei gutem Wetter ', ' wir gern mitkommen.', 'würden', 'Bei gutem Wetter ___ wir gern ___.'],
    ['vorbereiten', 'separable', 'An deiner Stelle ', ' ich das Gespräch vorbereiten.', 'würde', 'An deiner Stelle ___ ich das Gespräch ___.'],
    ['teilnehmen', 'separable', 'Ohne den Termin ', ' ihr am Kurs teilnehmen.', 'würdet', 'Ohne den Termin ___ ihr am Kurs ___.'],
    ['besuchen', 'inseparable', 'Wenn Nora mehr Zeit hätte, ', ' sie in Berlin mehrere Museen besuchen.', 'würde', 'Wenn Nora mehr Zeit hätte, ___ sie in Berlin mehrere Museen ___.'],
    ['verstehen', 'inseparable', 'Mit einem Beispiel ', ' du die Regel besser verstehen.', 'würdest', 'Mit einem Beispiel ___ du die Regel besser ___.'],
    ['erzählen', 'inseparable', 'Vor Freunden ', ' er die Geschichte anders erzählen.', 'würde', 'Vor Freunden ___ er die Geschichte anders ___.'],
    ['bekommen', 'inseparable', 'Mit dem Stipendium ', ' die Studierenden mehr Unterstützung bekommen.', 'würden', 'Mit dem Stipendium ___ die Studierenden mehr Unterstützung ___.'],
    ['entdecken', 'inseparable', 'Bei klarem Himmel ', ' das Team mehr Details entdecken.', 'würde', 'Bei klarem Himmel ___ das Team mehr Details ___.'],
  ],
  'konjunktiv-vergangenheit': [
    ['anrufen', 'separable', 'Mit einem funktionierenden Telefon ', ' ich dich sofort angerufen.', 'hätte', 'Mit einem funktionierenden Telefon ___ ich dich sofort ___.'],
    ['aufpassen', 'separable', 'Mit der Warnung ', ' du besser aufgepasst.', 'hättest', 'Mit der Warnung ___ du besser ___.'],
    ['mitkommen', 'separable', 'Bei gutem Wetter ', ' wir mitgekommen.', 'wären', 'Bei gutem Wetter ___ wir ___.'],
    ['zurückkehren', 'separable', 'Ohne den Sturm ', ' die Schiffe früher zurückgekehrt.', 'wären', 'Ohne den Sturm ___ die Schiffe früher ___.'],
    ['einpacken', 'separable', 'Mit mehr Platz ', ' ihr alle Bücher eingepackt.', 'hättet', 'Mit mehr Platz ___ ihr alle Bücher ___.'],
    ['besuchen', 'inseparable', 'Mit einer Einladung ', ' Nora die Ausstellung besucht.', 'hätte', 'Mit einer Einladung ___ Nora die Ausstellung ___.'],
    ['verstehen', 'inseparable', 'Nach einer Erklärung ', ' er die Aufgabe verstanden.', 'hätte', 'Nach einer Erklärung ___ er die Aufgabe ___.'],
    ['erzählen', 'inseparable', 'Ohne das Versprechen ', ' ich alles erzählt.', 'hätte', 'Ohne das Versprechen ___ ich alles ___.'],
    ['erreichen', 'inseparable', 'Mit dem früheren Zug ', ' sie das Ziel erreicht.', 'hätten', 'Mit dem früheren Zug ___ sie das Ziel ___.'],
    ['entkommen', 'inseparable', 'Ohne das neue Tor ', ' das Tier entkommen.', 'wäre', 'Ohne das neue Tor ___ das Tier ___.'],
  ],
  imperativ: [
...
export const GERMAN_SEPARATION_CHALLENGES: SeparationChallenge<GermanFormId>[] = Object.entries(SEPARATION_SEEDS)
  .flatMap(([form, seeds], formIndex) => {
    ...
    return order.map((seedIndex, index) => {
      const [verb, separation, before, after, answer, promptOverride] = seeds[seedIndex]
      return {
        ...
        verb,
        separation,
        prompt: promptOverride ?? sentencePrompt(verb, separation, before, after),
