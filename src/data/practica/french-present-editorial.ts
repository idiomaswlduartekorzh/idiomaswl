...
const errors: FrenchEditorialErrorSeed[] = [
  { title: 'Le premier service', pieces: [['Chaque matin, Inès ', 'ouvre'], [' les volets. Son frère ', 'vérifient'], [' les fours et la boulangère ', 'prépare']], after: ' la vitrine.', wrong: 1, answers: ['vérifie'], reason: 'Le sujet singulier « son frère » exige « vérifie ».' },
  ...
  { title: 'La première visite', pieces: [['Le musée ', 'ouvre'], [' à dix heures. La guide ', 'commence'], [' la visite et les touristes la ', 'suit']], after: ' au premier étage.', wrong: 2, answers: ['suivent'], reason: 'Le sujet pluriel « les touristes » exige « suivent ».' },
  ...
  { title: 'Le bulletin local', pieces: [['Le producteur ', 'choisit'], [' les sujets. La rédactrice ', 'vérifie'], [' les faits et le présentateur ', 'lisent']], after: ' les titres en direct.', wrong: 2, answers: ['lit'], reason: 'Le sujet singulier « le présentateur » exige « lit ».' },
