...
const errors: FrenchEditorialErrorSeed[] = [
  { title: 'Les vacances au village', pieces: [['Chaque été, nous ', 'logions'], [' chez notre tante. Elle ', 'achetait'], [' le pain et nous ', 'jouait']], after: ' près de la rivière.', wrong: 2, answers: ['jouions'], reason: 'Le sujet « nous » exige la terminaison -ions.' },
  { title: 'La nuit venteuse', pieces: [['Le vent ', 'soufflait'], [' contre les volets. La pluie ', 'tombaient'], [' et les chiens ', 'aboyaient']], after: '.', wrong: 1, answers: ['tombait'], reason: 'Le sujet singulier « la pluie » exige « tombait ».' },
  ...
  { title: 'Le dîner interrompu', pieces: [['Ma mère ', 'servait'], [' la soupe. Mon père ', 'mettait'], [' la table et nous ', 'parlaient']], after: ' quand le téléphone a sonné.', wrong: 2, answers: ['parlions'], reason: 'Le sujet « nous » exige « parlions ».' },
