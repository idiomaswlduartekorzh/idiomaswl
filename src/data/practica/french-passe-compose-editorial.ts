...
const errors: FrenchEditorialErrorSeed[] = [
  { title: 'Le colis de Nora', pieces: [['Hier, Nora ', 'a apporté'], [' le colis. Elle ', 'a remis'], [' le reçu, puis elle ', 'a retourné']], after: ' au bureau.', wrong: 2, answers: ['est retournée'], reason: 'Le déplacement intransitif « retourner » se construit ici avec être et s’accorde avec Nora.' },
  { title: 'La journée à Marseille', pieces: [['Nous ', 'avons visité'], [' le port, puis nous ', 'avons pris'], [' un bateau et nous ', 'avons revenus']], after: ' avant la nuit.', wrong: 2, answers: ['sommes revenus', 'sommes revenues'], reason: 'Le verbe « revenir » se construit avec être au passé composé.' },
  { title: 'La fuite réparée', pieces: [['Un tuyau ', 'a cédé'], [' sous l’évier. La gardienne ', 'est coupé'], [' l’eau et le plombier ', 'a remplacé']], after: ' le joint.', wrong: 1, answers: ['a coupé'], reason: 'Le verbe transitif « couper » se construit avec avoir dans cette phrase.' },
