...
const sequences: EditorialSequenceSeed[] = [
  { events: ['Quando avrò letto la richiesta, cercherò i dati', 'Dopo che avrò controllato i numeri, scriverò la risposta', 'Appena avrò inviato il messaggio, archivierò la pratica'], target: 0, production: { sentence: 'Quando avrò letto la richiesta, cercherò i dati', verb: 'leggere', answers: ['avrò letto'] } },
  { events: ['Quando Marta avrà scelto la ricetta, farà la lista', 'Dopo che avrà comprato gli ingredienti, inizierà a cucinare', 'Appena avrà preparato la cena, chiamerà gli amici'], target: 1, production: { sentence: 'Dopo che avrà comprato gli ingredienti, inizierà a cucinare', verb: 'comprare', answers: ['avrà comprato'] } },
  { events: ['Quando avremo ritirato le chiavi, apriremo la casa', 'Dopo che avremo portato i mobili, monteremo il letto', 'Appena ci saremo sistemati, inviteremo i vicini'], target: 2, production: { sentence: 'Appena ci saremo sistemati, inviteremo i vicini', verb: 'sistemarsi', answers: ['ci saremo sistemati'] } },
  { events: ['Quando il tecnico avrà spento il server, aprirà il pannello', 'Dopo che avrà sostituito il disco, controllerà i cavi', 'Appena avrà riavviato il sistema, avviserà gli utenti'], target: 0, production: { sentence: 'Quando il tecnico avrà spento il server, aprirà il pannello', verb: 'spegnere', answers: ['avrà spento'] } },
  { events: ['Quando avrete letto il regolamento, compilerete il modulo', 'Dopo che avrete firmato la domanda, allegherete i documenti', 'Appena avrete completato la pratica, la consegnerete'], target: 1, production: { sentence: 'Dopo che avrete firmato la domanda, allegherete i documenti', verb: 'firmare', answers: ['avrete firmato'] } },
  { events: ['Quando la guida avrà accolto il gruppo, chiuderà l’ingresso', 'Dopo che avrà mostrato la collezione, risponderà alle domande', 'Appena avrà concluso la visita, accompagnerà tutti all’uscita'], target: 2, production: { sentence: 'Appena avrà concluso la visita, accompagnerà tutti all’uscita', verb: 'concludere', answers: ['avrà concluso'] } },
  { events: ['Quando avrò controllato l’indirizzo, uscirò di casa', 'Dopo che avrò preso la metropolitana, cambierò linea', 'Appena sarò arrivato allo studio, ti telefonerò'], target: 0, production: { sentence: 'Quando avrò controllato l’indirizzo, uscirò di casa', verb: 'controllare', answers: ['avrò controllato'] } },
  { events: ['Quando gli studenti avranno raccolto le fonti, le ordineranno', 'Dopo che avranno scritto la relazione, creeranno le slide', 'Appena avranno presentato i risultati, risponderanno alle domande'], target: 1, production: { sentence: 'Dopo che avranno scritto la relazione, creeranno le slide', verb: 'scrivere', answers: ['avranno scritto'] } },
  { events: ['Quando Paolo avrà montato lo scaffale, aprirà le scatole', 'Dopo che avrà ordinato i libri, pulirà il pavimento', 'Appena avrà finito la stanza, farà una fotografia'], target: 2, production: { sentence: 'Appena avrà finito la stanza, farà una fotografia', verb: 'finire', answers: ['avrà finito'] } },
  { events: ['Quando la squadra avrà fatto riscaldamento, proverà gli schemi', 'Dopo che avrà ascoltato l’allenatore, entrerà in campo', 'Appena sarà iniziata la partita, cambierà disposizione'], target: 0, production: { sentence: 'Quando la squadra avrà fatto riscaldamento, proverà gli schemi', verb: 'fare', answers: ['avrà fatto'] } },
]
