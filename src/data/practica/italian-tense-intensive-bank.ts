...
export const ITALIAN_DRILL_SERIES: readonly ItalianDrillSeries[] = [
  ...
  },
  {
    ...
    drills: [
      ...
      d('Quando raggiungeremo il rifugio, noi ', 'avremo superato', ' il tratto più ripido.', 'superare', 'acción previa a otra futura', ['supereremo', 'abbiamo superato', 'avremmo superato']),
  ...
  },
  {
    ...
    drills: [
      ...
      d('Con un po’ di segnale ti ', 'avrei chiamato', ' subito dopo l’atterraggio.', 'chiamare', 'intención pasada frustrada', ['chiamerei', 'ho chiamato', 'avrò chiamato']),
      d('Voi ', 'avreste dovuto', ' avvertirci prima.', 'dovere', 'reproche sobre el pasado', ['dovreste', 'avete dovuto', 'avrete dovuto']),
      d('Con un altro treno serale, gli ospiti ', 'sarebbero rimasti', ' fino alla fine del concerto.', 'rimanere', 'deseo pasado impedido', ['rimarrebbero', 'sono rimasti', 'saranno rimasti']),
      d('Stando al rapporto non confermato, l’indagato ', 'sarebbe fuggito', ' attraversando il confine.', 'fuggire', 'noticia pasada no confirmada', ['fuggirebbe', 'è fuggito', 'sarà fuggito']),
  ...
  },
  {
    ...
    drills: [
      d('Davide, ', 'chiudi', ' il cancello prima che il cane esca.', 'chiudere', 'orden a tu', ['chiude', 'chiuderai', 'hai chiuso']),
      ...
      d('Ragazzi, non ', 'correte', ' vicino alla piscina.', 'correre', 'prohibición a voi', ['corrono', 'correrete', 'avete corso']),
