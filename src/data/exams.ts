...
export const EXAMS: Record<string, Exam> = {
  ...
  icfes: {
    ...
    sections: [
      ...
      { name: 'Parte 3', icon: '💬', time: '~7 min',  questions: 5,  color: '#2c3870', types: ['Diálogos: completar conversación (3 opciones)'] },
      { name: 'Parte 4', icon: '📝', time: '~10 min', questions: 8,  color: '#3a4895', types: ['Completar texto: elegir la palabra correcta para cada espacio (4 opciones)'] },
      { name: 'Parte 5', icon: '📖', time: '~10 min', questions: 7,  color: '#4a5aad', types: ['Texto corto: comprensión, inferencia, vocabulario en contexto (4 opciones)'] },
      { name: 'Parte 6', icon: '📑', time: '~10 min', questions: 5,  color: '#14215c', types: ['Texto largo: inferencia, idea principal, referencia pronominal (4 opciones)'] },
      { name: 'Parte 7', icon: '🔍', time: '~10 min', questions: 10, color: '#1e3270', types: ['Texto de opinión: argumento del autor, posición, vocabulario (4 opciones)'] },
    ],
    mocks: [
      { id: 'mock-01', title: 'Mock 1 · Vida cotidiana y ciudad',    subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-02', title: 'Mock 2 · Viajes y servicios',         subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-03', title: 'Mock 3 · Estudio y tecnología',       subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-04', title: 'Mock 4 · Salud y ambiente',           subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-05', title: 'Mock 5 · Comida y cultura',           subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-06', title: 'Mock 6 · Trabajo y carrera',          subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-07', title: 'Mock 7 · Deporte y tiempo libre',     subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-08', title: 'Mock 8 · Ciencia y espacio',          subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-09', title: 'Mock 9 · Arte y medios',              subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-10', title: 'Mock 10 · Emergencias y seguridad',   subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-11', title: 'Mock 11 · Tecnología y vida digital',  subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-12', title: 'Mock 12 · Medio ambiente',             subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-13', title: 'Mock 13 · Salud y medicina',           subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-14', title: 'Mock 14 · Trabajo y carreras',         subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-15', title: 'Mock 15 · Educación y aprendizaje',    subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-16', title: 'Mock 16 · Cultura e identidad',        subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-17', title: 'Mock 17 · Deporte y competencia',      subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      ...
      { id: 'mock-21', title: 'Mock 21 · Arte, deporte e historia',     subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-22', title: 'Mock 22 · Salud, estudios y juventud',   subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
      { id: 'mock-23', title: 'Mock 23 · Comunicación, trabajo y familia', subtitle: '7 partes · 45 preguntas · Formato Saber 11', free: true, parts: 7, questions: 45 },
