    ...
    // ── PARTE 3 ── Diálogos (preguntas 11–15) ────────────────────────────────
    {
      ...
      questions: [
        ...
        },
        {
          ...
          id: 'p3q2',
          part: 3,
          stimulus: "I've been training hard all week for Saturday's final.",
          text: '',
          options: [
            'The gym has blue walls.',
        ...
        },
        {
          ...
          id: 'p3q5',
          part: 3,
          stimulus: 'Shall we watch the Olympics on TV tonight?',
          text: '',
          options: [
            "Let's watch the athletics together.",
            'The television is in the living room.',
            'Tonight comes after this afternoon.',
          ],
          answer: 0,
        },
      ],
    ...
    // ── PARTE 4 ── Completar el texto (preguntas 16–23) ──────────────────────
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['speed', 'height', 'determination', 'equipment'],
          answer: 2,
        },
        {
          type: 'mcq',
          ...
          options: ['stadiums', 'trophies', 'facilities', 'teams'],
          answer: 3,
        },
        {
          type: 'mcq',
