      ...
      questions: [
        {
          ...
          stimulus: '[Vídeo — reportagem, ~3 min] Uma reportagem mostra escolas que adotaram intervalos ativos e jardins de aprendizagem ao ar livre. A repórter visita uma escola onde as aulas de ciências acontecem em uma horta e os alunos têm pausas com jogos e movimento, entrevista professores e uma pedagoga que explica que o contato com a natureza e o movimento melhoram a concentração e a saúde das crianças. Um aluno conta que aprende mais quando "põe a mão na terra".',
          text: 'Com base no vídeo, escreva um texto para o jornal da comunidade escolar defendendo a adoção de espaços verdes e intervalos ativos nas escolas. Explique os benefícios para a aprendizagem e a saúde dos alunos e proponha como implementar essas ideias. (Mínimo: 200 palavras)',
          minWords: 200,
        },
      ],
    },
