...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't14-l-cr1', part: 5, audioUrl: '/audio/toefl/set-14/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["No, I don't usually enjoy playing tennis after class.","The bread is warm and ready to serve.","She left the building a few minutes ago.","It's just beyond the vending machines."], answer: 3 },
        { type: 'mcq', id: 't14-l-cr2', part: 5, audioUrl: '/audio/toefl/set-14/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["It measures approximately six meters in total length.","Of course, I'd be glad to proofread it.","The main entrance gate is open this afternoon.","Yes, she works as a pilot for the airline."], answer: 1 },
        { type: 'mcq', id: 't14-l-cr3', part: 5, audioUrl: '/audio/toefl/set-14/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["It costs seven dollars at the campus store.","You can ask the tutor during office hours.","The tea is sweet and still quite hot.","He is scheduled to arrive next Wednesday."], answer: 1 },
        { type: 'mcq', id: 't14-l-cr4', part: 5, audioUrl: '/audio/toefl/set-14/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["The bus arrived late at the station today.","No, I have not seen that particular film.","It is made from several pieces of stone.","Sure; let's reschedule our meeting for Thursday."], answer: 3 },
        { type: 'mcq', id: 't14-l-cr5', part: 5, audioUrl: '/audio/toefl/set-14/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["The park is far.","She teaches history at the local university.","It is quite small compared with the others.","Yes, I passed my driving test!"], answer: 3 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't14-l-cv1', part: 6, text: 'What does the student want to do?', options: ["Change to a different university major","Complete one academic semester in another country","Find a new part-time job near campus","Withdraw from one of the current courses"], answer: 1 },
        { type: 'mcq', id: 't14-l-cv2', part: 6, text: 'What two goals does the student mention?', options: ["Study both art history and contemporary history","Save money while traveling between several countries","Study engineering while improving spoken Spanish","Learn local cooking while making new friends"], answer: 2 },
        { type: 'mcq', id: 't14-l-cv3', part: 6, text: 'What does the staff member say about tuition costs?', options: ["The entire study-abroad semester has no tuition cost.","The student's regular tuition doubles during the semester abroad.","Students pay the standard fees charged by the host university.","Students keep paying regular tuition rather than host fees."], answer: 3 },
        { type: 'mcq', id: 't14-l-cv4', part: 6, text: 'What does the staff member say is the key thing to sort out early?', options: ["Which courses will count toward the student's degree","Which neighborhood offers the best place to live","What clothing and materials the student should pack","Which flights the student should reserve for travel"], answer: 0 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't14-l-an1', part: 7, text: 'What is the first thing the announcement tells shoppers?', options: ["The department store is beginning a major sale.","The store will close in thirty minutes.","The store is moving to another building soon.","A product sold by the store has been recalled."], answer: 1 },
        { type: 'mcq', id: 't14-l-an2', part: 7, text: 'How do members earn points in the loyalty program?', options: ["Members earn points whenever they use a coupon.","Members earn one point for every dollar spent.","Members receive one point during each store visit.","Members earn points by bringing another customer."], answer: 1 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't14-l-at1', part: 8, text: 'What is the main subject of the lecture?', options: ["The collapse and later recovery of American bison","The process required to establish a successful ranch","The historical development of national parks in America","The causes behind the extinction of ancient dinosaurs"], answer: 0 },
        { type: 'mcq', id: 't14-l-at2', part: 8, text: 'According to the professor, what mainly caused the collapse of the bison?', options: ["A rapidly spreading disease among wild bison populations","Human activity, particularly large-scale commercial hunting","Long-term climate change across the North American plains","Competition for resources with other large grazing animals"], answer: 1 },
        { type: 'mcq', id: 't14-l-at3', part: 8, text: 'What role did places like Yellowstone play in the recovery?', options: ["They had almost no effect on recovering bison populations.","They sold protected bison to commercial meat producers.","They provided crucial refuges where bison remained protected.","They prohibited every bison from entering park boundaries."], answer: 2 },
        { type: 'mcq', id: 't14-l-at4', part: 8, text: 'What important nuance does the professor emphasize?', options: ["Bison populations never influenced their surrounding grassland ecosystems.","Conservation programs always restore every ecological function completely.","The American bison remains functionally extinct throughout North America.","Restoring population numbers does not restore the ecological role."], answer: 3 },
