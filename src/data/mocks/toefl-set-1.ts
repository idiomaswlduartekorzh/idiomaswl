...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't1-l-cr1', part: 5, audioUrl: '/audio/toefl/set-1/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["On the first floor, beside the café.","It opens at nine on weekday mornings.","Your card lets you borrow three books.","The library café serves lunch until two."], answer: 0 },
        { type: 'mcq', id: 't1-l-cr2', part: 5, audioUrl: '/audio/toefl/set-1/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["The dinner menu changes every Saturday.","We all enjoyed our meal there last week.","Sure, I'd love to join you for dinner.","You can reserve a table on their website."], answer: 2 },
        { type: 'mcq', id: 't1-l-cr3', part: 5, audioUrl: '/audio/toefl/set-1/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["You can leave your coat at the front desk.","The lobby windows were cleaned this morning.","You can borrow one from the front desk.","The forecast said it would rain tomorrow."], answer: 2 },
        { type: 'mcq', id: 't1-l-cr4', part: 5, audioUrl: '/audio/toefl/set-1/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["Of course—I'll email you the details.","The workshop covered a different topic.","I sent my application in last Tuesday.","The speaker asked us to arrive early."], answer: 0 },
        { type: 'mcq', id: 't1-l-cr5', part: 5, audioUrl: '/audio/toefl/set-1/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["Yes, I passed all my exams!","I wore this sweater yesterday.","The exam starts next week.","She seemed cheerful today."], answer: 0 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't1-l-cv1', part: 6, text: 'What decision is the woman trying to make?', options: ["Which career to pursue after college","Which friend to ask for course advice","Which elective to take next term","Which presentation topic to prepare"], answer: 2 },
        { type: 'mcq', id: 't1-l-cv2', part: 6, text: 'Why is the woman considering the public speaking course despite dreading it?', options: ["She expects the class to require less work.","Her friend needs a partner for the class.","Her preferred psychology course is full.","She needs presentation skills for work."], answer: 3 },
        { type: 'mcq', id: 't1-l-cv3', part: 6, text: 'What did the woman\'s friend say about the public speaking teacher?', options: ["The teacher builds up from easy exercises.","Students can opt out of speeches.","Students give a major talk first.","Most work is completed in writing."], answer: 0 },
        { type: 'mcq', id: 't1-l-cv4', part: 6, text: 'What does the woman decide at the end?', options: ["Enroll in psychology with her friend","Enroll in the public speaking course","Postpone choosing until next term","Drop both electives from her schedule"], answer: 1 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't1-l-an1', part: 7, text: 'What is the announcement mainly about?', options: ["Repairs that will close the cafeteria","Plans for an additional campus café","Changes prompted by student feedback","Higher prices for late-night meals"], answer: 2 },
        { type: 'mcq', id: 't1-l-an2', part: 7, text: 'What change to opening hours is mentioned?', options: ["Weekend service will extend until nine.","Weekday breakfast will begin earlier.","Evening meals will move to weekends.","Weekday service will continue until nine."], answer: 3 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't1-l-at1', part: 8, text: 'What is the main topic of the lecture?', options: ["How ancient dyes damaged the environment","How scarcity gave purple its status","How sea snails adapted to coastal life","How Roman rulers designed ceremonial robes"], answer: 1 },
        { type: 'mcq', id: 't1-l-at2', part: 8, text: 'How was Tyrian purple dye made in the ancient world?', options: ["From bark stripped off coastal trees","From petals of Mediterranean flowers","From mucus produced by sea snails","From minerals ground into a powder"], answer: 2 },
        { type: 'mcq', id: 't1-l-at3', part: 8, text: 'Why did purple become a symbol of wealth and power?', options: ["It marked military victories.","Its pigment protected fabrics.","Its color was favored by artisans.","Its scarcity made it costly to obtain."], answer: 3 },
        { type: 'mcq', id: 't1-l-at4', part: 8, text: 'What did William Perkin accidentally create in 1856?', options: ["The first synthetic purple dye","A treatment for malarial fever","A way to breed more sea snails","A method for recovering gold"], answer: 0 },
