      ...
      questions: [
        {
          ...
          stimulus: '[Vídeo — reportagem, ~3 min] Uma reportagem mostra o resgate de rios urbanos que estavam poluídos e abandonados. A repórter visita uma cidade onde um córrego foi despoluído e transformado em um parque linear, entrevista moradores que voltaram a frequentar o local e um biólogo que fala sobre o retorno de peixes e aves. Uma moradora antiga conta que, na sua infância, ninguém chegava perto do rio por causa do mau cheiro, e hoje as crianças brincam ali.',
          text: 'Com base no vídeo, escreva um texto para o site da prefeitura da sua cidade defendendo a recuperação de um rio ou córrego poluído. Explique os benefícios ambientais e sociais e proponha como a comunidade pode participar do projeto. (Mínimo: 200 palavras)',
          minWords: 200,
        },
      ],
    },
