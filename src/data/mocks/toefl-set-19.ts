...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't19-l-cr1', part: 5, audioUrl: '/audio/toefl/set-19/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["The bread is warm from the kitchen oven.","She left about an hour ago by bus.","It's on the second floor, past the lockers.","No, I don't usually enjoy camping there."], answer: 2 },
        { type: 'mcq', id: 't19-l-cr2', part: 5, audioUrl: '/audio/toefl/set-19/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["Sure, I'll help you set up the room.","The gate is open beside the main entrance.","Yes, she works as an architect downtown.","It measures three meters from side to side."], answer: 0 },
        { type: 'mcq', id: 't19-l-cr3', part: 5, audioUrl: '/audio/toefl/set-19/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["The timetable is posted online.","The soup is warm and ready to serve.","He arrives on Monday morning by train.","It costs seven dollars at the campus store."], answer: 0 },
        { type: 'mcq', id: 't19-l-cr4', part: 5, audioUrl: '/audio/toefl/set-19/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["No, I have not read that book yet.","It is made entirely from clear plastic.","Of course — I'll pick you up on the way.","The bus was late during the morning trip."], answer: 2 },
        { type: 'mcq', id: 't19-l-cr5', part: 5, audioUrl: '/audio/toefl/set-19/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["She teaches biology at the local college.","It is quite cheap during the seasonal sale.","Yes, I finally learned to swim!","The store is far from the central station."], answer: 2 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't19-l-cv1', part: 6, text: 'What is the man\'s problem?', options: ["He becomes extremely nervous when speaking before an audience","He cannot locate the notes prepared for his presentation","He has already missed the deadline for the presentation","He has not completed the necessary background research"], answer: 0 },
        { type: 'mcq', id: 't19-l-cv2', part: 6, text: 'What does the woman say helped her most?', options: ["Reading the presentation repeatedly in complete silence","Practicing aloud, preferably before another person","Avoiding every situation that requires a presentation","Creating many additional slides with detailed information"], answer: 1 },
        { type: 'mcq', id: 't19-l-cv3', part: 6, text: 'What problem did the woman notice when she recorded herself?', options: ["She remained too still throughout the recorded presentation","She spoke so quietly that listeners could not understand her","She spoke too quickly and repeatedly used the word um","She momentarily forgot her own name while presenting"], answer: 2 },
        { type: 'mcq', id: 't19-l-cv4', part: 6, text: 'What does the woman offer to do?', options: ["Deliver the complete presentation on his behalf","Lend him a useful book about public speaking","Write the entire presentation before the deadline","Watch him practice the presentation before next week"], answer: 3 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't19-l-an1', part: 7, text: 'What is the main announcement?', options: ["A new bus route connecting the main and science campuses","An increase in fares across all university bus services","The relocation of the main library to the science campus","The permanent cancellation of buses between campus buildings"], answer: 0 },
        { type: 'mcq', id: 't19-l-an2', part: 7, text: 'How often will the new route run on weekdays?', options: ["Once during each hour of weekday service","Every twenty minutes throughout weekday service","A single scheduled journey on every weekday","At intervals of five minutes during weekdays"], answer: 1 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't19-l-at1', part: 8, text: 'Why does play present a puzzle from an evolutionary standpoint?', options: ["Playing consistently produces serious injuries in young animals","Play cannot be directly observed in natural environments","Only human children engage in recognizable forms of play","Play uses energy and creates risks, yet remains widespread"], answer: 3 },
        { type: 'mcq', id: 't19-l-at2', part: 8, text: 'What is the leading explanation for play?', options: ["It provides practice for skills needed during adult life","It eliminates the need for animals to search for food","It indicates the presence of a serious developmental illness","It serves no useful function in animal development"], answer: 0 },
        { type: 'mcq', id: 't19-l-at3', part: 8, text: 'According to the professor, what social lessons does play teach?', options: ["How to locate food across an unfamiliar environment","How to read signals, take turns, handle conflict, and learn limits","How to sleep safely while surrounded by other animals","How to migrate between seasonal feeding and breeding areas"], answer: 1 },
        { type: 'mcq', id: 't19-l-at4', part: 8, text: 'What happens to animals deprived of play, according to research?', options: ["They engage in substantially more play after reaching adulthood","They develop greater physical strength than animals that play","They struggle socially and overreact during ordinary interactions","They generally experience longer lives than playful animals"], answer: 2 },
