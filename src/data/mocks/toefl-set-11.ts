...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't11-l-cr1', part: 5, audioUrl: '/audio/toefl/set-11/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["The bread is fresh from the bakery this morning.","She left the building early this morning.","It's right beside the main entrance doors.","No, I don't usually play golf on weekends."], answer: 2 },
        { type: 'mcq', id: 't11-l-cr2', part: 5, audioUrl: '/audio/toefl/set-11/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["Sure, I can help you study tonight.","The classroom window is closed for the evening.","Yes, he works as an engineer downtown.","It measures approximately three meters in width."], answer: 0 },
        { type: 'mcq', id: 't11-l-cr3', part: 5, audioUrl: '/audio/toefl/set-11/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["Check the schedule posted beside the door.","The orange juice is cold and ready to serve.","He is scheduled to arrive next Sunday afternoon.","It costs twelve dollars at the campus store."], answer: 0 },
        { type: 'mcq', id: 't11-l-cr4', part: 5, audioUrl: '/audio/toefl/set-11/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["No, I have not tried that particular dish.","It is made entirely from recycled plastic.","Of course; take as long as you need.","The bus was completely full during the trip."], answer: 2 },
        { type: 'mcq', id: 't11-l-cr5', part: 5, audioUrl: '/audio/toefl/set-11/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["She teaches art at the local secondary school.","It is quite near the main train station.","Yes, the presentation went really well today!","The café is closed for the entire afternoon."], answer: 2 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't11-l-cv1', part: 6, text: 'What is the woman encouraging the man to do?', options: ["Attend a workshop about effective study skills","Change his current university major next semester","Join an informal study group with classmates","Skip the assigned reading for his course"], answer: 0 },
        { type: 'mcq', id: 't11-l-cv2', part: 6, text: 'What problem does the man have with his notes?', options: ["He does not take any notes during lectures.","He records everything but cannot find useful information.","He frequently loses the notebooks containing his notes.","He writes too slowly to follow the professor."], answer: 1 },
        { type: 'mcq', id: 't11-l-cv3', part: 6, text: 'What note-taking method does the woman describe?', options: ["Avoid taking any notes while attending the lecture","Record the complete lecture for later transcription","Write key points, then summarize them afterward","Copy the relevant pages directly from the textbook"], answer: 2 },
        { type: 'mcq', id: 't11-l-cv4', part: 6, text: 'Why does the woman say the workshop is worth the time?', options: ["The workshop provides free food for every participant.","Attendance counts as extra credit in his course.","The university requires every student to attend it.","One hour may prevent several hours of rereading."], answer: 3 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't11-l-an1', part: 7, text: 'What is the announcement about?', options: ["Spring semester course registration through the student portal","A new borrowing policy introduced by the library","The university's upcoming graduation ceremony for students","A planned change to tuition fees next semester"], answer: 0 },
        { type: 'mcq', id: 't11-l-an2', part: 7, text: 'What determines a student\'s registration time?', options: ["The student's current overall grade point average","The number of academic credits already completed","The alphabetical position of the student's family name","The original date when the student applied"], answer: 1 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't11-l-at1', part: 8, text: 'What makes the Arctic tern remarkable, according to the professor?', options: ["Its unusual ability to swim beneath polar waters","Its exceptionally large body size among seabirds","Its bright and distinctive colors during breeding season","Its long annual migration between both polar regions"], answer: 3 },
        { type: 'mcq', id: 't11-l-at2', part: 8, text: 'Why does the Arctic tern make this journey?', options: ["To experience two summers with long days and food","To locate a suitable mate during the breeding season","To avoid competing with other birds for nesting sites","To escape the predators found near its original habitat"], answer: 0 },
        { type: 'mcq', id: 't11-l-at3', part: 8, text: 'How do terns navigate across oceans, according to the professor?', options: ["They simply follow the routes taken by older birds.","They use the sun, stars, and Earth's magnetic field.","They memorize visual landmarks across the open oceans.","They depend entirely on instinct without external cues."], answer: 1 },
        { type: 'mcq', id: 't11-l-at4', part: 8, text: 'Why don\'t terns fly in a straight line?', options: ["They prefer routes that always remain close to land.","They frequently lose their direction over the open ocean.","Winding routes use prevailing winds and save energy.","Direct routes cover a greater distance between both poles."], answer: 2 },
