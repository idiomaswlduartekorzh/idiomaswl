      ...
      questions: [
        {
          ...
          options: ['Laptop', 'Tablet', 'Printer', 'Monitor'],
          answer: 0,
        },
        {
          type: 'mcq',
        ...
        },
        {
          ...
          options: ['Fluency', 'Curriculum', 'Literacy', 'Assessment'],
          answer: 2,
        },
        {
          type: 'mcq',
          ...
          options: ['Syllabus', 'Scholarship', 'Transcript', 'Certificate'],
          answer: 3,
        },
        {
          type: 'mcq',
          ...
          options: ['Streaming', 'Navigation', 'Connectivity', 'Storage'],
          answer: 2,
        },
      ],
    },
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['provided', 'provides', 'is providing', 'will provide'],
          answer: 0,
        },
        {
          type: 'mcq',
        ...
        },
        {
          ...
          options: ['compete', 'replace', 'ignore', 'assist'],
          answer: 3,
        },
        {
          type: 'mcq',
          ...
          options: ['is introduced', 'introduces', 'introduced', 'has introducing'],
          answer: 2,
        },
        {
          type: 'mcq',
          ...
          options: ['distinguish', 'choose', 'separate', 'identify'],
          answer: 0,
        },
        {
          type: 'mcq',
          ...
          options: ['have published', 'published', 'are publishing', 'will be published'],
          answer: 3,
        },
      ],
    },
