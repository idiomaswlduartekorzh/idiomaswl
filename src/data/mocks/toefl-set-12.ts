...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't12-l-cr1', part: 5, audioUrl: '/audio/toefl/set-12/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["She left the building around noon today.","It's down the corridor, second door on the right.","No, I don't usually enjoy running after class.","The milk is fresh from the store this morning."], answer: 1 },
        { type: 'mcq', id: 't12-l-cr2', part: 5, audioUrl: '/audio/toefl/set-12/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["The main entrance door is open this afternoon.","Yes, he works as a lawyer downtown.","It measures approximately four meters in total length.","Sure, I can drive you to the station."], answer: 3 },
        { type: 'mcq', id: 't12-l-cr3', part: 5, audioUrl: '/audio/toefl/set-12/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["The coffee is hot.","He is expected to arrive next Friday afternoon.","It costs six dollars at the campus shop.","You can register at the front desk."], answer: 3 },
        { type: 'mcq', id: 't12-l-cr4', part: 5, audioUrl: '/audio/toefl/set-12/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["It is made from several sheets of paper.","No worries; I'll cover your work shift.","The film was boring and unusually long.","No, I have never met her before."], answer: 1 },
        { type: 'mcq', id: 't12-l-cr5', part: 5, audioUrl: '/audio/toefl/set-12/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["It is quite cheap at the campus store.","Yes, I finally fixed the bug in my code!","The library is far from the student residence.","She teaches music at the local high school."], answer: 1 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't12-l-cv1', part: 6, text: 'Why does the student come to see the professor?', options: ["To request a change of laboratory partners","To discuss withdrawing from the laboratory course","To request more time for the next assignment","To discuss an unexpectedly low laboratory-report grade"], answer: 3 },
        { type: 'mcq', id: 't12-l-cv2', part: 6, text: 'What did the professor praise about the report?', options: ["The report's data collection and analytical work","The appropriate length of the completed report","The report's formatting and visual presentation","The interpretation presented in the discussion section"], answer: 0 },
        { type: 'mcq', id: 't12-l-cv3', part: 6, text: 'Where did the student lose most points?', options: ["The section presenting the collected laboratory data","The discussion, which repeated rather than interpreted results","The introductory section explaining the report's purpose","The list of references included after the discussion"], answer: 1 },
        { type: 'mcq', id: 't12-l-cv4', part: 6, text: 'What does the professor offer to do?', options: ["Excuse the student from completing the next report","Increase the grade awarded for the original report","Review a rewritten discussion and provide feedback","Assign the student a different laboratory-report topic"], answer: 2 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't12-l-an1', part: 7, text: 'What is the announcement mainly about?', options: ["A change to the recreation center's opening hours","An increase in the recreation center membership fee","The opening of a new gym on campus","A new system for checking in members"], answer: 3 },
        { type: 'mcq', id: 't12-l-an2', part: 7, text: 'How will students check in under the new system?', options: ["With the mobile app or student identification card","By writing their names on a paper list","By presenting a receipt at the front desk","With the old paper membership card at reception"], answer: 0 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't12-l-at1', part: 8, text: 'What is the main topic of the lecture?', options: ["How human memory works","How people can strengthen their personal willpower","How habits function and can be changed","Why people experience boredom during daily activities"], answer: 2 },
        { type: 'mcq', id: 't12-l-at2', part: 8, text: 'What are the three parts of the "habit loop"?', options: ["Thought, spoken word, and completed physical action","Cause, immediate effect, and eventual final result","Cue, behavioral routine, and reinforcing reward","Start, middle, and end"], answer: 2 },
        { type: 'mcq', id: 't12-l-at3', part: 8, text: 'According to the professor, what is the most effective way to change a habit?', options: ["Keep the cue and reward but replace the routine","Completely avoid every cue associated with the habit","Punish yourself whenever the unwanted behavior occurs","Use willpower alone to stop the routine immediately"], answer: 0 },
        { type: 'mcq', id: 't12-l-at4', part: 8, text: 'In the cookie example, what might the real reward be?', options: ["The sweet taste provided by the afternoon cookie","A brief break and a change of scenery","The possibility of losing weight over several months","The money saved by avoiding an unnecessary purchase"], answer: 1 },
