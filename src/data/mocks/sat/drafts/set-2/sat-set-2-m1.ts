...
import { items as cs, meta as csMeta } from './blocks/m1-cs'
import { items as ii, meta as iiMeta } from './blocks/m1-ii'
import { items as sec, meta as secMeta } from './blocks/m1-sec'
import { items as eoi, meta as eoiMeta } from './blocks/m1-eoi'
 ...
 */
export const satSet2M1Draft: SatModule = {
  id: 'sat-set-2-m1',
  variant: 'M1',
  items: [...cs, ...ii, ...sec, ...eoi],
