...
export const items: MCQQuestion[] = [
  ...
  },
  {
    ...
    stimulus: 'After a flexible sensor detects changes in a biofilm growing across its ______ a processor converts the measurements into a time series.',
    text: 'Which choice completes the text so that it conforms to the conventions of Standard English?',
  ...
  },
  {
    ...
    stimulus: 'The theater’s oldest surviving shadow ______ a translucent leather figure cut in the shape of a bird—was stored flat to protect its movable joints.',
    text: 'Which choice completes the text so that it conforms to the conventions of Standard English?',
  ...
  },
  {
    ...
    stimulus: 'The excavated ship’s cargo contained three kinds of ceramic ______ tall transport amphorae, shallow cooking dishes, and small glazed cups.',
    text: 'Which choice completes the text so that it conforms to the conventions of Standard English?',
