...
export const items: MCQQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'One load of pots from a single rubbish dump that had been piling up for years.',
    ],
    answer: 3,
  },
]
