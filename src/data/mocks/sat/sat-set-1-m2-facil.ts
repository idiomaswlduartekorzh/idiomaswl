 ...
 *
 * «Estándar» no quiere decir fácil. Lleva 13 ítems fáciles, 11 medios y 3 difíciles: lo
 * que la separa de la rama exigente es la **media**, no la ausencia de los otros niveles.
 * Un módulo sin ningún ítem difícil deja de medir a quien va bien, y el examen real
 * tampoco lo hace (blueprint §2, «Módulo 1 vs módulo 2»).
 *
