...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't18-l-cr1', part: 5, audioUrl: '/audio/toefl/set-18/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["No, I don't usually enjoy skating there.","The soup is ready in the dining room.","She left early this morning by train.","It's just past the fountain, on the right."], answer: 3 },
        { type: 'mcq', id: 't18-l-cr2', part: 5, audioUrl: '/audio/toefl/set-18/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["It measures five meters from bottom to top.","Sure, I'll bring my notes tomorrow.","The window is open beside the entrance.","Yes, she works as a scientist downtown."], answer: 1 },
        { type: 'mcq', id: 't18-l-cr3', part: 5, audioUrl: '/audio/toefl/set-18/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["It costs eight dollars at the campus shop.","You can ask at the reception desk.","The coffee is fresh from the kitchen.","He arrives on Sunday afternoon by bus."], answer: 1 },
        { type: 'mcq', id: 't18-l-cr4', part: 5, audioUrl: '/audio/toefl/set-18/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["The bus was empty during the morning trip.","No, I have not tried that restaurant yet.","It is made entirely from brown leather.","Of course — I'll save you a seat at the front."], answer: 3 },
        { type: 'mcq', id: 't18-l-cr5', part: 5, audioUrl: '/audio/toefl/set-18/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["The market is far from the central station.","She teaches economics at the local college.","It is quite small compared with the original.","Yes, I finished writing my first novel!"], answer: 3 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't18-l-cv1', part: 6, text: 'Why does the student come to the career advisor?', options: ["To obtain a part-time job before graduation","Because she feels uncertain about her path after graduation","To replace environmental science with another academic major","To request a professional reference for an application"], answer: 1 },
        { type: 'mcq', id: 't18-l-cv2', part: 6, text: 'What does the advisor suggest the student do?', options: ["Select a permanent career direction immediately","Submit applications for many positions simultaneously","Conduct informational interviews across several fields","Enroll in another complete university degree"], answer: 2 },
        { type: 'mcq', id: 't18-l-cv3', part: 6, text: 'What is the student worried about?', options: ["That she lacks the qualifications employers expect","That her chosen career will require moving away","That professionals may be too busy to speak with her","That conducting the interviews will require payment"], answer: 2 },
        { type: 'mcq', id: 't18-l-cv4', part: 6, text: 'How does the advisor describe the purpose of these interviews?', options: ["Collecting information before making a final career decision","Securing an immediate job offer from a professional contact","Practicing techniques for upcoming university examinations","Choosing a permanent career path during each interview"], answer: 0 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't18-l-an1', part: 7, text: 'What is the announcement mainly about?', options: ["Construction of an entirely new university library building","Extended opening hours throughout the examination period","A recently announced change to examination dates","A discounted sale of books from library collections"], answer: 1 },
        { type: 'mcq', id: 't18-l-an2', part: 7, text: 'What is true about the overnight hours?', options: ["Only library employees may enter during overnight hours.","Every floor and collection remains open throughout the night.","Only the main study floors open between midnight and six.","The entire library closes to students during the night."], answer: 2 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't18-l-at1', part: 8, text: 'What is the main point of the lecture?', options: ["Standardized shipping containers transformed the global economy","Metal storage boxes remain unusually expensive to manufacture","Modern cargo ships continue increasing greatly in physical size","International shipping creates unavoidable dangers for every port"], answer: 0 },
        { type: 'mcq', id: 't18-l-at2', part: 8, text: 'What was loading a ship like before the shipping container?', options: ["A rapid and inexpensive process requiring few workers","A slow, costly process demanding extensive manual labor","A fully automated system managed entirely by machines","An impossible task for ports handling international cargo"], answer: 1 },
        { type: 'mcq', id: 't18-l-at3', part: 8, text: 'Why did standardization make such a difference?', options: ["Cargo ships traveled more slowly after containers appeared","Standard containers occupied less space than other packages","Equal sizes enabled sealed goods to transfer between transport modes","Containers used valuable metals that protected every product"], answer: 2 },
        { type: 'mcq', id: 't18-l-at4', part: 8, text: 'According to the professor, what happened to shipping costs?', options: ["They remained approximately the same as before.","They became increasingly difficult to predict accurately.","They rose sharply with every new container shipment.","They fell to a small fraction of previous costs."], answer: 3 },
