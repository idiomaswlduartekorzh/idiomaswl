  ...
  sections: [
    {
      ...
      instructions: 'Assista ao vídeo oficial do CELPE-BRAS (edição 2005/1). Preste atenção ao tema e às informações apresentadas. Depois, redija o texto solicitado em português.',
      audioUrl: '/api/celpe-bras-video?src=https%3A%2F%2Fwww.ufrgs.br%2Facervocelpebras%2Fwp-content%2Fuploads%2F2021%2F12%2F2005_1-Video-Museu-do-Tropeiro.mp4',
      questions: [
        {
          type: 'write', id: 'celpe-bras-s8-q1', part: 1, taskNumber: 1,
          stimulusLabel: 'Vídeo oficial CELPE-BRAS — Museu do Tropeiro',
          stimulus: '[Vídeo oficial CELPE-BRAS, edição 2005/1] Tema: "Museu do Tropeiro". Assista com atenção para compreender as informações apresentadas antes de escrever seu texto.',
