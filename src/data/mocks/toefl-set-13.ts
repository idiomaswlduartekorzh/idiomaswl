...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't13-l-cr1', part: 5, audioUrl: '/audio/toefl/set-13/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["It's on the noticeboard beside the main entrance.","No, I don't usually enjoy cycling after class.","The rice is ready to serve in the dining room.","She left the building about an hour ago."], answer: 0 },
        { type: 'mcq', id: 't13-l-cr2', part: 5, audioUrl: '/audio/toefl/set-13/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["Yes, he works as a nurse at the clinic.","It stands approximately two meters tall in total.","Sure, I'll email it to you immediately.","The entrance gate is locked for the evening."], answer: 2 },
        { type: 'mcq', id: 't13-l-cr3', part: 5, audioUrl: '/audio/toefl/set-13/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["He is scheduled to arrive next Thursday afternoon.","It costs nine dollars at the campus store.","The student center has a lost-and-found desk.","The soup is warm and ready to serve."], answer: 2 },
        { type: 'mcq', id: 't13-l-cr4', part: 5, audioUrl: '/audio/toefl/set-13/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["Absolutely; I'll save a seat for you.","The bus was nearly empty during the morning trip.","No, I have never visited that place before.","It is made entirely from natural clay."], answer: 0 },
        { type: 'mcq', id: 't13-l-cr5', part: 5, audioUrl: '/audio/toefl/set-13/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["Yes, I submitted my thesis this morning!","The market is closed for the entire afternoon.","She teaches French at the local university.","It is very close to the main station."], answer: 0 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't13-l-cv1', part: 6, text: 'What is the man encouraging the woman to do?', options: ["Join one of the university's competitive sports teams","Leave her current part-time job before the election","Become a candidate in the student council election","Spend additional time studying for final examinations"], answer: 2 },
        { type: 'mcq', id: 't13-l-cv2', part: 6, text: 'Why is the woman hesitant at first?', options: ["She strongly dislikes attending formal committee meetings.","She plans to move to another city soon.","She has little interest in current student concerns.","Classes and work already take most of her time."], answer: 3 },
        { type: 'mcq', id: 't13-l-cv3', part: 6, text: 'How much time does the role require, according to the woman?', options: ["Approximately ten hours during every academic week","One complete working day during each week","She does not know how much time it requires","Approximately three hours during a typical week"], answer: 3 },
        { type: 'mcq', id: 't13-l-cv4', part: 6, text: 'What does the woman finally decide?', options: ["Decide against running in the council election","Submit her name before the Friday deadline","Delay her candidacy until the following academic year","Leave her part-time job before becoming a candidate"], answer: 1 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't13-l-an1', part: 7, text: 'What change is announced?', options: ["The airport shuttle now charges a higher fare","The shuttle service to Terminal 2 has been cancelled","The Terminal 2 shuttle now leaves from Bay 7","Terminal 2 has closed to all departing passengers"], answer: 2 },
        { type: 'mcq', id: 't13-l-an2', part: 7, text: 'Why has the departure point changed?', options: ["A strike involving airport transportation employees","A special event being held inside Terminal 2","Severe weather affecting roads around the airport","Road maintenance along the airport's main access road"], answer: 3 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't13-l-at1', part: 8, text: 'What is the main question the lecture addresses?', options: ["How early farmers made agriculture more efficient","Why human communities originally began practicing agriculture","When the earliest permanent cities were first constructed","What foods ancient hunter-gatherer groups normally consumed"], answer: 1 },
        { type: 'mcq', id: 't13-l-at2', part: 8, text: 'What "puzzle" does the professor describe?', options: ["Agriculture immediately made early communities healthier and stronger.","Early farming spread despite making individual lives harder.","Farming required much less work than hunting and gathering.","Hunter-gatherer communities consistently refused to practice agriculture."], answer: 1 },
        { type: 'mcq', id: 't13-l-at3', part: 8, text: 'According to the leading explanation, why did farming spread?', options: ["It required considerably less daily work from individuals.","It provided people with a wider variety of foods.","It quickly improved the health of individual farmers.","It supported larger populations on the same land."], answer: 3 },
        { type: 'mcq', id: 't13-l-at4', part: 8, text: 'What broader lesson does the professor draw?', options: ["Technologies may spread by supporting more people despite hardship.","The adoption of agriculture was simply a historical mistake.","Researchers cannot examine historical change using scientific evidence.","Every successful technology necessarily improves individual quality of life."], answer: 0 },
