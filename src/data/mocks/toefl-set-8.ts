...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't8-l-cr1', part: 5, audioUrl: '/audio/toefl/set-8/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["She left the building about an hour ago.","No, I don't usually drink tea with breakfast.","Yes, room 110 is down the hall on the left.","It costs eight dollars at the campus store."], answer: 2 },
        { type: 'mcq', id: 't8-l-cr2', part: 5, audioUrl: '/audio/toefl/set-8/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["That sounds like a lot of fun — count me in!","He comes from Brazil.","It rained all afternoon.","The chair beside the window is broken."], answer: 0 },
        { type: 'mcq', id: 't8-l-cr3', part: 5, audioUrl: '/audio/toefl/set-8/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["Ask at the information desk near the entrance.","The cake needs a little more sugar in it.","She plays the piano in the school orchestra.","It measures about twenty meters from end to end."], answer: 0 },
        { type: 'mcq', id: 't8-l-cr4', part: 5, audioUrl: '/audio/toefl/set-8/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["Yes, she lives nearby.","It is made of cotton.","No problem — I can lend you mine.","The movie starts at eight in the evening."], answer: 2 },
        { type: 'mcq', id: 't8-l-cr5', part: 5, audioUrl: '/audio/toefl/set-8/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["He drives a red car.","It is about three hours away by car.","Yes, I passed with a good grade!","The store is closed today."], answer: 2 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't8-l-cv1', part: 6, text: 'What problem is the student having?', options: ["A database is charging her for articles.","The library is closed.","Her student ID is missing.","She is unable to access her university email account."], answer: 0 },
        { type: 'mcq', id: 't8-l-cv2', part: 6, text: 'What is the cause of the problem, according to the librarian?', options: ["Her student account has expired.","She entered the database directly, bypassing the university portal.","The university has stopped paying for its subscription to the database.","The database is temporarily broken."], answer: 1 },
        { type: 'mcq', id: 't8-l-cv3', part: 6, text: 'What does the librarian tell the student to do?', options: ["Return to the library tomorrow and ask for assistance with the search","Pay the requested fee to download the articles directly from the database","Open the library's Databases tab and sign in with her student ID","Try a different search engine to locate the articles for her paper"], answer: 2 },
        { type: 'mcq', id: 't8-l-cv4', part: 6, text: 'What does the librarian say about old articles for a history paper?', options: ["Older articles are always more reliable; their age guarantees the accuracy of their information.","Only articles published this year are acceptable, regardless of the historical period being studied.","Old articles should never be used; they cannot provide useful evidence for a history paper.","Older primary sources can be valuable; check whether each source is primary or secondary."], answer: 3 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't8-l-an1', part: 7, text: 'What is the announcement mainly about?', options: ["A professor joining the department","A change to student grading","The department's closure during an upcoming public holiday","A new date for the economics final exam"], answer: 3 },
        { type: 'mcq', id: 't8-l-an2', part: 7, text: 'What has changed about the exam?', options: ["The time of day and the room assigned","The date: December 17 instead of December 15","The question format used throughout the entire examination","The total time allowed for completing the examination"], answer: 1 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't8-l-at1', part: 8, text: 'What is the main topic of the lecture?', options: ["The stages in the life cycle of wasps","The different ways that insects communicate with others","The hunting methods used by several animal predators","Two different kinds of mimicry found in animals"], answer: 3 },
        { type: 'mcq', id: 't8-l-at2', part: 8, text: 'In Batesian mimicry, what is the relationship between the mimic and the species it resembles?', options: ["A harmless species resembles a harmful one.","Both species are harmful.","The mimic is more dangerous than its model.","Both species are harmless."], answer: 0 },
        { type: 'mcq', id: 't8-l-at3', part: 8, text: 'Why does the professor describe the Batesian mimic as "bluffing"?', options: ["It rapidly changes color.","It appears dangerous but has no actual defense.","It attacks predators directly.","It avoids detection by hiding beneath the ground."], answer: 1 },
        { type: 'mcq', id: 't8-l-at4', part: 8, text: 'In Müllerian mimicry, why do harmful species resemble each other?', options: ["To attract potential mates through matching patterns and colors","To make it harder for the species to recognize one another","To share a warning predators learn faster, protecting them all","To compete more successfully for food within the same habitat"], answer: 2 },
