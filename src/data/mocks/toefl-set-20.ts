...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't20-l-cr1', part: 5, audioUrl: '/audio/toefl/set-20/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["It's right next to the science building.","No, I don't usually enjoy fishing there.","The soup is ready in the dining room.","She left early this morning by bus."], answer: 0 },
        { type: 'mcq', id: 't20-l-cr2', part: 5, audioUrl: '/audio/toefl/set-20/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["Yes, she works as a veterinarian downtown.","It measures four meters from side to side.","Sure, I can show you how it works.","The window is broken beside the entrance."], answer: 2 },
        { type: 'mcq', id: 't20-l-cr3', part: 5, audioUrl: '/audio/toefl/set-20/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["He arrives on Thursday afternoon by train.","It costs six dollars at the campus shop.","The results will be posted on Friday.","The bread is fresh from the bakery today."], answer: 2 },
        { type: 'mcq', id: 't20-l-cr4', part: 5, audioUrl: '/audio/toefl/set-20/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["Of course — I'll bring an umbrella for you too.","The bus was late during the morning journey.","No, I have not seen that particular film.","It is made entirely from clear glass."], answer: 0 },
        { type: 'mcq', id: 't20-l-cr5', part: 5, audioUrl: '/audio/toefl/set-20/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["Yes, I got the internship I applied for!","The park is far from the central station.","She teaches history at the secondary school.","It is quite small compared with the original."], answer: 0 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't20-l-cv1', part: 6, text: 'What is the student struggling with?', options: ["Selecting an appropriate topic for the research paper","Locating the correct library building on the campus","Determining which information sources are reliable","Writing an effective introduction for the research paper"], answer: 2 },
        { type: 'mcq', id: 't20-l-cv2', part: 6, text: 'What is the first question the librarian suggests asking about a source?', options: ["How much access to the information source costs","Which colors appear throughout the source's website","How long the source and its individual sections are","Who wrote the source and what qualifications they have"], answer: 3 },
        { type: 'mcq', id: 't20-l-cv3', part: 6, text: 'What does the librarian say about professional-looking websites?', options: ["Professional design does not ensure reliable evidence or sourcing","Professional-looking websites should always be avoided completely","A polished website consistently provides the strongest information","Professional appearance guarantees that every claim is reliable"], answer: 0 },
        { type: 'mcq', id: 't20-l-cv4', part: 6, text: 'What does the librarian suggest doing to be more confident about a claim?', options: ["Accept the first source that mentions the claim","Cross-check whether several reliable sources agree","Select the longest article available on the topic","Disregard the publication date of every source"], answer: 1 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't20-l-an1', part: 7, text: 'What is the announcement asking students to do?', options: ["Complete a required examination during the open day","Attend their normal university classes on Saturday","Volunteer as guides and helpers during the open day","Pay a registration fee at the student union office"], answer: 2 },
        { type: 'mcq', id: 't20-l-an2', part: 7, text: 'What do volunteers receive in return?', options: ["Additional academic credit toward a current course","A reserved parking pass for the entire semester","Direct financial payment for each completed volunteer shift","Lunch, a university shirt, and a participation certificate"], answer: 3 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't20-l-at1', part: 8, text: 'What is "anchoring"?', options: ["A specialized technique for securing boats at a harbor","Overreliance on the first information received when judging","A structured psychological method for improving long-term memory","A negotiation technique that produces successful results every time"], answer: 1 },
        { type: 'mcq', id: 't20-l-at2', part: 8, text: 'What did the UN experiment demonstrate?', options: ["People consistently produce accurate estimates about unfamiliar topics","Most participants possess extensive knowledge about international geography","A random starting number pulled later estimates toward itself","The experimental wheel selected every number with equal probability"], answer: 2 },
        { type: 'mcq', id: 't20-l-at3', part: 8, text: 'How do stores use anchoring, according to the professor?', options: ["By distributing selected products without charging customers","By increasing the listed price of every product equally","By concealing all prices until customers reach the checkout","By displaying a high original price beside a lower sale price"], answer: 3 },
        { type: 'mcq', id: 't20-l-at4', part: 8, text: 'What does the professor say about resisting anchoring?', options: ["It remains difficult even after people learn about the effect","The influence cannot be reduced through any deliberate strategy","Only trained experts experience significant effects from anchoring","Awareness makes the influence simple to eliminate completely"], answer: 0 },
