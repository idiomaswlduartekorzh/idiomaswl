      ...
      questions: [
        {
          ...
          options: ['Chef', 'Waiter', 'Farmer', 'Grocer'],
          answer: 0,
        },
        {
          type: 'mcq',
          ...
          options: ['Recipe', 'Menu', 'Bill', 'Order'],
          answer: 1,
        },
        {
          type: 'mcq',
          ...
          options: ['Ingredient', 'Portion', 'Recipe', 'Cuisine'],
          answer: 2,
        },
        {
          type: 'mcq',
          ...
          options: ['Flavor', 'Texture', 'Spice', 'Cuisine'],
          answer: 3,
        },
        {
          type: 'mcq',
      ...
      questions: [
        {
          ...
          options: ['is frying', 'fried', 'fry', 'had fry'],
          answer: 1,
        },
        {
          type: 'mcq',
        ...
        },
        {
          ...
          options: ['despite', 'although', 'after', 'while'],
          answer: 2,
        },
        {
          type: 'mcq',
          ...
          options: ['rarely', 'never', 'hardly', 'usually'],
          answer: 3,
        },
        {
          type: 'mcq',
          ...
          options: ['pour', 'slice', 'knead', 'drain'],
          answer: 2,
        },
        {
          type: 'mcq',
        ...
        },
        {
          ...
          options: ['is spread', 'spreads', 'has spread', 'spread'],
          answer: 3,
        },
      ],
    },
