...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't9-l-cr1', part: 5, audioUrl: '/audio/toefl/set-9/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["She left the building early yesterday afternoon.","It's the blue building right on the corner.","No, I don't usually play chess after class.","The soup became cold before lunch started."], answer: 1 },
        { type: 'mcq', id: 't9-l-cr2', part: 5, audioUrl: '/audio/toefl/set-9/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["The classroom door is locked for the evening.","Yes, she teaches history at the university.","It is ten meters tall.","I'd love to, but I have a class then."], answer: 3 },
        { type: 'mcq', id: 't9-l-cr3', part: 5, audioUrl: '/audio/toefl/set-9/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["The chocolate cake tastes unusually sweet after baking today.","He is scheduled to arrive at the station next Tuesday.","It costs five dollars at the campus shop near the library.","You can borrow mine for the afternoon if you like."], answer: 3 },
        { type: 'mcq', id: 't9-l-cr4', part: 5, audioUrl: '/audio/toefl/set-9/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["It is made from polished metal and glass.","Sure, let's meet at the café around three.","The train was crowded during this morning's trip.","No, I have not read that particular book."], answer: 1 },
        { type: 'mcq', id: 't9-l-cr5', part: 5, audioUrl: '/audio/toefl/set-9/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["It is quite far from the university campus.","Yes, everything went smoothly; thanks for asking.","The store opens at nine every weekday morning.","She studies law at the local university."], answer: 1 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't9-l-cv1', part: 6, text: 'What decision is the woman trying to make?', options: ["Whether to change her academic major next year","Whether to study in another city next year","Which courses to take during the next semester","Whether to choose a dorm or an apartment"], answer: 3 },
        { type: 'mcq', id: 't9-l-cv2', part: 6, text: 'What advantage of the dorms does the woman mention?', options: ["They are near classes and include prepared meals.","They are quiet and provide private study rooms.","They allow residents to live without any rules.","They cost less and include every utility bill."], answer: 0 },
        { type: 'mcq', id: 't9-l-cv3', part: 6, text: 'What risk does the woman mention about the apartment?', options: ["The apartment is located too close to campus.","She may pay more if a roommate leaves.","The apartment does not provide an internet connection.","The apartment costs more than living in dorms."], answer: 1 },
        { type: 'mcq', id: 't9-l-cv4', part: 6, text: 'What does the woman say is her next step?', options: ["Ask her parents to contribute more rent money","Sign the apartment lease before the deadline tonight","Confirm her friends' commitment before signing the lease","Submit an application to remain in the dorms"], answer: 2 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't9-l-an1', part: 7, text: 'Why is the workshop being moved?', options: ["The scheduled presenter became unavailable at short notice.","The original starting time created a scheduling conflict.","The original room requires cleaning during the workshop.","Attendance was much higher than organizers had expected."], answer: 3 },
        { type: 'mcq', id: 't9-l-an2', part: 7, text: 'Where is the workshop being moved to?', options: ["The main auditorium located on the ground floor","The large meeting room inside the campus library","A lecture hall located in a different building","Room 210 on the building's second floor"], answer: 0 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't9-l-at1', part: 8, text: 'What misconception about sleep does the professor correct?', options: ["People require exactly eight hours of sleep nightly.","Sleep is mainly necessary for children and adolescents.","Sleep is downtime when the brain switches off.","Dreams have no meaning or function for learning."], answer: 2 },
        { type: 'mcq', id: 't9-l-at2', part: 8, text: 'What is the role of the hippocampus, according to the professor?', options: ["It controls the content and timing of dreams.","It produces hormones that initiate deep sleep.","It permanently stores every memory a person forms.","It temporarily stores information with limited capacity."], answer: 3 },
        { type: 'mcq', id: 't9-l-at3', part: 8, text: 'What happens to important memories during deep sleep?', options: ["They move from the hippocampus to the neocortex.","They are replaced by information learned more recently.","They remain permanently stored within the hippocampus.","They are erased to create space for dreams."], answer: 0 },
        { type: 'mcq', id: 't9-l-at4', part: 8, text: 'What do the sleep-versus-wake studies consistently show?', options: ["Participants who stayed awake performed better afterward.","Participants who slept performed better on learned tasks.","Both groups performed equally well on learned tasks.","Participants forgot the task after they had slept."], answer: 1 },
