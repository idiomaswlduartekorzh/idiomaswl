      ...
      questions: [
        {
          ...
          stimulus: '[Vídeo — reportagem, ~3 min] Uma reportagem mostra o impacto de programas de esporte e cultura no contraturno escolar. A repórter visita um projeto que oferece dança, teatro, capoeira e reforço escolar no período em que os alunos não estão na aula, entrevista pais que veem os filhos mais motivados e seguros, e uma coordenadora que explica que o projeto reduziu a evasão escolar e afastou os jovens de situações de risco.',
          text: 'Com base no vídeo, escreva um texto para o jornal do bairro defendendo a criação de atividades de esporte e cultura no contraturno escolar. Explique os benefícios para os jovens e para a comunidade, e proponha como a escola e os moradores podem colaborar. (Mínimo: 200 palavras)',
          minWords: 200,
        },
      ],
    },
