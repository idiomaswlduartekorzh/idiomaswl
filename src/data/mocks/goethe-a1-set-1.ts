...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 'g-a1-1-l6', part: 5, stimulus: 'A — Radhaus: Fahrräder kaufen, mieten und reparieren. Werkstatt Montag bis Samstag von 9 bis 18 Uhr.\n\nB — City-Rad: Geführte Fahrradtouren durch die Altstadt. Jeden Samstag und Sonntag um 10 Uhr. Fahrräder können Sie bei uns mieten.', stimulusLabel: 'Sie möchten am Wochenende eine Fahrradtour machen.', stimulusStyle: 'notice', text: 'Welche Anzeige passt?', options: ['A', 'B'], answer: 1 },
        { type: 'mcq', id: 'g-a1-1-l7', part: 5, stimulus: 'A — Sprachpunkt: Deutsch A1 am Montag und Mittwoch von 19 bis 21 Uhr. Kleine Gruppen, Beginn im September.\n\nB — Bücherwelt: Wörterbücher, Lernbücher und Übungshefte für Deutsch. Heute 20 Prozent Rabatt.', stimulusLabel: 'Sie möchten abends Deutsch lernen.', stimulusStyle: 'notice', text: 'Welche Anzeige passt?', options: ['A', 'B'], answer: 0 },
        { type: 'mcq', id: 'g-a1-1-l8', part: 5, stimulus: 'A — Pension Wald: Ruhige Zimmer ab 45 Euro pro Nacht. Frühstück und WLAN inklusive. Reservierung auch telefonisch.\n\nB — Restaurant Wald: Großes Frühstücksbuffet am Sonntag von 8 bis 12 Uhr. 18 Euro pro Person.', stimulusLabel: 'Sie suchen ein günstiges Zimmer mit Frühstück.', stimulusStyle: 'notice', text: 'Welche Anzeige passt?', options: ['A', 'B'], answer: 0 },
        { type: 'mcq', id: 'g-a1-1-l9', part: 5, stimulus: 'A — Ticketbüro: Karten für Theater, Konzerte und Sportveranstaltungen. Geöffnet Montag bis Freitag.\n\nB — Reisebüro Sonnig: Bahn- und Flugtickets, Hotels und Ausflüge gemeinsam buchen. Persönliche Beratung oder Online-Reservierung.', stimulusLabel: 'Sie möchten eine Zugfahrt buchen.', stimulusStyle: 'notice', text: 'Welche Anzeige passt?', options: ['A', 'B'], answer: 1 },
        { type: 'mcq', id: 'g-a1-1-l10', part: 5, stimulus: 'A — Praxis Dr. Koch: Untersuchungen nach Termin. Telefonische Anmeldung Montag bis Freitag von 8 bis 12 Uhr.\n\nB — Apotheke am Ring: Medikamente und Beratung rund um die Uhr. Nacht- und Notdienst auch sonntags geöffnet.', stimulusLabel: 'Sie brauchen am Sonntagabend Medikamente.', stimulusStyle: 'notice', text: 'Welche Anzeige passt?', options: ['A', 'B'], answer: 1 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 'g-a1-1-l11', part: 6, stimulus: 'RUHETAG\nDas Restaurant bleibt jeden Dienstag geschlossen. Ab Mittwoch sind wir wieder von 11 bis 22 Uhr für Sie da.', stimulusLabel: 'Am Restaurant', stimulusStyle: 'sign', text: 'Am Dienstag kann man hier nicht essen.', options: ['Richtig', 'Falsch'], answer: 0 },
        ...
        { type: 'mcq', id: 'g-a1-1-l13', part: 6, stimulus: 'BIBLIOTHEK\nBücher können Sie auch nach den Öffnungszeiten am Rückgabeautomaten neben dem Eingang abgeben.', stimulusLabel: 'An der Bibliothek', stimulusStyle: 'sign', text: 'Bücher kann man nur bei einer Person zurückgeben.', options: ['Richtig', 'Falsch'], answer: 1 },
        ...
        { type: 'mcq', id: 'g-a1-1-l15', part: 6, stimulus: 'BUS 24\nHeute fährt der Bus nur bis Marktplatz. Für die Weiterfahrt zum Bahnhof nehmen Sie dort bitte Bus 8.', stimulusLabel: 'An der Haltestelle', stimulusStyle: 'sign', text: 'Der Bus 24 fährt heute nicht weiter als bis zum Marktplatz.', options: ['Richtig', 'Falsch'], answer: 0 },
      ],
    },
    {
