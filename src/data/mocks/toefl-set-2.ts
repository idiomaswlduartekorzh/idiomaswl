...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't2-l-cr1', part: 5, audioUrl: '/audio/toefl/set-2/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["She left after the afternoon lecture ended.","It's beside the library, in the next building.","No, I usually get coffee near campus.","The soup stays warm in that covered pot."], answer: 1 },
        { type: 'mcq', id: 't2-l-cr2', part: 5, audioUrl: '/audio/toefl/set-2/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["The window was left open after the meeting.","Yes, she has worked as a pilot for years.","It stands about six meters above the ground.","Sure, I can help you move those boxes today."], answer: 3 },
        { type: 'mcq', id: 't2-l-cr3', part: 5, audioUrl: '/audio/toefl/set-2/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["The bread was delivered fresh this morning.","He is expected to arrive next Tuesday.","It normally costs about nine dollars there.","You can register online through the student portal."], answer: 3 },
        { type: 'mcq', id: 't2-l-cr4', part: 5, audioUrl: '/audio/toefl/set-2/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["It was built from stone many years ago.","No problem—I can wait here until you return.","The bus became crowded near the final stop.","No, I have never visited that place before."], answer: 1 },
        { type: 'mcq', id: 't2-l-cr5', part: 5, audioUrl: '/audio/toefl/set-2/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["It is still quite far from the station.","Yes, I won first prize in the contest yesterday.","The market had already closed before we arrived.","She teaches art at the community center."], answer: 1 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't2-l-cv1', part: 6, text: 'What is the student\'s problem?', options: ["She failed to submit the project before its deadline.","She wants the professor to move her into another group.","She cannot understand what the assignment requires from her.","Two group members are not contributing to the project."], answer: 3 },
        { type: 'mcq', id: 't2-l-cv2', part: 6, text: 'What does the professor suggest the student do first?', options: ["Assign the two members specific tasks and deadlines.","Complete the remaining group work entirely by herself.","Withdraw from the course before the next class meeting.","Report both group members directly to the college dean."], answer: 0 },
        { type: 'mcq', id: 't2-l-cv3', part: 6, text: 'What should the student do if the members still do not help?', options: ["Stop working on the project and accept a lower grade.","Return with records of her attempts to contact them.","Discuss the unhelpful members with students outside the group.","Rewrite the entire group project without telling the professor."], answer: 1 },
        { type: 'mcq', id: 't2-l-cv4', part: 6, text: 'How does the professor say individual effort will be reflected?', options: ["Through one final examination taken by the entire group.","Through a single shared mark with no individual adjustment.","Through peer evaluations that may affect individual grades.","Through identical grades assigned to every group member."], answer: 2 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't2-l-an1', part: 7, text: 'What is the announcement about?', options: ["A temporary change to the schedule of several classes","The planned closure of a gallery on the campus","A concert featuring music performed by current students","A student art contest based on the theme ‘Home’"], answer: 3 },
        { type: 'mcq', id: 't2-l-an2', part: 7, text: 'What must students attach to their entry?', options: ["A brief note explaining what the artwork means to them","A recent photograph showing the student beside the artwork","A detailed essay discussing the history of the chosen medium","A receipt confirming payment of the competition entry fee"], answer: 0 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't2-l-at1', part: 8, text: 'What is the "spacing effect"?', options: ["A technique for increasing reading speed during examinations","A study method based on reviewing material only once","Better memory from spreading study across multiple sessions","A procedure for measuring a learner's general intelligence"], answer: 2 },
        { type: 'mcq', id: 't2-l-at2', part: 8, text: 'In the professor\'s example, which approach leads to better long-term retention?', options: ["Both schedules produce the same amount of long-term retention.","Neither schedule produces useful learning after the final session.","Studying for six hours on the night before the test.","Studying one hour daily over a period of six days."], answer: 3 },
        { type: 'mcq', id: 't2-l-at3', part: 8, text: 'According to the leading explanation, why does spacing work?', options: ["Because effortful retrieval after a delay strengthens memory.","Because spaced practice always feels more enjoyable to students.","Because cramming cannot be used for difficult academic material.","Because spaced sessions require less total study time overall."], answer: 0 },
        { type: 'mcq', id: 't2-l-at4', part: 8, text: 'Why does cramming do little for long-term memory?', options: ["The material becomes too complex to understand after one session.","Easy recall provides too little effort to strengthen memory.","Students become too tired to remember any recently studied material.","A single session always requires substantially more total study time."], answer: 1 },
