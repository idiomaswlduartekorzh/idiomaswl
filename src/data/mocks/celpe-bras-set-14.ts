  ...
  sections: [
    {
      ...
      instructions: 'Assista ao vídeo oficial do CELPE-BRAS (edição 2009/1). Preste atenção ao tema e às informações apresentadas. Depois, redija o texto solicitado em português.',
      audioUrl: '/api/celpe-bras-video?src=https%3A%2F%2Fwww.ufrgs.br%2Facervocelpebras%2Fwp-content%2Fuploads%2F2021%2F12%2F2009_1-Video-Capoeira.mp4',
      questions: [
        {
          type: 'write', id: 'celpe-bras-s14-q1', part: 1, taskNumber: 1,
          stimulusLabel: 'Vídeo oficial CELPE-BRAS — Capoeira',
          stimulus: '[Vídeo oficial CELPE-BRAS, edição 2009/1] Tema: "Capoeira". Assista com atenção para compreender as informações apresentadas antes de escrever seu texto.',
