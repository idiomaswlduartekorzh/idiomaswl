      ...
      questions: [
        {
          ...
          stimulus: '[Vídeo — reportagem, ~3 min] Uma reportagem mostra a expansão da agricultura urbana em grandes cidades brasileiras. A repórter visita hortas cultivadas em lajes de prédios, terrenos vazios e até paredes verticais, entrevista moradores que produzem parte do próprio alimento e um agrônomo que fala sobre segurança alimentar e redução do calor nas cidades. Uma moradora conta que passou a comer melhor e a conhecer os vizinhos depois de participar de uma horta coletiva.',
          text: 'Com base no vídeo, escreva um texto para o site da associação de moradores do seu bairro incentivando a criação de uma horta comunitária. Explique o que é a agricultura urbana, quais benefícios traz e como os vizinhos podem se organizar. (Mínimo: 200 palavras)',
          minWords: 200,
        },
      ],
    },
