      ...
      questions: [
        {
          ...
          options: ['Routine', 'Emergency', 'Holiday', 'Training'],
          answer: 1,
        },
        {
          type: 'mcq',
          ...
          options: ['Firefighter', 'Journalist', 'Engineer', 'Librarian'],
          answer: 0,
        },
        {
          type: 'mcq',
          ...
          options: ['Arrive', 'Evacuate', 'Remain', 'Explore'],
          answer: 1,
        },
        {
          type: 'mcq',
          ...
          options: ['Recipe', 'Schedule', 'Emergency plan', 'Budget'],
          answer: 2,
        },
        {
          type: 'mcq',
          ...
          options: ['Compass', 'Alarm', 'Calendar', 'Thermometer'],
          answer: 1,
        },
      ],
    },
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['is searching', 'searched', 'searches', 'will search'],
          answer: 1,
        },
        {
          type: 'mcq',
          ...
          options: ['enter', 'evacuate', 'rebuild', 'ignore'],
          answer: 1,
        },
        {
          type: 'mcq',
        ...
        },
        {
          ...
          options: ['helped', 'helping', 'helps', 'help'],
          answer: 0,
        },
        {
          type: 'mcq',
          ...
          options: ['public', 'private', 'ancient', 'indoor'],
          answer: 0,
        },
        {
          type: 'mcq',
          ...
          options: ['above', 'onto', 'toward', 'from'],
          answer: 1,
        },
        {
          type: 'mcq',
...
City officials plan to expand ShakeReady to neighboring municipalities by 2025, with funding from a national disaster preparedness grant.`,
          ...
          options: ['Flooding', 'Earthquakes', 'Hurricanes', 'Fires'],
          answer: 1,
        },
        {
          type: 'mcq',
