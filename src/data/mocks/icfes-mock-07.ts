      ...
      questions: [
        {
          ...
          options: ['Referee', 'Supporter', 'Coach', 'Spectator'],
          answer: 2,
        },
        {
          type: 'mcq',
        ...
        },
        {
          ...
          options: ['Trophy', 'Tournament', 'Training', 'Transfer'],
          answer: 1,
        },
        {
          type: 'mcq',
          ...
          options: ['Career', 'Hobby', 'Talent', 'Ambition'],
          answer: 1,
        },
        {
          type: 'mcq',
          ...
          options: ['Fatigue', 'Strain', 'Bruise', 'Fracture'],
          answer: 1,
        },
      ],
    },
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['because of', 'for', 'despite', 'although'],
          answer: 1,
        },
        {
          type: 'mcq',
        ...
        },
        {
          ...
          options: ['option', 'optional', 'optionally', 'opting'],
          answer: 0,
        },
        {
          type: 'mcq',
          ...
          options: ['after', 'until', 'before', 'since'],
          answer: 2,
        },
        {
          type: 'mcq',
        ...
        },
        {
          ...
          options: ['however', 'despite', 'because', 'unless'],
          answer: 2,
        },
      ],
    },
