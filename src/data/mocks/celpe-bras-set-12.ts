      ...
      questions: [
        {
          ...
          stimulus: '[Vídeo — reportagem, ~3 min] Uma reportagem mostra o crescimento das feiras de adoção de animais abandonados. A repórter acompanha um evento em uma praça, entrevista voluntários de uma ONG protetora e famílias que adotaram cães e gatos, e um veterinário que fala sobre castração e posse responsável. Uma voluntária lembra que, para cada animal adotado, há muitos ainda esperando um lar, e critica o abandono e a compra por impulso.',
          text: 'Com base no vídeo, escreva um texto para as redes sociais de uma ONG incentivando a adoção responsável de animais abandonados. Explique a importância de adotar em vez de comprar, os cuidados necessários e como as pessoas podem ajudar. (Mínimo: 200 palavras)',
          minWords: 200,
        },
      ],
    },
