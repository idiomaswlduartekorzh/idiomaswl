      ...
      questions: [
        {
          ...
          stimulus: '[Vídeo — reportagem, ~3 min] Uma reportagem mostra o crescimento do empreendedorismo feminino no Brasil. A repórter entrevista mulheres que abriram o próprio negócio — uma confeiteira, uma dona de salão de beleza e uma desenvolvedora de aplicativos — e uma economista que explica que as mulheres estão à frente de milhões de pequenos negócios no país. As entrevistadas falam sobre desafios como acesso a crédito e a conciliação com a família, mas também sobre autonomia e realização.',
          text: 'Com base no vídeo, escreva um texto para o blog de uma associação comercial destacando a importância do empreendedorismo feminino. Explique os desafios que essas mulheres enfrentam, suas conquistas e como a sociedade pode apoiá-las. (Mínimo: 200 palavras)',
          minWords: 200,
        },
      ],
    },
