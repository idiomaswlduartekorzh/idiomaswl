      ...
      questions: [
        {
          ...
          options: ["On the third floor beside the main elevator.","No, I usually drink tea instead of coffee.","The weather was extremely sunny throughout yesterday.","She is my sister from my mother's side."],
          answer: 0,
        },
        {
          type: 'mcq', id: 't6-l-cr2', part: 5, audioUrl: '/audio/toefl/set-6/listen-choose-2.mp3',
          text: 'Choose the best response to what you heard.',
          options: ["Yes, it is a very old building downtown.","The book normally costs fifteen dollars at the store.","Sorry, I can't; I have to work this Saturday.","The kitchen is being painted during the holiday."],
          answer: 2,
        },
        {
          type: 'mcq', id: 't6-l-cr3', part: 5, audioUrl: '/audio/toefl/set-6/listen-choose-3.mp3',
          text: 'Choose the best response to what you heard.',
          options: ["She was born in Peru but moved here later.","The public lecture begins at ten tomorrow morning.","I normally take the number 12 bus to campus.","It tastes a little too salty for my preference."],
          answer: 2,
        },
        {
          type: 'mcq', id: 't6-l-cr4', part: 5, audioUrl: '/audio/toefl/set-6/listen-choose-4.mp3',
          text: 'Choose the best response to what you heard.',
          options: ["Sure, I can help you carry those boxes upstairs.","The film continued for about two hours yesterday.","No, I have never played tennis before today.","It is made entirely from thick colored glass."],
          answer: 0,
        },
        {
          type: 'mcq', id: 't6-l-cr5', part: 5, audioUrl: '/audio/toefl/set-6/listen-choose-5.mp3',
          text: 'Choose the best response to what you heard.',
          options: ["Yes, I finally finished the assignment last night.","The train was quite crowded during the morning commute.","She teaches chemistry at the nearby secondary school.","It is about ten minutes away by bus."],
          answer: 0,
        },
      ],
    },
      ...
      questions: [
        {
          ...
          options: ["She strongly disagrees with the professor's view of the subject.","She cannot locate enough reliable sources for the assignment.","Her proposed essay topic covers too much material.","She submitted the essay after the required deadline."],
          answer: 2,
        },
        {
          type: 'mcq', id: 't6-l-cv2', part: 6,
          text: 'What does the professor suggest a good research essay should do?',
          options: ["Use every available source related to the general field","Describe the topic without presenting a clear position","Attempt to cover an entire academic field in one essay","Focus the essay on answering one specific research question"],
          answer: 3,
        },
        {
          type: 'mcq', id: 't6-l-cv3', part: 6,
          text: 'According to the professor, what is the hardest lesson for most students?',
          options: ["Remove interesting material that does not answer the research question","Write a strong conclusion that summarizes every section of the essay","Format all citations correctly before submitting the final document","Locate enough academic sources to support the selected topic"],
          answer: 0,
        },
        {
          type: 'mcq', id: 't6-l-cv4', part: 6,
          text: 'What does the professor offer to do?',
          options: ["Select the final research topic on the student's behalf","Review the student's research question before writing begins","Extend the assignment deadline until the following week","Provide a complete list of sources the student must use"],
          answer: 1,
        },
      ],
    },
      ...
      questions: [
        {
          ...
          options: ["The university's upcoming graduation ceremony for final-year students","A temporary change affecting the regular class schedule","The annual fair featuring student clubs and organizations","The opening of a new exercise facility on campus"],
          answer: 2,
        },
        {
          type: 'mcq', id: 't6-l-an2', part: 7,
          text: 'What new feature has been added this year?',
          options: ["An online system for registering with participating student clubs","A food-truck area serving meals throughout the afternoon","A live stage featuring performances by student music groups","A quiet space for private one-to-one conversations"],
          answer: 3,
        },
        {
      ...
      questions: [
        {
          ...
          options: ["That forgetting occurs only among people of advanced age","That forgetting is merely a failure in the memory system","That human memory has no practical limit on stored information","That emotions have no influence on what people remember"],
          answer: 1,
        },
        {
          type: 'mcq', id: 't6-l-at2', part: 8,
          text: 'Why does the professor say remembering everything would be "paralyzing"?',
          options: ["All remembered events would produce emotions that were too strong.","The brain would consume too much energy while storing information.","Irrelevant details would interfere with retrieving useful information.","Constant memories would make it impossible for people to sleep."],
          answer: 2,
        },
        {
          type: 'mcq', id: 't6-l-at3', part: 8,
          text: 'What does the case study of the man who could not forget illustrate?',
          options: ["That every instance of forgetting results from a serious illness","That memories connected to strong emotions are generally unreliable","That perfect memory automatically makes a person exceptionally intelligent","That remembering every detail can obstruct patterns and abstraction"],
          answer: 3,
        },
        {
          type: 'mcq', id: 't6-l-at4', part: 8,
          text: 'According to the professor, which memories tend to be retained?',
          options: ["Frequently used memories and memories linked to strong emotions","Only memories formed during the earliest years of childhood","Memories preserved in writing rather than recalled from experience","Only the most recently formed memories in the brain"],
          answer: 0,
        },
        {
