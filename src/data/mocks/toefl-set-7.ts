...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't7-l-cr1', part: 5, audioUrl: '/audio/toefl/set-7/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["No, the rain stopped earlier this morning.","The blue pen is lying on the desk.","She studies history at the local university.","Around noon, if that time works for you."], answer: 3 },
        { type: 'mcq', id: 't7-l-cr2', part: 5, audioUrl: '/audio/toefl/set-7/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["It weighs approximately two kilograms without the cover.","Thanks, but I already have plans this weekend.","The window is open because the room feels warm.","Yes, he speaks French with his family at home."], answer: 1 },
        { type: 'mcq', id: 't7-l-cr3', part: 5, audioUrl: '/audio/toefl/set-7/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["It normally costs around thirty dollars at the store.","You can print it in the first-floor computer laboratory.","The soup still needs more pepper before it is served.","She is expected to arrive on Monday afternoon."], answer: 1 },
        { type: 'mcq', id: 't7-l-cr4', part: 5, audioUrl: '/audio/toefl/set-7/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["The bus is running late again this morning.","No, I have not seen that particular film yet.","It is made from soft brown leather material.","Of course; I'll send you my notes tonight."], answer: 3 },
        { type: 'mcq', id: 't7-l-cr5', part: 5, audioUrl: '/audio/toefl/set-7/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["The library is closed for maintenance throughout today.","He plays the violin in the university orchestra.","It is approximately five kilometers from the campus.","Yes, it went really well; thanks for asking."], answer: 3 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't7-l-cv1', part: 6, text: 'What are the students mainly discussing?', options: ["A new bicycle-sharing program introduced across the campus","A temporary change to the schedule of several classes","A continuing problem involving rooms inside the student residences","A major construction project affecting several campus buildings"], answer: 0 },
        { type: 'mcq', id: 't7-l-cv2', part: 6, text: 'How much of each ride is free for students?', options: ["One free bicycle ride during each day of use","The first ten minutes of every bicycle journey","The first thirty minutes of each bicycle journey","The complete ride regardless of how long it lasts"], answer: 2 },
        { type: 'mcq', id: 't7-l-cv3', part: 6, text: 'What concern does the man raise?', options: ["New users may find the mobile application difficult to operate.","The bicycle stations may be located too far from one another.","The bicycles may cost more than many students can afford.","Too few bicycles may be available during the busiest periods."], answer: 3 },
        { type: 'mcq', id: 't7-l-cv4', part: 6, text: 'How does the program plan to address busy periods?', options: ["Track demand and add bicycles at the busiest stations","Limit every student to one bicycle journey each day","Permanently close stations that receive fewer daily users","Increase the usage fee during the busiest periods"], answer: 0 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't7-l-an1', part: 7, text: 'What new service is the library launching?', options: ["A new café opening inside the university's main library","Longer borrowing periods offered to eligible graduate students","A redesigned online catalog for searching the library collection","Free printing services available to all currently enrolled students"], answer: 1 },
        { type: 'mcq', id: 't7-l-an2', part: 7, text: 'How long may graduate students now borrow most books?', options: ["For a maximum period of one complete academic year","For three weeks beyond the original return date","For six weeks during the middle of the semester","For as long as twelve weeks in total"], answer: 3 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't7-l-at1', part: 8, text: 'What is the main topic of the lecture?', options: ["The physical reason that the daytime sky appears blue","The process through which Earth's atmosphere originally formed","The optical process responsible for creating visible rainbows","The reason direct sunlight normally appears white to observers"], answer: 0 },
        { type: 'mcq', id: 't7-l-at2', part: 8, text: 'According to the professor, what is Rayleigh scattering?', options: ["Reflection of incoming sunlight from the surfaces of clouds","Stronger scattering of shorter wavelengths by atmospheric gas molecules","Absorption of particular wavelengths of light by atmospheric oxygen","Bending of visible light while it passes through water droplets"], answer: 1 },
        { type: 'mcq', id: 't7-l-at3', part: 8, text: 'Why does the whole sky appear blue rather than just the area near the sun?', options: ["The ocean surface reflects blue light upward into the atmosphere.","Clouds reflect only the blue portion of incoming sunlight.","Scattered blue light reaches observers from every direction.","The sun itself emits light that is primarily blue."], answer: 2 },
        { type: 'mcq', id: 't7-l-at4', part: 8, text: 'Why isn\'t the sky violet, according to the professor?', options: ["Violet light has a longer wavelength than visible blue light.","The atmosphere completely absorbs all incoming violet light.","Violet light passes through the atmosphere without being scattered.","Sunlight has less violet, and human eyes detect blue better."], answer: 3 },
