...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't15-l-cr1', part: 5, audioUrl: '/audio/toefl/set-15/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["The soup is ready to serve in the dining room.","She left early.","It's on the shelf behind the counter.","No, I don't usually enjoy painting landscapes."], answer: 2 },
        { type: 'mcq', id: 't15-l-cr2', part: 5, audioUrl: '/audio/toefl/set-15/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["Sure, I'll pick you up at eight.","The window is broken.","Yes, she works as a dentist downtown.","It measures approximately seven meters in total width."], answer: 0 },
        { type: 'mcq', id: 't15-l-cr3', part: 5, audioUrl: '/audio/toefl/set-15/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["The details are available on the department website.","The bread is fresh from the bakery today.","He is scheduled to arrive next Monday morning.","It costs four dollars at the campus shop."], answer: 0 },
        { type: 'mcq', id: 't15-l-cr4', part: 5, audioUrl: '/audio/toefl/set-15/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["No, I have not read that particular book.","It is made entirely from clear glass.","Of course; I'll bring an extra one for you.","The bus arrived late at the station today."], answer: 2 },
        { type: 'mcq', id: 't15-l-cr5', part: 5, audioUrl: '/audio/toefl/set-15/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["She teaches physics at the local high school.","It is quite far.","Yes, we won the competition!","The shop is closed for the entire afternoon."], answer: 2 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't15-l-cv1', part: 6, text: 'Why is the man stressed?', options: ["Several assignments and a group project are due soon","He recently lost the laptop containing all his work","He is preparing to move into another apartment","He received a failing grade on an important exam"], answer: 0 },
        { type: 'mcq', id: 't15-l-cv2', part: 6, text: 'What is the man\'s current approach to his work?', options: ["He organizes tasks using a carefully prioritized list.","He attempts everything at once and performs poorly.","He avoids beginning any of the assigned work.","He requests deadline extensions from every course professor."], answer: 1 },
        { type: 'mcq', id: 't15-l-cv3', part: 6, text: 'What technique does the woman say helped her most?', options: ["Studying with music","Continue working throughout the entire night without resting","Divide large assignments into smaller manageable steps","Skip selected assignments when the workload becomes excessive"], answer: 2 },
        { type: 'mcq', id: 't15-l-cv4', part: 6, text: 'What does the woman advise about the group project?', options: ["Request additional time to complete the group project","Wait until shortly before the final project deadline","Complete every part of the project independently","Contact the team soon and divide the tasks"], answer: 3 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't15-l-an1', part: 7, text: 'What is the announcement about?', options: ["An upcoming science fair for student projects","A revision to the school's regular class timetable","A planned educational trip for science students","An interschool sports day scheduled for next month"], answer: 0 },
        { type: 'mcq', id: 't15-l-an2', part: 7, text: 'What must students submit by Friday if they want to take part?', options: ["A fully completed science project ready for display","A one-page proposal describing the intended project","A payment covering the project's required materials","A photograph illustrating the proposed scientific experiment"], answer: 1 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't15-l-at1', part: 8, text: 'What did scientists believe about the deep ocean floor before the late 1970s?', options: ["The deep ocean was warmer than surface waters.","The deep ocean contained large cities of fish.","The dark ocean floor supported abundant plant life.","The deep ocean was almost lifeless without sunlight."], answer: 3 },
        { type: 'mcq', id: 't15-l-at2', part: 8, text: 'What did scientists discover near the Galápagos Islands in 1977?', options: ["Thriving communities surrounding deep-sea hydrothermal vents","A previously unknown island near the Galápagos archipelago","Fossil evidence from several species of ancient plants","A large sunken ship resting on the ocean floor"], answer: 0 },
        { type: 'mcq', id: 't15-l-at3', part: 8, text: 'What is "chemosynthesis"?', options: ["Plants producing food by capturing energy from sunlight","Bacteria producing food with energy from chemical compounds","A process that removes pollutants from deep ocean water","A particular type of mineral-rich hydrothermal ocean vent"], answer: 1 },
        { type: 'mcq', id: 't15-l-at4', part: 8, text: 'What supports the entire vent ecosystem?', options: ["Fish that regularly migrate downward from surface waters","Plants adapted to grow without any available sunlight","Bacteria capable of producing food through chemosynthesis","Sunlight that penetrates through the entire water column"], answer: 2 },
