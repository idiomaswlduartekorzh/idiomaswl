...
Miriam`,
  ...
  listening: {
    ...
    parts: [
      ...
      },
      {
        ...
        plays: 1,
        items: [
          { ...choice('g-a2-1-h3-1', 'Was leiht die Frau aus?', ['eine Bohrmaschine', 'eine Leiter', 'eine Nähmaschine'], 1, 'Die Leiter wird bis Montag gebraucht.', ['Falsch: Die Bohrmaschine hat sie schon.', 'Richtig: Sie entscheidet sich für die Leiter.', 'Falsch: Eine Nähmaschine kommt nicht vor.'], '/images/goethe/a2-1/hoeren-teil3-1.svg', 'Drei redaktionelle Illustrationen: Bohrmaschine, Leiter und Nähmaschine.'), turns: [{ speaker: 'Mann', text: 'Brauchen Sie die Bohrmaschine oder die Leiter?' }, { speaker: 'Frau', text: 'Die Bohrmaschine habe ich schon. Aber die Leiter brauche ich bis Montag.' }] },
  ...
  media: {
    ...
    photography: 'none',
    assets: [
      { id: 'h2-places', path: '/images/goethe/a2-1/hoeren-teil2-orte.svg', purpose: 'nine-option listening board', alt: 'Neun redaktionelle Illustrationen von Alltagssituationen.' },
