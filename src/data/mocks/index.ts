...
import goetheA1Set8 from './goethe-a1-set-8';
import goetheA1Set9 from './goethe-a1-set-9';
import goetheA1Set10 from './goethe-a1-set-10';
...
const MOCK_REGISTRY: Record<string, MockExam> = {
  ...
  'toefl:set-3': withToefl2026FixedForm(toeflSet3),
  'toefl:set-4': withToefl2026FixedForm(toeflSet4),
  'toefl:set-5': withToefl2026FixedForm(toeflSet5),
  'toefl:set-6': withToefl2026FixedForm(toeflSet6),
  'toefl:set-7': withToefl2026FixedForm(toeflSet7),
  'toefl:set-8': withToefl2026FixedForm(toeflSet8),
  'toefl:set-9': withToefl2026FixedForm(toeflSet9),
  'toefl:set-10': withToefl2026FixedForm(toeflSet10),
  'toefl:set-11': withToefl2026FixedForm(toeflSet11),
  'toefl:set-12': withToefl2026FixedForm(toeflSet12),
  'toefl:set-13': withToefl2026FixedForm(toeflSet13),
  'toefl:set-14': withToefl2026FixedForm(toeflSet14),
  'toefl:set-15': withToefl2026FixedForm(toeflSet15),
  'toefl:set-16': withToefl2026FixedForm(toeflSet16),
  'toefl:set-17': withToefl2026FixedForm(toeflSet17),
  'toefl:set-18': withToefl2026FixedForm(toeflSet18),
  'toefl:set-19': withToefl2026FixedForm(toeflSet19),
  'toefl:set-20': withToefl2026FixedForm(toeflSet20),
  ...
  'goethe:a1-8': goetheA1Set8,
  'goethe:a1-9': goetheA1Set9,
  'goethe:a1-10': goetheA1Set10,
