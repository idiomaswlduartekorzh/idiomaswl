...
const MOCK_REGISTRY: Record<string, MockExam> = {
  ...
  'toefl:set-9': toeflSet9,
  'toefl:set-10': toeflSet10,
  'toefl:set-11': toeflSet11,
  'toefl:set-12': toeflSet12,
  'toefl:set-13': toeflSet13,
  'toefl:set-14': toeflSet14,
  'toefl:set-15': toeflSet15,
  'toefl:set-16': toeflSet16,
  'toefl:set-17': toeflSet17,
  'toefl:set-18': toeflSet18,
  'toefl:set-19': toeflSet19,
  'toefl:set-20': toeflSet20,
