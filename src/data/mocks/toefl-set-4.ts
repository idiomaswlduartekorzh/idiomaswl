...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't4-l-cr1', part: 5, audioUrl: '/audio/toefl/set-4/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["The soup will be ready in about ten minutes.","She left the building earlier this afternoon.","It's at the end of the hall, on the left.","No, I normally go running only on weekends."], answer: 2 },
        { type: 'mcq', id: 't4-l-cr2', part: 5, audioUrl: '/audio/toefl/set-4/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["Sure, I can give you a ride to the airport.","The window was broken during yesterday's heavy storm.","Yes, she has worked as a lawyer for years.","It measures about seven meters from side to side."], answer: 0 },
        { type: 'mcq', id: 't4-l-cr3', part: 5, audioUrl: '/audio/toefl/set-4/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["The opening hours are posted beside the main door.","The bread should stay warm inside that covered basket.","He is expected to arrive on Monday afternoon.","It normally costs about four dollars at the store."], answer: 0 },
        { type: 'mcq', id: 't4-l-cr4', part: 5, audioUrl: '/audio/toefl/set-4/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["No, I have not tried that particular one yet.","It was made from clay by a local artist.","Of course—I'll help you carry it upstairs.","The bus was almost empty when it reached campus."], answer: 2 },
        { type: 'mcq', id: 't4-l-cr5', part: 5, audioUrl: '/audio/toefl/set-4/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["She teaches history at the community learning center.","It is quite cheap compared with the other models.","Yes, I earned a place on the team!","The library is far from the nearest bus stop."], answer: 2 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't4-l-cv1', part: 6, text: 'Why does the student apologize at the start?', options: ["Her borrowed library book is already past its due date.","She accidentally damaged several pages of the borrowed book.","She was speaking too loudly inside the main reading room.","She cannot find the book that she borrowed last month."], answer: 0 },
        { type: 'mcq', id: 't4-l-cv2', part: 6, text: 'What does the librarian offer to do about the fine?', options: ["Charge twice the normal fine for the overdue book","Waive the fine because this is her first overdue book","Report the student's late return to the department chair","Suspend the student's borrowing privileges for the entire term"], answer: 1 },
        { type: 'mcq', id: 't4-l-cv3', part: 6, text: 'What tip does the librarian give for the future?', options: ["Return every borrowed book one day before its due date","Avoid borrowing any additional books during the academic term","Renew the book online before its due date when necessary","Pay the full overdue fine whenever additional time is needed"], answer: 2 },
        { type: 'mcq', id: 't4-l-cv4', part: 6, text: 'What does the librarian do for the student at the end?', options: ["Order a replacement copy from another library branch","Close the student's borrowing account for three weeks","Charge the overdue fine without renewing the borrowed book","Renew the same book for an additional three weeks"], answer: 3 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't4-l-an1', part: 7, text: 'What is the announcement about?', options: ["A new station where students can repair bicycles for free","A campus cycling competition planned for the following weekend","A new rule prohibiting bicycles near the academic buildings","A new parking area reserved for cars belonging to students"], answer: 0 },
        { type: 'mcq', id: 't4-l-an2', part: 7, text: 'Why are the tools attached with cables?', options: ["To keep the tools looking clean and attractive for visitors","To keep the tools available for everyone who needs them","To recharge the electrical batteries inside each repair tool","To record how frequently students use the repair station"], answer: 1 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't4-l-at1', part: 8, text: 'What are "heuristics," as the professor describes them?', options: ["A condition that causes people to lose stored memories","Equations used to calculate the probability of uncertain events","Perfectly rational calculations made before every important decision","Mental shortcuts that speed decisions but can create systematic errors"], answer: 3 },
        { type: 'mcq', id: 't4-l-at2', part: 8, text: 'What is the "availability heuristic"?', options: ["Selecting the least expensive option in every purchasing decision","Rejecting all available evidence before reaching a final conclusion","Calculating the exact mathematical probability of every possible event","Estimating likelihood from how easily examples come to mind"], answer: 3 },
        { type: 'mcq', id: 't4-l-at3', part: 8, text: 'Why do many people overestimate the danger of flying after a plane crash?', options: ["Air travel actually causes more accidents than road travel.","Vivid crash images make the risk seem greater than it is.","Commercial airplanes normally travel more slowly than private cars.","Many passengers avoid airports because they dislike crowded places."], answer: 1 },
        { type: 'mcq', id: 't4-l-at4', part: 8, text: 'According to the professor, why do we have these mental shortcuts?', options: ["They have no useful role in ordinary human decision-making.","They produce perfectly accurate decisions in every possible situation.","They usually provide useful answers when quick judgments are needed.","They first appeared only recently in modern human societies."], answer: 2 },
