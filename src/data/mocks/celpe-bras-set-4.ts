      ...
      questions: [
        {
          ...
          stimulus: '[Vídeo — reportagem, ~3 min] Uma reportagem mostra projetos de reaproveitamento de água da chuva em escolas públicas do semiárido nordestino. A repórter visita uma escola no interior da Bahia que instalou cisternas para captar água da chuva, entrevista professores e alunos e mostra como a água é usada na horta escolar e na limpeza. Um engenheiro explica que a tecnologia é simples e barata, e que essas soluções ajudam comunidades a conviver com a seca.',
          text: 'Com base no vídeo, escreva um texto para o site de uma ONG ambiental apresentando o projeto de captação de água da chuva nas escolas do semiárido. Explique como funciona, quais problemas resolve e por que merece apoio e financiamento. (Mínimo: 200 palavras)',
          minWords: 200,
        },
      ],
    },
