...
const SET9 = content(
  9,
  ['Was nimmt der Mann mit?', ['eine Jacke', 'einen Hut', 'einen Regenschirm'], 2, 'regenweg', 'Der Himmel ist schon ganz dunkel. Nimmst du deine warme Jacke oder wenigstens den Hut mit?', 'Die Jacke brauche ich nicht, und der Hut hilft bei Regen kaum. Ich stecke lieber den kleinen Regenschirm in meine Tasche.', 'Das ist gut. Laut Wetterbericht regnet es heute Nachmittag sehr stark.'],
  [
    ['Was kauft die Frau im Museumsshop?', ['eine Postkarte', 'ein Buch', 'eine Tasse'], 0, 'museumshop', 'Möchten Sie den großen Bildband über die Stadt kaufen? Wir haben auch Tassen mit dem Museumslogo.', 'Heute nicht, danke. Das Buch ist zu schwer und eine Tasse habe ich schon. Ich nehme nur diese Postkarte für meine Schwester.', 'Gern. Die Postkarte kostet einen Euro zwanzig.'],
    ['Wann ist der Friseurtermin?', ['um 14:15 Uhr', 'um 14:30 Uhr', 'um 14:45 Uhr'], 1, 'friseurtermin', 'Frau Baumann, Ihr Termin ist morgen um Viertel nach zwei, richtig?', 'Fast. Ich komme um halb drei. Um Viertel vor drei muss ich schon wieder im Büro sein, deshalb möchte ich nur die Haare schneiden lassen.', 'Kein Problem, wir sind rechtzeitig fertig.'],
    ['Welches Gebäck nimmt der Mann?', ['Vollkornbrot', 'Baguette', 'Brezel'], 2, 'baeckerei', 'Darf es ein Vollkornbrot oder ein frisches Baguette sein?', 'Danke, beides brauche ich heute nicht. Für die Zugfahrt möchte ich nur eine große Brezel mit Butter.', 'Die Brezeln kommen gerade warm aus dem Ofen.'],
    ['Wie viele Pakete holt die Frau ab?', ['zwei', 'vier', 'sechs'], 0, 'pakete', 'Hier stehen sechs Pakete auf Ihrer Karte. Möchten Sie alle mitnehmen?', 'Nein, vier davon gehören meiner Nachbarin. Für mich sind nur zwei kleine Pakete da, und die passen in meinen Rucksack.', 'Dann brauche ich bitte noch Ihren Ausweis.'],
    ['Wo treffen sich die Kollegen?', ['an der Information', 'bei den Schließfächern', 'an Gleis 3'], 1, 'bahnhofstreffen', 'Treffen wir uns im Bahnhof an der Information? Das ist leicht zu finden.', 'Dort ist es morgens sehr voll. Warten wir lieber bei den Schließfächern. Von dort gehen wir zusammen zu Gleis drei.', 'Einverstanden, ich bin um sieben Uhr dort.'],
    ['Wie fährt Mira zum Abendkurs?', ['mit dem Bus', 'mit dem Fahrrad', 'mit der Straßenbahn'], 2, 'abendkursweg', 'Fährst du heute mit dem Bus zum Abendkurs, Mira? Dein Fahrrad steht doch auch vor dem Haus.', 'Der Bus kommt wegen der Baustelle zu spät, und im Dunkeln fahre ich nicht gern Rad. Deshalb nehme ich die Straßenbahn.', 'Die hält direkt gegenüber von der Schule.'],
  ],
  [
    ['Der Lesesaal bleibt heute bis 18 Uhr geöffnet.', 1, 'Liebe Besucherinnen und Besucher. Der Lesesaal schließt heute aus technischen Gründen bereits um siebzehn Uhr. Bücher können Sie bis achtzehn Uhr am Automaten im Eingangsbereich zurückgeben. Morgen gelten wieder die normalen Zeiten.'],
    ['Fahrgäste können eine Fahrkarte beim Fahrer kaufen.', 0, 'Information für die Fahrgäste der Linie zwölf. Fahrkarten bekommen Sie heute auch direkt beim Fahrer. Bitte bezahlen Sie möglichst passend. Der Automat an der Haltestelle Markt ist zurzeit außer Betrieb.'],
    ['Der Kinderfilm läuft in Saal 2.', 1, 'Willkommen im Stadtkino. Der Kinderfilm um sechzehn Uhr läuft heute in Saal vier, nicht in Saal zwei. Bereits gekaufte Karten bleiben gültig. Familien warten bitte vor dem Eingang im ersten Stock.'],
    ['Das Fundbüro ist am Vormittag geöffnet.', 0, 'Guten Tag. Das Fundbüro im Rathaus ist montags bis freitags von acht bis zwölf Uhr geöffnet. Am Nachmittag können Sie verlorene Gegenstände online melden. Abholungen sind dann leider nicht möglich.'],
  ],
  [
    ['Wann kommt Lena?', ['am Samstag', 'am Sonntag', 'am Montag'], 0, 'Hallo Tom, Lena hier. Ich komme schon am Samstag zu euch. Am Sonntag besuchen wir gemeinsam den Markt, und am Montag muss ich früh zurück zur Arbeit. Kannst du mich am Samstagabend vom Bahnhof abholen?'],
    ['Wo liegt das Paket?', ['im Hausflur', 'am Kiosk', 'bei der Nachbarin'], 1, 'Hallo Frau Berger, der Paketdienst konnte Sie nicht erreichen. Ihr Paket liegt nicht im Hausflur und auch nicht bei Ihrer Nachbarin. Sie können es ab heute Nachmittag am Kiosk an der Ecke abholen.'],
    ['Was soll David mitbringen?', ['eine Lampe', 'eine Leiter', 'Handschuhe'], 2, 'Hallo David, wir arbeiten morgen im Garten. Eine Lampe brauchen wir draußen nicht, und die Leiter steht schon in der Garage. Bring bitte deine Arbeitshandschuhe mit, denn wir schneiden viele alte Äste.'],
    ['Warum bleibt das Geschäft geschlossen?', ['Es gibt kein Wasser.', 'Die Verkäuferin ist krank.', 'Die Tür ist kaputt.'], 0, 'Guten Morgen, hier ist der Blumenladen Rose. Wir können heute leider nicht öffnen, weil im ganzen Haus das Wasser abgestellt ist. Unsere Verkäuferin ist gesund, und die neue Eingangstür funktioniert schon.'],
    ['Welche Nummer soll Herr Yilmaz anrufen?', ['040 6289', '040 6829', '040 6892'], 1, 'Guten Tag, Herr Yilmaz. Hier ist die Fahrradwerkstatt. Ihr Rad ist fertig. Rufen Sie uns bitte unter null vier null, sechs acht zwei neun an. Die Nummer endet also nicht mit acht neun oder neun zwei.'],
  ],
  { textA: 'Hallo Nora,\nam Samstag feiere ich meinen Geburtstag mit einem Frühstück bei mir zu Hause. Wir beginnen um 10 Uhr, weil Lea am Nachmittag arbeiten muss. Kaffee, Brot und Obst habe ich schon. Kannst du bitte Joghurt mitbringen? Komm am besten mit der U-Bahn; vor meinem Haus gibt es keine Parkplätze.\nLiebe Grüße\nMiriam', textB: 'Liebe Mitarbeiterinnen und Mitarbeiter,\nam Mittwoch wird unsere Büroküche gründlich gereinigt. Von 8 bis 12 Uhr können Sie dort weder kochen noch Kaffee machen. Der Wasserspender im Flur bleibt geöffnet. Bitte nehmen Sie Ihr Geschirr schon am Dienstagabend aus den Schränken.\nViele Grüße\nDie Hausverwaltung', questions: [{ label: 'Text A', text: 'Miriam lädt Nora zu einem Frühstück ein.', answer: 0 }, { label: 'Text A', text: 'Nora soll mit dem Auto kommen.', answer: 1 }, { label: 'Text B', text: 'Die Büroküche wird am Mittwoch gereinigt.', answer: 0 }, { label: 'Text B', text: 'Am Vormittag kann man in der Küche Kaffee machen.', answer: 1 }, { label: 'Text B', text: 'Das Geschirr soll vorher aus den Schränken genommen werden.', answer: 0 }] },
  [
    ['Sie möchten für ein Wochenende eine Nähmaschine mieten.', 'Stoffwelt: Stoffe, Knöpfe und neue Nähmaschinen im Verkauf. Keine Vermietung.', 'Nähstudio LeihFix: Moderne Nähmaschinen tageweise oder am Wochenende mieten. Kurze Einführung inklusive.', 1, 'naehmaschine'],
    ['Sie möchten am Samstag Honig aus der Region kaufen.', 'Imkerei Sonnengold: Honig aus der Umgebung. Hofladen samstags von 8 bis 13 Uhr geöffnet.', 'Supermarkt Nord: Lebensmittel aus aller Welt. Regionale Produkte nur auf Bestellung.', 0, 'honig'],
    ['Sie suchen ein Ferienhaus, in dem Ihr Hund erlaubt ist.', 'Pension Ruhe: Kleine Zimmer im Zentrum. Haustiere sind im ganzen Haus nicht erlaubt.', 'Waldhaus Ferien: Haus mit Garten für vier Personen. Hunde willkommen, Wanderwege direkt vor der Tür.', 1, 'ferienhaushund'],
    ['Sie brauchen heute noch einen Sehtest.', 'Optik Klarblick: Kostenloser Sehtest ohne Termin, montags bis samstags bis 19 Uhr.', 'Augenpraxis Mitte: Untersuchungen nur mit Termin. Nächster freier Termin in drei Wochen.', 0, 'sehtest'],
    ['Sie suchen günstige gebrauchte Kinderbücher.', 'Buchinsel: Neue Romane und Reiseführer. Keine Bücher für Kinder.', 'Kinderkiste: Gebrauchte Bilder- und Kinderbücher ab zwei Euro. Tausch am Freitagnachmittag möglich.', 1, 'kinderbuecher'],
  ],
  [['In der Bäckerei', 'BITTE NUMMER ZIEHEN\nWIR RUFEN SIE AUF.', 'Man soll warten, bis die eigene Nummer kommt.', 0], ['Am Spielplatz', 'BENUTZUNG NUR BIS 20 UHR.', 'Kinder dürfen hier auch nachts spielen.', 1], ['Im Fahrradkeller', 'TÜR IMMER ABSCHLIESSEN.', 'Die Tür soll geschlossen und abgeschlossen sein.', 0], ['An der Kasse', 'RÜCKGABE NUR MIT KASSENBON\nINNERHALB VON 14 TAGEN.', 'Mit Kassenbon kann man die Ware innerhalb von zwei Wochen zurückgeben.', 0], ['Im Aufzug', 'MAXIMAL 6 PERSONEN ODER 480 KG.', 'Sieben Personen dürfen zusammen fahren.', 1]],
  { scenario: 'Ihre Freundin Valeria Petrova ist 29 Jahre alt und kommt aus Bulgarien. Sie wohnt in Dresden, Elbweg 14, und arbeitet als Floristin. Ab dem 9. September möchte sie einen Keramikkurs am Montag besuchen. Valeria ist Linkshänderin. Ihre Telefonnummer ist 0176 391 52 84. Sie bezahlt mit Karte.', title: 'WERKSTATT TON & FORM · Kursanmeldung', example: 'Familienname, Vorname: Petrova, Valeria', template: 'Herkunftsland: Bulgarien\nAlter: {{1}}\nStraße, Hausnummer: Elbweg 14\nWohnort: {{2}}\nTelefon: 0176 391 52 84\nBeruf: {{3}}\nKursbeginn: {{4}}\nBesondere Information: {{5}}\nZahlungsweise: Karte', blanks: [{ answers: ['29', '29 Jahre'], maxWords: 2 }, { answers: ['Dresden'] }, { answers: ['Floristin'] }, { answers: ['9. September', '09. September', '9 September'], maxWords: 2 }, { answers: ['Linkshänderin', 'Linkshaenderin'] }] },
  { label: 'E-Mail an den Paketdienst', stimulus: 'Ihr Paket sollte gestern an einer Packstation liegen, aber das Fach war leer. Schreiben Sie dem Paketdienst.', bullets: ['Beschreiben Sie das Problem.', 'Nennen Sie die Sendungsnummer.', 'Bitten Sie um eine schnelle Antwort.'] },
  ['WOHNEN\nMiete · Balkon · Nachbarn · Küche · Möbel · Haustier', 'UNTERWEGS\nHaltestelle · Fahrplan · Gepäck · Verspätung · Weg · Taxi'],
  [['Schlüssel', 'Besen', 'Topf', 'Lampe', 'Decke', 'Schere'], ['Fahrradpumpe', 'Stadtplan', 'Trinkflasche', 'Rucksack', 'Fahrkarte', 'Sonnenbrille']],
);

const SET10 = content(
  10,
  ['Was bringt die Frau zum Picknick mit?', ['eine Decke', 'einen Korb', 'einen Ball'], 1, 'picknick', 'Bringst du die große Decke für unser Picknick mit? Einen Ball könnten wir im Park auch gut gebrauchen.', 'Die Decke nimmt Jonas, und den Ball bringt Aylin. Ich packe das Essen und die Teller in meinen Korb.', 'Perfekt. Dann treffen wir uns um zwölf Uhr am See.'],
  [
    ['Wie viel Pfand bekommt der Mann?', ['1,50 Euro', '3 Euro', '5 Euro'], 0, 'flaschenpfand', 'Sie bringen sechs Flaschen zurück. Bekomme ich dafür drei Euro Pfand?', 'Nein, jede Flasche bringt fünfundzwanzig Cent. Zusammen sind das ein Euro fünfzig. Fünf Euro kostet nur die neue Getränkekiste.', 'Dann nehme ich das Pfand bitte bar.'],
    ['Wann ist der Zahnarzttermin?', ['um 9:15 Uhr', 'um 9:45 Uhr', 'um 10:15 Uhr'], 1, 'zahnarzttermin', 'Mein Termin bei Frau Doktor Kern ist morgen um Viertel nach neun, oder?', 'Nein, Sie kommen um Viertel vor zehn. Um Viertel nach zehn ist bereits der nächste Patient eingetragen.', 'Gut, dann bin ich zehn Minuten früher da.'],
    ['Welche Blumen kauft die Frau?', ['Tulpen', 'Rosen', 'Sonnenblumen'], 2, 'blumenstrauss', 'Die roten Tulpen sind heute sehr frisch. Oder möchten Sie lieber diese weißen Rosen?', 'Beide passen nicht so gut. Meine Mutter liebt gelbe Blumen. Ich nehme deshalb fünf Sonnenblumen.', 'Gern, ich mache Ihnen daraus einen schönen Strauß.'],
    ['Wie viele Kopien braucht der Mann?', ['acht', 'zwölf', 'zwanzig'], 0, 'kopien', 'Soll ich zwölf Kopien von diesem Formular machen? Zwanzig Blatt hätten wir auch noch.', 'Acht Kopien reichen für alle Teilnehmer. Bitte drucken Sie jede Seite nur einmal und in Schwarz-Weiß.', 'In zwei Minuten sind die acht Exemplare fertig.'],
    ['Wo steht das Fahrrad?', ['im Keller', 'auf dem Balkon', 'in der Garage'], 1, 'fahrradplatz', 'Hast du dein Fahrrad wieder in den Keller gestellt?', 'Nein, dort wird heute geputzt. Die Garage ist voll, deshalb steht es auf meinem Balkon neben der Tür.', 'Vergiss nicht, es später abzuschließen.'],
    ['Wie fährt Lukas zum Zoo?', ['mit dem Zug', 'mit dem Auto', 'mit der Straßenbahn'], 2, 'zooweg', 'Fährst du am Sonntag mit dem Zug zum Zoo, Lukas? Mit dem Auto wäre es schneller.', 'Am Zoo gibt es kaum Parkplätze, und der Zug hält weit weg. Die Straßenbahn fährt direkt bis zum Haupteingang.', 'Dann kaufe ich eine Tageskarte für uns.'],
  ],
  [
    ['Der Wochenmarkt findet heute draußen statt.', 1, 'Information für unsere Marktbesucher. Wegen des starken Windes findet der Wochenmarkt heute in der Sporthalle statt. Der Platz vor dem Rathaus bleibt geschlossen. Die Verkaufszeiten von neun bis vierzehn Uhr ändern sich nicht.'],
    ['Das Schwimmbad öffnet um 7 Uhr.', 0, 'Guten Morgen. Das Hallenbad öffnet heute wie gewohnt um sieben Uhr. Das große Becken ist ab acht Uhr frei, weil vorher ein Schwimmkurs trainiert. Die Sauna bleibt den ganzen Vormittag geschlossen.'],
    ['Der Aufzug fährt bis in den fünften Stock.', 1, 'Achtung im Ärztehaus. Der Aufzug fährt wegen einer Reparatur heute nur bis zum vierten Stock. Patienten für den fünften Stock benutzen bitte die Treppe oder melden sich am Empfang.'],
    ['Das Büro der Musikschule ist am Donnerstagnachmittag geöffnet.', 0, 'Liebe Kursteilnehmerinnen und Kursteilnehmer. Unser Büro ist donnerstags von vierzehn bis achtzehn Uhr geöffnet. Vormittags beantworten wir nur E-Mails. Anmeldungen für neue Kurse sind auch online möglich.'],
  ],
  [
    ['Wann soll Rosa anrufen?', ['heute Abend', 'morgen früh', 'am Wochenende'], 0, 'Hallo Rosa, hier ist Tim. Ruf mich bitte heute Abend nach acht Uhr an. Morgen früh bin ich beim Arzt, und am Wochenende fahre ich zu meinen Eltern. Es geht um unsere gemeinsame Reise.'],
    ['Wo wartet Herr Novak?', ['vor der Bank', 'im Café', 'an der Bushaltestelle'], 1, 'Guten Tag, Frau Seidel. Herr Novak wartet im Café gegenüber vom Rathaus. Vor der Bank war kein Platz, und an der Bushaltestelle ist es zu laut. Er sitzt hinten am Fenster.'],
    ['Was soll Kim kaufen?', ['Reis', 'Tomaten', 'Käse'], 2, 'Hallo Kim, für das Abendessen haben wir noch Reis und Tomaten zu Hause. Bitte kauf auf dem Rückweg etwas Käse. Nimm ungefähr zweihundert Gramm; Brot hole ich selbst beim Bäcker.'],
    ['Warum kommt Anton später?', ['Sein Bus hat Verspätung.', 'Er arbeitet länger.', 'Er sucht seinen Schlüssel.'], 0, 'Hallo Eva, Anton hier. Mein Bus hat ungefähr zwanzig Minuten Verspätung, deshalb komme ich später. Mit der Arbeit bin ich fertig, und meinen Schlüssel habe ich auch schon gefunden. Warte bitte im Restaurant.'],
    ['Welche Etage ist richtig?', ['Erdgeschoss', 'zweiter Stock', 'dritter Stock'], 1, 'Guten Tag, Frau Mendes. Der Sprachkurs findet heute im zweiten Stock in Raum zweiundzwanzig statt. Im Erdgeschoss ist nur die Anmeldung, und im dritten Stock schreibt eine andere Gruppe eine Prüfung.'],
  ],
  { textA: 'Hallo Daniel,\nich ziehe nächsten Samstag in meine neue Wohnung. Der Umzugswagen kommt schon um 8 Uhr. Kannst du ab 9 Uhr helfen? Wir müssen vor allem Bücher und Pflanzen tragen; die großen Möbel übernimmt die Firma. Mittags bestelle ich Pizza für alle. Bitte bring Arbeitsschuhe mit.\nViele Grüße\nKlara', textB: 'Liebe Eltern,\nam Donnerstag macht unsere Klasse einen Ausflug zum Bauernhof. Die Kinder treffen sich um 7:45 Uhr vor der Schule; der Bus fährt um 8 Uhr ab. Bitte geben Sie Ihrem Kind ein Frühstück und eine Regenjacke mit. Wir sind gegen 16 Uhr zurück.\nHerzliche Grüße\nFrau Neumann', questions: [{ label: 'Text A', text: 'Klara zieht am Samstag um.', answer: 0 }, { label: 'Text A', text: 'Daniel soll die großen Möbel tragen.', answer: 1 }, { label: 'Text B', text: 'Die Klasse fährt am Donnerstag zum Bauernhof.', answer: 0 }, { label: 'Text B', text: 'Der Bus fährt um 7:45 Uhr ab.', answer: 1 }, { label: 'Text B', text: 'Die Kinder sollen eine Regenjacke mitbringen.', answer: 0 }] },
  [
    ['Sie möchten am Abend einen Raum zum Tanzen mieten.', 'Praxis Ruhe: Heller Raum für Yoga und Meditation bis 18 Uhr. Laute Musik ist nicht erlaubt.', 'Tanzsaal Luna: Großer Saal mit Musikanlage, abends und am Wochenende stundenweise zu mieten.', 1, 'tanzraum'],
    ['Sie suchen einen Reparaturdienst für Ihre Kaffeemaschine.', 'Küchenservice Braun: Reparatur von Kaffeemaschinen und kleinen Küchengeräten. Abholung in der Stadt möglich.', 'Café Bohne: Kaffee, Kuchen und Frühstück. Keine Reparaturen oder Ersatzteile.', 0, 'kaffeemaschine'],
    ['Sie möchten montags nach der Arbeit Spanisch lernen.', 'Sprachclub Vormittag: Spanischkurse montags und mittwochs um 10 Uhr. Nur für Personen ohne Berufstätigkeit.', 'Centro Español: Anfängerkurs montags um 19 Uhr. Kleine Gruppen, erste Probestunde kostenlos.', 1, 'spanischkurs'],
    ['Sie brauchen für morgen einen Kleinbus mit Fahrer.', 'CityMobil: Kleinbusse mit Fahrer für sechs bis acht Personen, kurzfristig telefonisch buchbar.', 'Auto Privat: Kleine Autos wochenweise mieten. Kein Fahrer und keine Busse verfügbar.', 0, 'kleinbus'],
    ['Sie möchten alte Möbel kostenlos abgeben.', 'Möbelmarkt Neu: Verkauf neuer Tische, Betten und Schränke. Keine Annahme gebrauchter Möbel.', 'Sozialkaufhaus Mitte: Holt gut erhaltene gebrauchte Möbel kostenlos ab. Termin online vereinbaren.', 1, 'moebelspende'],
  ],
  [['In der Bibliothek', 'ESSEN UND TRINKEN NUR IM CAFÉ.', 'Im Lesesaal darf man nicht essen.', 0], ['Vor dem Garten', 'PRIVATGRUNDSTÜCK\nZUTRITT VERBOTEN.', 'Besucher dürfen den Garten betreten.', 1], ['Im Fitnessstudio', 'GERÄTE NACH DEM TRAINING REINIGEN.', 'Man soll die Geräte sauber hinterlassen.', 0], ['Am Schalter', 'HEUTE GEÖFFNET 10–12 UHR UND 15–17 UHR.', 'Der Schalter ist um 14 Uhr geöffnet.', 1], ['Im Treppenhaus', 'KINDERWAGEN BITTE IM KELLER ABSTELLEN.', 'Kinderwagen sollen im Keller stehen.', 0]],
  { scenario: 'Ihr Freund Samuel Okafor ist 37 Jahre alt und kommt aus Nigeria. Er wohnt in Hannover, Lindenallee 5, und arbeitet als Krankenpfleger. Ab dem 18. November möchte er einen Fotokurs am Mittwoch besuchen. Samuel hat eine eigene Kamera. Seine Telefonnummer ist 0151 907 43 62. Er bezahlt per Überweisung.', title: 'FOTOSCHULE LICHTBLICK · Kursanmeldung', example: 'Familienname, Vorname: Okafor, Samuel', template: 'Herkunftsland: Nigeria\nAlter: {{1}}\nStraße, Hausnummer: Lindenallee 5\nWohnort: {{2}}\nTelefon: 0151 907 43 62\nBeruf: {{3}}\nKursbeginn: {{4}}\nEigene Kamera: {{5}}\nZahlungsweise: Überweisung', blanks: [{ answers: ['37', '37 Jahre'], maxWords: 2 }, { answers: ['Hannover'] }, { answers: ['Krankenpfleger'] }, { answers: ['18. November', '18 November'], maxWords: 2 }, { answers: ['ja', 'vorhanden', 'eigene Kamera'], maxWords: 2 }] },
  { label: 'Nachricht an Ihre Nachbarin', stimulus: 'Sie fahren drei Tage weg. Ihre Nachbarin Frau Aydin soll in dieser Zeit Ihre Pflanzen gießen.', bullets: ['Sagen Sie, wann Sie weg sind.', 'Erklären Sie, wo der Schlüssel liegt.', 'Bedanken Sie sich für die Hilfe.'] },
  ['ARBEIT\nArbeitszeit · Kollegin · Pause · Termin · Büro · Urlaub', 'ESSEN\nFrühstück · Rezept · Markt · Getränk · Restaurant · Rechnung'],
  [['Locher', 'Notizbuch', 'Tasse', 'Ladekabel', 'Kalender', 'Stift'], ['Brotkorb', 'Salz', 'Serviette', 'Flasche', 'Löffel', 'Speisekarte']],
);

export const GOETHE_A1_SETS_3_TO_10: Record<number, GoetheA1SetContent> = {
  3: SET3, 4: SET4, 5: SET5, 6: SET6, 7: SET7, 8: SET8, 9: SET9, 10: SET10,
};

export function getGoetheA1SetContent(number: number) {
  const value = GOETHE_A1_SETS_3_TO_10[number];
