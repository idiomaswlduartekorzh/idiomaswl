...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't10-l-cr1', part: 5, audioUrl: '/audio/toefl/set-10/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["No, I don't usually enjoy swimming after class.","The soup is ready to serve in the dining room.","She is scheduled to arrive around noon today.","It's just beyond the cafeteria, on your right."], answer: 3 },
        { type: 'mcq', id: 't10-l-cr2', part: 5, audioUrl: '/audio/toefl/set-10/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["It weighs approximately five kilograms without the cover.","Sure, I'd be happy to review it for you.","The bus arrived late at the station this morning.","Yes, she works as a doctor at the hospital."], answer: 1 },
        { type: 'mcq', id: 't10-l-cr3', part: 5, audioUrl: '/audio/toefl/set-10/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["It costs ten dollars at the campus bookstore.","Try the third-floor office; they handle that.","The tea is still too hot to drink.","He plays football for the university team."], answer: 1 },
        { type: 'mcq', id: 't10-l-cr4', part: 5, audioUrl: '/audio/toefl/set-10/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["The film lasted much longer than I expected.","No, I have never visited that location before.","It is made from several pieces of wood.","Don't worry; we can reschedule for next week."], answer: 3 },
        { type: 'mcq', id: 't10-l-cr5', part: 5, audioUrl: '/audio/toefl/set-10/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["The shop is closed for the entire afternoon.","She teaches biology at the local university.","It is quite far from the main campus.","Yes, I got the job; I start next month!"], answer: 3 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't10-l-cv1', part: 6, text: 'Why has the student come to see the advisor?', options: ["To discuss leaving the university before graduating","To discuss changing from biology to environmental science","To report a problem involving one of the professors","To request financial support through a new scholarship"], answer: 1 },
        { type: 'mcq', id: 't10-l-cv2', part: 6, text: 'What is drawing the student toward environmental science?', options: ["A close friend recommended the environmental science program","The new major appears much easier than biology","A wish to address climate and conservation problems","The program requires fewer courses before graduation"], answer: 2 },
        { type: 'mcq', id: 't10-l-cv3', part: 6, text: 'What reassuring point does the advisor make?', options: ["Environmental science courses do not require final examinations","The student could return to biology at any time","Changing majors would allow the student to graduate early","Completed biology courses would count toward the new degree"], answer: 3 },
        { type: 'mcq', id: 't10-l-cv4', part: 6, text: 'What does the advisor recommend the student do first?', options: ["Take one environmental science elective before changing majors","Discuss the possible change with family members first","Transfer to a university with another science program","Change majors immediately before taking another biology course"], answer: 0 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't10-l-an1', part: 7, text: 'What is the announcement mainly about?', options: ["The opening of a new computer lab inside the library","An internet system upgrade throughout the residence hall","New room assignments for students living in residence","A scheduled electrical outage affecting the entire campus"], answer: 1 },
        { type: 'mcq', id: 't10-l-an2', part: 7, text: 'When may the internet be unavailable?', options: ["On Sunday afternoon between noon and four","On Saturday between eight and noon","Throughout the entire weekend from Friday onward","During the evening hours on every weekday"], answer: 1 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't10-l-at1', part: 8, text: 'How does the professor define opportunity cost?', options: ["The value of the best alternative given up","The total expense required to operate a business","A government tax placed on all economic activity","The amount of money paid for a purchase"], answer: 0 },
        { type: 'mcq', id: 't10-l-at2', part: 8, text: 'What is the "key insight" the professor emphasizes?', options: ["Only choices involving expensive products have real costs.","Every choice costs something, even without spending money.","Anything offered without payment has no associated cost.","Opportunity costs apply exclusively to decisions by businesses."], answer: 1 },
        { type: 'mcq', id: 't10-l-at3', part: 8, text: 'What is the opportunity cost for the shop owner who uses her own building?', options: ["The original price paid to purchase the building","The maintenance expenses required to repair the building","The rental income forgone by using the building","The wages paid to employees working in the shop"], answer: 2 },
        { type: 'mcq', id: 't10-l-at4', part: 8, text: 'Why does the professor say "free" is rarely truly free?', options: ["Free events usually provide participants with lower quality.","Businesses normally add hidden fees to free services.","Every available activity eventually requires a cash payment.","Free activities still consume time or other resources."], answer: 3 },
