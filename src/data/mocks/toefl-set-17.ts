...
const mock: MockExam = {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't17-l-cr1', part: 5, audioUrl: '/audio/toefl/set-17/listen-choose-1.mp3', text: 'Choose the best response to what you heard.', options: ["It's on the ground floor, near the exit.","No, I don't usually enjoy dancing there.","The rice is ready in the dining room.","She left early this afternoon by bus."], answer: 0 },
        { type: 'mcq', id: 't17-l-cr2', part: 5, audioUrl: '/audio/toefl/set-17/listen-choose-2.mp3', text: 'Choose the best response to what you heard.', options: ["Yes, he works as a chef downtown.","It measures nine meters from the ground.","Sure, I'll meet you at the library at four.","The gate is locked for the entire evening."], answer: 2 },
        { type: 'mcq', id: 't17-l-cr3', part: 5, audioUrl: '/audio/toefl/set-17/listen-choose-3.mp3', text: 'Choose the best response to what you heard.', options: ["He arrives on Tuesday morning by train.","It costs five dollars at the campus store.","You can find the form on the noticeboard.","The tea is cold after sitting outside."], answer: 2 },
        { type: 'mcq', id: 't17-l-cr4', part: 5, audioUrl: '/audio/toefl/set-17/listen-choose-4.mp3', text: 'Choose the best response to what you heard.', options: ["No problem — I'll email the slides to everyone.","The bus was crowded during the morning commute.","No, I have not visited that place before.","It is made entirely from polished wood."], answer: 0 },
        { type: 'mcq', id: 't17-l-cr5', part: 5, audioUrl: '/audio/toefl/set-17/listen-choose-5.mp3', text: 'Choose the best response to what you heard.', options: ["Yes, my sister had a baby girl!","The store is quite far from the station.","She teaches geography at the secondary school.","It is fairly cheap during the summer sale."], answer: 0 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't17-l-cv1', part: 6, text: 'What is the man encouraging the woman to do?', options: ["Apply to move into another student residence","Register for an additional academic course","Join a volunteer program tutoring local students","Become a member of an intramural sports team"], answer: 2 },
        { type: 'mcq', id: 't17-l-cv2', part: 6, text: 'Why is the woman hesitant at first?', options: ["She does not enjoy explaining academic material","She expects to move away before the program starts","She cannot find any free time in her schedule","She doubts that she has sufficient qualifications"], answer: 3 },
        { type: 'mcq', id: 't17-l-cv3', part: 6, text: 'How much time does the program require?', options: ["Two scheduled hours during each week","One complete weekend during every month","Several evening sessions throughout the week","Ten hours of tutoring during each week"], answer: 0 },
        { type: 'mcq', id: 't17-l-cv4', part: 6, text: 'According to the man, how does tutoring help the tutor?', options: ["The program provides tutors with generous financial compensation","Explaining concepts strengthens the tutor's own understanding","The sessions require almost no preparation or mental effort","Tutoring completely replaces the need for independent study"], answer: 1 },
      ],
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't17-l-an1', part: 7, text: 'What is the announcement about?', options: ["A temporary adjustment to university housing rent","A scheduled interruption of electrical power","A temporary water shut-off for pipe maintenance","A mandatory fire drill for housing residents"], answer: 2 },
        { type: 'mcq', id: 't17-l-an2', part: 7, text: 'What does the announcement recommend students do?', options: ["Contact a plumber before the maintenance work begins","Move permanently into an unaffected residence building","Remain away from university housing for the entire day","Fill bottles beforehand and plan showers around the shut-off"], answer: 3 },
    ...
    },
    {
      ...
      questions: [
        { type: 'mcq', id: 't17-l-at1', part: 8, text: 'What is the main topic of the lecture?', options: ["How neighboring trees compete to obtain adequate sunlight","How trees connect and cooperate through underground fungal networks","How forestry specialists plant and maintain a young forest","Why forest ecosystems are disappearing across different regions"], answer: 1 },
        { type: 'mcq', id: 't17-l-at2', part: 8, text: 'What is a "mycorrhiza"?', options: ["A seed adapted to grow beneath forest soil","A rare species of tree found in old forests","A partnership between tree roots and soil fungi","A disease that damages the roots of trees"], answer: 2 },
        { type: 'mcq', id: 't17-l-at3', part: 8, text: 'What have experiments with radioactive tracers shown?', options: ["Fungal networks consistently damage the trees they connect","Trees can relocate gradually from one forest area to another","Neighboring trees remain isolated and exchange no resources","Trees can transfer carbon and nutrients through fungal networks"], answer: 3 },
        { type: 'mcq', id: 't17-l-at4', part: 8, text: 'What note of caution does the professor add?', options: ["Descriptions of cooperative sharing may overstate evidence because fungi may benefit themselves","Trees never transfer any resources to neighboring plants through underground networks","Later research has completely disproved the existence of all fungal connections","The underground networks described by researchers are imaginary rather than real"], answer: 0 },
