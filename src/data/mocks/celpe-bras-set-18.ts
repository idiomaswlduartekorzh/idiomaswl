      ...
      questions: [
        {
          ...
          stimulus: '[Vídeo — reportagem, ~3 min] Uma reportagem mostra iniciativas de combate ao desperdício de alimentos. A repórter visita um restaurante que aproveita integralmente frutas e verduras, um mercado que doa alimentos próximos do vencimento a instituições, e um aplicativo que conecta estabelecimentos a consumidores para vender comida que sobraria por preços baixos. Uma especialista lembra que o Brasil desperdiça toneladas de comida enquanto milhões passam fome.',
          text: 'Com base no vídeo, escreva um texto para o boletim de uma cooperativa ou associação incentivando práticas de combate ao desperdício de alimentos. Explique o problema, apresente soluções mostradas no vídeo e mobilize as pessoas a agir. (Mínimo: 200 palavras)',
          minWords: 200,
        },
      ],
    },
