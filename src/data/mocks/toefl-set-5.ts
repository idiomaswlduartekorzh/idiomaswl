      ...
      questions: [
        {
          ...
          options: ["Because the library had already closed for the evening.","Sure, the meeting will be held in room 204.","No, I have never traveled anywhere in Canada.","It usually rains throughout most of April here."],
          answer: 1,
        },
        {
          ...
          text: 'Choose the best response to what you heard.',
          options: ["She lives near the station on the east side.","The printer has completely run out of paper.","It cost approximately twenty dollars at the store.","Yes, I'd love to—what time will it start?"],
          answer: 3,
        },
        {
          ...
          text: 'Choose the best response to what you heard.',
          options: ["No, thank you; I have already eaten lunch.","The next bus leaves the station at nine.","She's studying biology at the university this year.","It's on the second shelf beside the dictionaries."],
          answer: 3,
        },
        {
          ...
          text: 'Choose the best response to what you heard.',
          options: ["It was made from wood by a local craftsperson.","That's a good idea; let's ask the professor first.","I was born in July during the summer holidays.","The store normally closes at eight in the evening."],
          answer: 1,
        },
        {
          ...
          text: 'Choose the best response to what you heard.',
          options: ["The museum offers free admission every Sunday morning.","Yes, my flight was delayed for two hours.","The recipe still needs a little more salt.","He plays the guitar very well in that band."],
          answer: 1,
        },
      ],
    },
      ...
      questions: [
        {
          ...
          options: ["She cannot afford the additional cost of the trip.","She has another important examination scheduled for that day.","She is no longer interested in studying marine biology.","The trip conflicts with the hours of her part-time job."],
          answer: 3,
        },
        {
          type: 'mcq', id: 't5-l-cv2', part: 6,
          text: 'What does the male student say makes the trip especially worthwhile?',
          options: ["It contributes directly to the student's final project grade.","It is a formal requirement for completing the degree program.","It provides extra credit only to students with perfect attendance.","It includes a free lunch for every student who participates."],
          answer: 0,
        },
        {
          type: 'mcq', id: 't5-l-cv3', part: 6,
          text: 'What must students do if they cannot attend the trip?',
          options: ["Repeat the entire course during the following academic term","Complete an additional research paper instead of attending","Participate in a replacement field trip later in the term","Forfeit all of the available points for the final project"],
          answer: 1,
        },
        {
          type: 'mcq', id: 't5-l-cv4', part: 6,
          text: 'By when must students reserve a seat on the bus?',
          options: ["There is no deadline for choosing the alternative assignment.","Submit the decision to the professor by Thursday afternoon.","Submit the decision by Saturday morning after the trip.","Wait until the end of the month to make a decision."],
          answer: 1,
        },
      ],
    },
      ...
      questions: [
        {
          ...
          options: ["To promote a new permanent shuttle service for students","To remind students that their parking permits require renewal","To announce an additional fee for parking on the campus","To report that Lot C will close temporarily for resurfacing"],
          answer: 3,
        },
        {
          type: 'mcq', id: 't5-l-an2', part: 7,
          text: 'Where should students who normally use Lot C park during the closure?',
          options: ["In Lot F beside the university athletic center","On the street immediately outside the main campus entrance","Inside the parking garage beneath the engineering building","In Lot A near the administration building"],
          answer: 0,
        },
        {
      ...
      questions: [
        {
          ...
          options: ["Because the component is extremely difficult for observers to see","Because both the component and structure are made from stone","Because removing it causes the entire system to collapse","Because it is physically the largest element in the structure"],
          answer: 2,
        },
        {
          type: 'mcq', id: 't5-l-at2', part: 8,
          text: 'What happened when Robert Paine removed the starfish from the tide pools?',
          options: ["The number of different species in the tide pool increased.","No important change in the tide pool could be observed.","All of the mussels in the tide pool suddenly disappeared.","The mussels displaced other species and reduced overall diversity."],
          answer: 3,
        },
        {
          ...
          options: ["Species with unusually large effects should receive priority in protection.","Starfish should be removed so that mussel populations can expand.","Tide-pool habitats cannot be protected through conservation programs.","Every species in an ecosystem always has exactly equal importance."],
          answer: 0,
        },
        {
          type: 'mcq', id: 't5-l-at4', part: 8,
          text: 'In the sea otter example, what happens to kelp forests if otters are removed?',
          options: ["Kelp forests grow more quickly than they did before.","Kelp disappears as growing sea-urchin populations consume it.","Kelp forests remain unaffected by the ecological change.","Kelp forests are gradually replaced by dense mussel beds."],
          answer: 1,
        },
        {
