...
const PART_SIX: IcfesPartLessonConfig = {
  part: 6, visual: 'inference-reading', skill: 'inferential_reading',
  formatTitle: 'Texto más complejo · interpretación', formatBody: 'Respondes preguntas sobre propósito, tono, idea global e información que se deduce al combinar pistas.',
  evaluatesTitle: 'Lectura inferencial y crítica', evaluatesBody: 'Distingues lo dicho de lo sugerido y eliges la conclusión más precisa que el texto permite.',
  strategyTitle: 'Pregunta → pistas → límite', strategyBody: 'Reúne evidencia, formula una inferencia moderada y rechaza opciones absolutas o más amplias que el texto.',
  anatomy: {id:'inference-anatomy',stimulus:'Lena checked the dark clouds, put the picnic basket back in the car, and suggested visiting the museum instead.',stimulusLabel:'Lectura',prompt:'What can be inferred about Lena?',options:['She expected bad weather.','She disliked the museum.','She forgot the food.'],answerIndex:0,decisiveClue:'dark clouds · basket back · instead',reasoning:'Las acciones juntas muestran que anticipó lluvia y cambió el plan.',distractor:'El texto no dice que deteste el museo ni que haya olvidado la comida.'},
  lookFor:'Verbo de la pregunta —infer, purpose, attitude, mainly— y dos o más pistas compatibles.', answerWith:'La conclusión más limitada que explica la evidencia sin inventar motivaciones.', avoid:'Elegir palabras extremas como always, completely o only cuando el texto es moderado.',
  methodSteps:[{title:'Clasifica la pregunta',body:'Decide si pide inferencia, propósito, tono o idea principal.'},{title:'Reúne dos pistas',body:'Una sola palabra puede engañar; busca un patrón entre acciones o evaluaciones.'},{title:'Formula una conclusión mínima',body:'Di solo lo que debe ser razonablemente cierto.'},{title:'Controla el alcance',body:'Descarta absolutos, causas inventadas y opciones parcialmente verdaderas.'}],
  clueTools:[{label:'Acciones',examples:'checked · returned · suggested',body:'Permiten inferir decisiones.'},{label:'Modalidad',examples:'may · seems · likely',body:'Controla certeza.'},{label:'Evaluación',examples:'unfortunately · valuable',body:'Revela tono.'},{label:'Estructura',examples:'however · overall · instead',body:'Marca propósito y giro.'}],
  families:[{icon:'↗',title:'Inferencia',examples:'evidence → conclusion'},{icon:'◎',title:'Propósito',examples:'inform · persuade · warn'},{icon:'≈',title:'Tono',examples:'positive · critical · cautious'},{icon:'¶',title:'Idea global',examples:'main claim · summary'},{icon:'!',title:'Actitud',examples:'approval · concern'},{icon:'≤',title:'Alcance',examples:'moderate · supported'}],
  groups:[
    {id:'inference',label:'Inferencia',subtitle:'Combina acciones y contexto sin inventar.',icon:'↗',examples:examples('Lectura',[['p6-i1','Lena checked the dark clouds, put the picnic basket back in the car, and suggested visiting the museum instead.','What can be inferred?',['She expected bad weather.','She hated museums.','She forgot the food.'],0,'dark clouds · instead','El cambio de plan sugiere lluvia.','Las otras motivaciones no están respaldadas.'],['p6-i2','When Omar arrived, the lights were off and the door was locked. He checked the invitation again.','What probably happened?',['He may have the wrong time or place.','The party had finished successfully.','He decided not to enter.'],0,'off · locked · checked invitation','La escena contradice lo esperado y lo lleva a verificar datos.','No sabemos que la fiesta terminó ni que desistió.'],['p6-i3','Priya read the menu twice before asking whether any dishes contained nuts.','What can be inferred?',['She is concerned about nuts.','She cannot read the menu.','She wants the cheapest dish.'],0,'asked · contained nuts','La pregunta específica revela una preocupación alimentaria.','Leer dos veces no prueba incapacidad.'],['p6-i4','The coach smiled when Eva completed the final lap and wrote her time in his notebook.','What is most likely true?',['He was monitoring her progress.','He wanted to end practice.','He was angry with Eva.'],0,'wrote her time','Registrar el tiempo indica seguimiento.','Smile contradice anger.'],['p6-i5','The café added more outdoor tables after customers repeatedly asked to sit in the garden.','Why were tables probably added?',['To respond to customer demand.','To reduce the menu.','To close the garden.'],0,'customers repeatedly asked','La decisión responde a solicitudes repetidas.','Cerrar el jardín contradice añadir mesas.']])},
    {id:'purpose-tone',label:'Propósito y tono',subtitle:'Reconoce para qué se escribe y cómo se posiciona la voz.',icon:'◎',examples:examples('Lectura',[['p6-t1','Please remember that the west entrance will be closed during repairs. Use the main gate until Friday.','What is the purpose?',['To give temporary access instructions.','To advertise repairs.','To complain about visitors.'],0,'closed · use main gate','Informa un cambio y dirige a los usuarios.','No vende ni se queja.'],['p6-t2','Although the new bike lane removed parking spaces, it has made the route much safer for children.','What is the writer’s attitude?',['Generally supportive.','Completely negative.','Uninterested.'],0,'although · much safer','Reconoce un costo pero valora el beneficio.','Completely negative ignora la evaluación positiva.'],['p6-t3','You might want to carry water; there is little shade on the final section of the trail.','What is the purpose?',['To offer cautious advice.','To prohibit hiking.','To describe a storm.'],0,'might want · little shade','Sugiere una precaución basada en una condición.','No prohíbe la actividad.'],['p6-t4','The exhibition brings together ordinary objects that reveal extraordinary stories about migration.','What is the tone?',['Appreciative','Hostile','Uncertain'],0,'extraordinary stories','El vocabulario valora la exposición.','No hay crítica ni duda.'],['p6-t5','If we continue wasting water at this rate, future restrictions will be unavoidable.','What is the purpose?',['To warn about consequences.','To celebrate consumption.','To explain a past event.'],0,'future · unavoidable','Advierte sobre un resultado futuro.','Celebrate contradice wasting.']])},
    {id:'main-idea',label:'Idea global',subtitle:'Resume el patrón completo, no un detalle llamativo.',icon:'¶',examples:examples('Lectura',[['p6-m1','Community gardens provide fresh food, create meeting spaces, and teach children where food comes from.','What is the main idea?',['Community gardens offer several social benefits.','Children dislike vegetables.','Gardens are difficult to build.'],0,'food · meeting · teach','La opción integra los tres beneficios.','Las otras ideas no aparecen.'],['p6-m2','Remote work saves commuting time, but some employees miss informal conversations with colleagues.','What is the text mainly about?',['A benefit and a drawback of remote work.','How to find a new office.','Why commuting is always easy.'],0,'saves · but · miss','Resume el contraste central.','Always easy contradice el texto.'],['p6-m3','The library now lends tools as well as books, helping residents complete small home repairs.','What is the main point?',['The library expanded its service.','Books are no longer available.','Residents must buy tools.'],0,'now lends tools as well as books','Describe una ampliación de servicio.','As well as confirma que los libros continúan.'],['p6-m4','Scientists track city temperatures because trees, pavement, and building density can make nearby neighborhoods feel very different.','What is the main idea?',['Urban design affects local temperature.','All neighborhoods have equal weather.','Trees increase pavement.'],0,'trees · pavement · density · temperatures','Conecta características urbanas con temperatura.','Equal contradice very different.'],['p6-m5','Small changes—repairing clothes, sharing equipment, and avoiding single-use items—can reduce household waste.','What does the text mainly suggest?',['Everyday choices can reduce waste.','Only recycling matters.','Households should buy more items.'],0,'small changes · reduce waste','La lista apoya una recomendación cotidiana general.','Only excede y contradice los ejemplos.']])},
  ],
};

const PART_SEVEN: IcfesPartLessonConfig = {
  part: 7, visual: 'lexical-cloze', skill: 'lexical_grammar_cloze',
  formatTitle: 'Texto con espacios · significado y estructura', formatBody: 'Completas un texto eligiendo la palabra que encaja por sentido, colocación, forma gramatical y cohesión.',
  evaluatesTitle: 'Léxico y gramática integrados', evaluatesBody: 'Combinas vocabulario contextual con patrones de palabras y relaciones entre oraciones.',
  strategyTitle: 'Predicción → colocación → cohesión', strategyBody: 'Predice una idea, identifica la forma necesaria, prueba las combinaciones cercanas y relee el párrafo.',
  anatomy:{id:'lexical-anatomy',stimulus:'The project was difficult; ___, the team completed it on time.',stimulusLabel:'Texto',prompt:'Choose the best word for the blank.',options:['however','because','for example'],answerIndex:0,decisiveClue:'difficult · completed',reasoning:'Las ideas contrastan; however expresa ese giro.',distractor:'Because introduciría causa y dejaría la relación incompleta.'},
  lookFor:'Significado esperado, palabras vecinas, categoría gramatical y relación con la oración anterior.',answerWith:'La palabra que encaja en los cuatro niveles, no solo una traducción posible.',avoid:'Evaluar el espacio aislado o ignorar colocaciones fijas y conectores del discurso.',
  methodSteps:[{title:'Predice la idea',body:'Antes de ver opciones, imagina el significado que falta.'},{title:'Define la forma',body:'Decide si necesitas verbo, nombre, adjetivo, adverbio o conector.'},{title:'Prueba la colocación',body:'Lee la palabra con sus vecinas inmediatas.'},{title:'Valida cohesión',body:'Relee el párrafo para confirmar tiempo, referencia y relación lógica.'}],
  clueTools:[{label:'Vecinos',examples:'make a decision · interested in',body:'Revelan colocaciones.'},{label:'Forma',examples:'success · successful · successfully',body:'Define función gramatical.'},{label:'Sentido',examples:'borrow · lend · spend',body:'Distingue roles.'},{label:'Discurso',examples:'however · therefore · moreover',body:'Conecta oraciones.'}],
  families:[{icon:'Aa',title:'Significado',examples:'precise word choice'},{icon:'⛓',title:'Colocaciones',examples:'verb + noun'},{icon:'△',title:'Forma',examples:'noun · adjective · adverb'},{icon:'∴',title:'Conectores',examples:'cause · contrast'},{icon:'⌁',title:'Tiempo verbal',examples:'sequence · aspect'},{icon:'↔',title:'Cohesión',examples:'reference · repetition'}],
  groups:[
    {id:'meaning',label:'Significado contextual',subtitle:'Distingue palabras cercanas por roles y contexto.',icon:'Aa',examples:examples('Texto',[['p7-s1','Can I ___ your pen for a minute?','Choose the best word.',['borrow','lend','owe'],0,'I · your pen','Borrow significa recibir temporalmente.','Lend sería la acción del dueño.'],['p7-s2','We had to ___ the meeting because the manager was ill.','Choose the best word.',['cancel','solve','arrive'],0,'meeting · manager ill','Cancel encaja con suspender el evento.','Solve no se usa con meeting.'],['p7-s3','The map helped us ___ our way back.','Choose the best word.',['find','look','watch'],0,'our way back','La colocación es find our way.','Look necesita otra estructura.'],['p7-s4','Please ___ attention to the safety instructions.','Choose the best word.',['pay','give','spend'],0,'attention','La colocación fija es pay attention.','Spend se usa con tiempo o dinero.'],['p7-s5','The medicine had no ___ on the pain.','Choose the best word.',['effect','affect','result'],0,'no · on','Have an effect on es el patrón correcto.','Affect suele ser verbo.']])},
    {id:'collocation-form',label:'Colocación y forma',subtitle:'Comprueba combinación y función gramatical.',icon:'⛓',examples:examples('Texto',[['p7-c1','The team made an important ___.','Choose the best word.',['decision','decide','decisive'],0,'made an · noun','Made a decision exige sustantivo.','Decide es verbo.'],['p7-c2','She explained the process very ___.','Choose the best word.',['clear','clearly','clarity'],1,'explained · very','Un adverbio modifica explained.','Clear es adjetivo.'],['p7-c3','The event was a great ___.','Choose the best word.',['success','successful','successfully'],0,'a great · noun','El artículo y adjetivo exigen sustantivo.','Successful sería adjetivo.'],['p7-c4','He is responsible ___ checking the equipment.','Choose the best word.',['for','of','to'],0,'responsible','La colocación es responsible for.','Of no completa el patrón.'],['p7-c5','They are looking forward to ___ you.','Choose the best word.',['see','seeing','saw'],1,'to · gerund in expression','Look forward to exige gerundio.','To aquí es preposición, no infinitivo.']])},
    {id:'discourse',label:'Cohesión del texto',subtitle:'Conecta causa, contraste, adición y resultado.',icon:'∴',examples:examples('Texto',[['p7-d1','The project was difficult; ___, the team completed it on time.','Choose the best word.',['however','because','therefore'],0,'difficult · completed','However marca contraste.','Therefore indicaría resultado causal.'],['p7-d2','The road was flooded; ___, the school closed.','Choose the best word.',['therefore','although','meanwhile'],0,'cause · result','Therefore introduce consecuencia.','Although requiere otra estructura.'],['p7-d3','The course is practical. ___, it is free.','Choose the best word.',['Moreover','Instead','Otherwise'],0,'additional benefit','Moreover añade una ventaja.','Instead sustituiría una idea.'],['p7-d4','___ the rain, the match continued.','Choose the best word.',['Despite','Because','During'],0,'rain · continued','Despite + noun expresa contraste.','Because convertiría rain en causa de continuar.'],['p7-d5','Take a jacket ___ it gets cold later.','Choose the best word.',['in case','even though','as a result'],0,'possible future cold','In case introduce precaución.','Even though afirmaría el frío como hecho.']])},
  ],
};
