...
export const PART_ONE_EXAMPLE_GROUPS: PartOneExampleGroup[] = [
  {
    ...
    examples: [
      ...
      {
        id: 'places-bank',
        definition: 'People keep their money here and can take out cash.',
        wordBank: ['bank', 'bookstore', 'hospital', 'hotel', 'market', 'museum', 'post office', 'supermarket'],
        answer: 'bank',
        decisiveClue: 'money · take out cash',
        reasoning: 'Money identifica el campo financiero y take out cash confirma bank.',
        distractor: 'Market y supermarket reciben dinero, pero las personas no guardan allí sus ahorros ni retiran efectivo.',
      },
      {
        id: 'places-bakery',
        definition: 'You can buy fresh bread and cakes in this place.',
        wordBank: ['bakery', 'butcher shop', 'café', 'factory', 'farm', 'library', 'restaurant', 'warehouse'],
        answer: 'bakery',
        decisiveClue: 'fresh bread · cakes',
        reasoning: 'La combinación de bread y cakes define el tipo de tienda: bakery.',
        distractor: 'Café y restaurant pueden servir pan o torta, pero la definición se concentra en el lugar donde se compran como productos principales.',
      },
    ],
  },
  {
    ...
    examples: [
      ...
      {
        id: 'people-vet',
        definition: 'This person gives medical care to sick animals.',
        wordBank: ['dentist', 'farmer', 'nurse', 'pharmacist', 'scientist', 'surgeon', 'teacher', 'vet'],
        answer: 'vet',
        decisiveClue: 'medical care · animals',
        reasoning: 'Medical care abre el campo de salud; animals vuelve la profesión específica: vet.',
        distractor: 'Farmer trabaja con animales, pero su función no es brindarles atención médica.',
      },
      {
        id: 'people-cashier',
        definition: 'This person receives your payment in a store.',
        wordBank: ['cashier', 'customer', 'manager', 'mechanic', 'owner', 'salesperson', 'security guard', 'supplier'],
        answer: 'cashier',
        decisiveClue: 'receives your payment',
        reasoning: 'La acción de recibir y registrar pagos en una tienda corresponde al cashier.',
        distractor: 'Salesperson ayuda a elegir o comprar productos, pero no se define necesariamente por recibir el pago.',
      },
    ],
  },
  {
    ...
    examples: [
      ...
      {
        id: 'objects-umbrella',
        definition: 'You hold this over your head when it rains.',
        wordBank: ['cap', 'coat', 'gloves', 'hood', 'raincoat', 'scarf', 'umbrella', 'wallet'],
        answer: 'umbrella',
        decisiveClue: 'hold · over your head · rains',
        reasoning: 'Hold elimina prendas y over your head when it rains identifica umbrella.',
        distractor: 'Raincoat también protege de la lluvia, pero se lleva puesto; no se sostiene sobre la cabeza.',
      },
      {
        id: 'objects-key',
        definition: 'You put this into a lock to open a door.',
        wordBank: ['bell', 'button', 'handle', 'key', 'knob', 'lock', 'switch', 'tool'],
        answer: 'key',
        decisiveClue: 'into a lock · open a door',
        reasoning: 'La relación objeto–acción es directa: una key entra en la cerradura para abrir.',
        distractor: 'Handle y knob ayudan a mover la puerta, pero no se introducen into a lock.',
      },
    ],
  },
  {
    ...
    examples: [
      ...
      {
        id: 'states-nervous',
        definition: 'People may feel like this before an important exam.',
        wordBank: ['bored', 'calm', 'confident', 'excited', 'nervous', 'proud', 'relaxed', 'surprised'],
        answer: 'nervous',
        decisiveClue: 'before an important exam',
        reasoning: 'La anticipación de una situación evaluativa importante suele producir nervous.',
        distractor: 'Excited también puede aparecer antes de un evento, pero no captura la preocupación implícita en la situación de examen.',
      },
      {
        id: 'states-bored',
        definition: 'You feel like this when nothing is interesting and you have nothing to do.',
        wordBank: ['alone', 'bored', 'busy', 'confused', 'lazy', 'quiet', 'tired', 'worried'],
        answer: 'bored',
        decisiveClue: 'nothing is interesting · nothing to do',
        reasoning: 'La falta simultánea de interés y actividad define bored.',
        distractor: 'Lazy describe poca disposición para actuar; bored describe falta de interés o estimulación.',
      },
    ],
  },
];
