...
export const ICFES_TEACHER_OPS_VERSION = 'icfes-teacher-ops-2026-09-12-v3' as const;
export const ICFES_TEACHER_ADDENDUM_VERSION = 'icfes-teacher-addendum-2026-09-12-v3' as const;
...
export const ICFES_TEACHER_ADDENDUM = Object.freeze({
  ...
  text:
    'Para ICFES, el plan incluye un solo crédito de feedback pedagógico personalizado de WeLearn con asistencia de IA durante cada periodo de 30 días. El objetivo operativo interno es entregarlo dentro de 12 horas desde una solicitud completa, sujeto a capacidad disponible y sin constituir una garantía. WeLearn aplica control de calidad antes de la entrega.',
} as const);
