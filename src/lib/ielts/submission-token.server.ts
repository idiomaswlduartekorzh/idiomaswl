...
export const IELTS_SUBMISSION_ID_PATTERN = /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
...
export function createIeltsSubmissionToken(submissionId: string): string {
...
export function verifyIeltsSubmissionToken(submissionId: string, token: unknown): boolean {
