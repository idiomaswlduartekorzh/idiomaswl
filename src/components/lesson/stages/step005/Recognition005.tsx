...
const r6:  Item = { id:'r6',  kr:'생활',                     es:'vida cotidiana / rutina',                  audio:'생활',                     step:'005', img: KR_IMG_005.campus_routine };
const r7:  Item = { id:'r7',  kr:'공부해요',                 es:'estudio / estudia',                        audio:'공부해요',                 step:'005', img: KR_IMG_005.david_studying };
const r8:  Item = { id:'r8',  kr:'일해요',                   es:'trabajo / trabaja',                        audio:'일해요',                   step:'005', img: KR_IMG_005.david_cafe };
const r9:  Item = { id:'r9',  kr:'좋아해요',                 es:'me gusta / le gusta',                      audio:'좋아해요',                 step:'005', img: null };
const r10: Item = { id:'r10', kr:'뭐해요?',                  es:'¿qué haces?',                              audio:'뭐해요?',                  step:'005', img: KR_IMG_005.minsu_david_chat };
const r11: Item = { id:'r11', kr:'매일',                     es:'todos los días',                           audio:'매일',                     step:'005', img: null };
const r12: Item = { id:'r12', kr:'에서',                     es:'en (lugar donde ocurre la acción)',         audio:'에서',                     step:'005', img: KR_IMG_005.eseo_vs_e };
const r13: Item = { id:'r13', kr:'에',                       es:'a / hacia (destino)',                      audio:'에',                       step:'005', img: KR_IMG_005.eseo_vs_e };
const r14: Item = { id:'r14', kr:'친구들',                   es:'amigos (plural)',                          audio:'친구들',                   step:'005', img: KR_IMG_005.minsu_david_chat };
const r15: Item = { id:'r15', kr:'이 대학교에서 공부해요',   es:'Estudio en esta universidad',              audio:'이 대학교에서 공부해요',   step:'005', img: KR_IMG_005.david_studying };
const r16: Item = { id:'r16', kr:'카페에서 일해요',           es:'Trabajo en el café',                       audio:'카페에서 일해요',           step:'005', img: KR_IMG_005.david_cafe };
const r17: Item = { id:'r17', kr:'한국 좋아해요',             es:'Me gusta Corea',                           audio:'한국 좋아해요',             step:'005', img: null };
const r18: Item = { id:'r18', kr:'매일 카페에 가요',          es:'Voy al café todos los días',               audio:'매일 카페에 가요',          step:'005', img: null };
const r19: Item = { id:'r19', kr:'친구들이 많아요',           es:'Tengo muchos amigos',                      audio:'친구들이 많아요',           step:'005', img: KR_IMG_005.minsu_david_chat };
const r20: Item = { id:'r20', kr:'씨',                       es:'Sr./Sra. + nombre (tratamiento)',           audio:'씨',                       step:'005', img: null };
