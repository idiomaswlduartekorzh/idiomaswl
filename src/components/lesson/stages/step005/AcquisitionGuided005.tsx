...
const VOCAB: VocabItem[] = [
  { kr: '생활',    rom: 'saeng-hwal',       es: 'vida cotidiana / rutina',  audio: '생활',    img: KR_IMG_005.campus_routine,   note: '한국 생활 = vida en Corea' },
  { kr: '공부해요', rom: 'gong-bu-hae-yo',  es: 'estudio / estudia',         audio: '공부해요', img: KR_IMG_005.david_studying,   note: '공부하다 → 공부해요' },
  { kr: '일해요',  rom: 'il-hae-yo',        es: 'trabajo / trabaja',          audio: '일해요',  img: KR_IMG_005.david_cafe,       note: '일하다 → 일해요' },
  { kr: '좋아해요', rom: 'jo-a-hae-yo',     es: 'me gusta / le gusta',        audio: '좋아해요', img: KR_IMG_005.campus_routine,   note: '좋아하다 → 좋아해요 (verbo)' },
  { kr: '뭐해요?', rom: 'mwo-hae-yo',       es: '¿qué haces?',                audio: '뭐해요?', img: KR_IMG_005.minsu_david_chat, note: '뭐(qué) + 하다(hacer)' },
  { kr: '매일',    rom: 'mae-il',           es: 'todos los días',             audio: '매일',    img: KR_IMG_005.campus_routine,   note: '매일 카페에 가요' },
  { kr: '에서',    rom: 'e-seo',            es: 'en (lugar de acción)',        audio: '에서',    img: KR_IMG_005.eseo_vs_e,        note: '카페에서 일해요' },
  { kr: '에',      rom: 'e',               es: 'a / hacia (destino)',          audio: '에',      img: KR_IMG_005.eseo_vs_e,        note: '카페에 가요' },
  { kr: '친구들',  rom: 'chin-gu-deul',     es: 'amigos (plural)',             audio: '친구들',  img: KR_IMG_005.minsu_david_chat, note: '친구 + 들(plural)' },
  { kr: '씨',      rom: 'ssi',             es: 'Sr./Sra. + nombre',            audio: '씨',      img: KR_IMG_005.minsu_david_chat, note: '민수 씨 = Sr. Minsu' },
];
      ...
      {allSeen && (
        <div style={{ background: 'rgba(108,99,255,0.06)', border: '1px solid rgba(108,99,255,0.2)', borderRadius: 14, padding: '20px', textAlign: 'center' }}>
          ...
          <p style={{ margin: '0 0 16px', fontSize: 13, color: 'var(--muted-foreground)' }}>
            Has visto las {VOCAB.length} tarjetas del step005.
          </p>
          <button
            type="button"
            onClick={() => onComplete?.()}
