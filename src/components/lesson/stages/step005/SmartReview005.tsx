...
/* ─── All questions — acumulativo steps 001-005 ──────────────────────────── */
const ALL_QUESTIONS: Question[] = [
  ...
  // ── Step 005 — vocabulario ────────────────────────────────────────────────
  { id:'q005-1', type:'kr→es', step:'Step 005', prompt:'생활', options:['vida cotidiana / rutina','trabajo','estudio','amigos'], correct:'vida cotidiana / rutina', audio:'생활', explanation:'생활 = la vida como actividad continua en un lugar. 한국 생활 = vida en Corea.' },
  { id:'q005-2', type:'kr→es', step:'Step 005', prompt:'공부해요', options:['trabajo','estudio / estudia','voy','me gusta'], correct:'estudio / estudia', audio:'공부해요', explanation:'공부하다 → 공부해요 (presente polite). El patrón 하다 → 해요 es siempre igual.' },
  { id:'q005-3', type:'kr→es', step:'Step 005', prompt:'일해요', options:['estudio','hay muchos','trabajo / trabaja','voy'], correct:'trabajo / trabaja', audio:'일해요', explanation:'일하다 → 일해요. 일 = trabajo (sustantivo), 일하다 = trabajar (verbo).' },
  { id:'q005-4', type:'kr→es', step:'Step 005', prompt:'좋아해요', options:['está bien','hay','me gusta / le gusta','tengo'], correct:'me gusta / le gusta', audio:'좋아해요', explanation:'좋아하다 = gustar (verbo de acción). Diferente de 좋아요 (adjetivo = está bien).' },
  { id:'q005-5', type:'kr→es', step:'Step 005', prompt:'매일', options:['a veces','todos los días','muy','hoy'], correct:'todos los días', audio:'매일', explanation:'매일 = todos los días. Adverbio de frecuencia muy útil: 매일 카페에 가요.' },
  { id:'q005-6', type:'grammar', step:'Step 005', prompt:'¿Cuándo usas 에서 en lugar de 에?', options:['Cuando vas a un lugar','Cuando una acción ocurre en un lugar','Cuando describes algo','Cuando hay algo en un lugar'], correct:'Cuando una acción ocurre en un lugar', explanation:'에서 = la acción sucede aquí. 에 = te mueves hacia aquí. Mismo lugar, distintas partículas según el verbo.' },
  { id:'q005-7', type:'fill', step:'Step 005', prefix:'카페', suffix:'일해요.', options:['에서','에','는','도'], correct:'에서', es:'Trabajo en el café.', audio:'카페에서 일해요', explanation:'일하다 es una acción que ocurre EN el café → 에서. Si fuera 가요 (ir), sería 에.' },
  { id:'q005-8', type:'fill', step:'Step 005', prefix:'매일 카페', suffix:'가요.', options:['에','에서','가','을'], correct:'에', es:'Voy al café todos los días.', audio:'매일 카페에 가요', explanation:'가요 (ir) es movimiento hacia un destino → 에. Con 일하다/공부하다 usarías 에서.' },
  { id:'q005-9', type:'context', step:'Step 005', prompt:'Quieres decir "Estudio en esta universidad". ¿Cuál es correcto?', options:['이 대학교에 공부해요','이 대학교에서 공부해요','이 대학교가 공부해요','이 대학교를 공부해요'], correct:'이 대학교에서 공부해요', audio:'이 대학교에서 공부해요', explanation:'공부하다 es acción → 에서. "En la universidad" como lugar de la acción, no destino.' },
  { id:'q005-10', type:'context', step:'Step 005', prompt:'¿Cuál expresa correctamente "Me gusta Corea"?', options:['한국 좋아요','한국이 좋아요','한국 좋아해요','한국이에요 좋아요'], correct:'한국 좋아해요', audio:'한국 좋아해요', explanation:'좋아해요 es el verbo "gustar". 좋아요 significa "está bien" o "de acuerdo" — no expresa preferencia.' },
  { id:'q005-11', type:'es→kr', step:'Step 005', prompt:'"¿Qué haces?" en coreano:', options:['어때요?','뭐해요?','있어요?','가요?'], correct:'뭐해요?', audio:'뭐해요?', explanation:'뭐(qué) + 해요(haces) = 뭐해요? La pregunta social más frecuente después de conocer a alguien en Corea.' },
  { id:'q005-12', type:'kr→es', step:'Step 005', prompt:'친구들', options:['un amigo','amigos (plural)','personas','compañeros de clase'], correct:'amigos (plural)', audio:'친구들', explanation:'친구 + 들 = amigos. 들 es el marcador de plural en coreano. También: 사람들 (personas), 학생들 (estudiantes).' },
  { id:'q005-13', type:'grammar', step:'Step 005', prompt:'¿Cuál es la diferencia entre 좋아요 y 좋아해요?', options:['좋아요 es pasado, 좋아해요 es presente','좋아요 es adjetivo (está bien), 좋아해요 es verbo (gustar)','Son sinónimos perfectos','좋아요 es formal, 좋아해요 informal'], correct:'좋아요 es adjetivo (está bien), 좋아해요 es verbo (gustar)', explanation:'좋다 (adjetivo) → 좋아요. 좋아하다 (verbo) → 좋아해요. Para expresar que algo te gusta usa siempre 좋아해요.' },
  { id:'q005-14', type:'pattern', step:'Step 005', template:'___ + 에서 + 공부해요', options:['매일','대학교','가요','좋아해요'], correct:'대학교', es:'Estudio en la universidad', audio:'이 대학교에서 공부해요', explanation:'에서 necesita un lugar como sujeto. 대학교에서 공부해요 = la acción (공부) ocurre en ese lugar (대학교).' },
  { id:'q005-15', type:'context', step:'Step 005', prompt:'Minsu te pregunta 한국 생활 어때요? Respondes que estudias y que te gusta Corea.', options:['대학교에서 공부해요. 한국 좋아해요.','대학교에 공부해요. 한국 좋아요.','대학교에서 공부해요. 한국 좋아요.','대학교에 가요. 한국 좋아해요.'], correct:'대학교에서 공부해요. 한국 좋아해요.', audio:'이 대학교에서 공부해요', explanation:'에서 para la acción de estudiar + 좋아해요 para expresar preferencia. ¡Así responde David!' },
  { id:'q005-16', type:'kr→es', step:'Step 005', prompt:'씨 (partícula)', options:['señor/señora + apellido','señor/señora + nombre propio','muy / bastante','ya / todavía'], correct:'señor/señora + nombre propio', audio:'씨', explanation:'씨 se usa DESPUÉS del nombre propio (no apellido): 민수 씨. Es respetuoso y cercano a la vez. Muy frecuente entre colegas.' },
];
    ...
    return (
      <div style={{ ...base, padding: '28px 20px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 18 }}>
        ...
        <p style={{ margin: 0, fontSize: 13, color: 'var(--muted-foreground)', maxWidth: 320, lineHeight: 1.6 }}>
          Repasaste vocabulario y gramática de Steps 001 → 005 en una sola sesión. La circularidad es clave para la memoria.
        </p>
