...
/* ─── All questions — acumulativo steps 001-006 ──────────────────────────── */
...
const ALL_QUESTIONS: Question[] = [
  ...
  // ── Step 006 — vocabulario ────────────────────────────────────────────────
  { id:'q006-1', type:'kr→es', step:'Step 006', prompt:'새로 왔어요?', options:['¿Cuándo llegaste?','¿Eres nuevo/a aquí?','¿Eres de Corea?','¿Te gusta esto?'], correct:'¿Eres nuevo/a aquí?', audio:'새로 왔어요?', explanation:'새로 = recién/nuevo, 왔어요 = llegaste (pasado de 오다). Pregunta natural para conocidos recién llegados.' },
  { id:'q006-2', type:'kr→es', step:'Step 006', prompt:'반갑습니다', options:['Gracias','Hola (informal)','Hasta pronto','Encantado/a de conocerte'], correct:'Encantado/a de conocerte', audio:'반갑습니다', explanation:'반갑습니다 = encantado/a. Se usa la primera vez que conoces a alguien. Más formal que 안녕하세요.' },
  { id:'q006-3', type:'es→kr', step:'Step 006', prompt:'"¿Cómo es? / ¿Qué tal?" en coreano:', options:['마실래요?','어때요?','왔어요?','있어요?'], correct:'어때요?', audio:'어때요?', explanation:'어때요 = ¿cómo es? / ¿qué tal? Patrón clave: [sustantivo] + 어때요? — funciona con cualquier cosa.' },
  { id:'q006-4', type:'es→kr', step:'Step 006', prompt:'"¿Quieres tomar un café?" en coreano:', options:['커피 어때요?','커피 있어요?','커피 마실래요?','커피 좋아요?'], correct:'커피 마실래요?', audio:'커피 마실래요?', explanation:'-ㄹ래요? propone hacer algo juntos. 마실래요 = ¿quieres beber? De 마시다 (beber) + -ㄹ래요.' },
  { id:'q006-5', type:'kr→es', step:'Step 006', prompt:'좋아요', options:['Hay mucho','Es amable','Está bien / Me gusta','¿Qué tal?'], correct:'Está bien / Me gusta', audio:'좋아요', explanation:'좋아요 = está bien, me gusta. Respuesta positiva universal. De 좋다 (ser bueno).' },
  { id:'q006-6', type:'kr→es', step:'Step 006', prompt:'많아요', options:['Es amable','Hay muchos/as','Está bien','Hay café'], correct:'Hay muchos/as', audio:'많아요', explanation:'많아요 = hay muchos, es mucho. De 많다 (ser numeroso).' },
  { id:'q006-7', type:'kr→es', step:'Step 006', prompt:'도 (partícula)', options:['pero / sino','y (entre nombres)','también / encima','solo / únicamente'], correct:'también / encima', audio:'커피도 있어요', explanation:'도 = también. Se adjunta al sustantivo: 커피도 있어요 (también hay café). ¡Muy frecuente!' },

  // ── Step 006 — gramática y patrones ──────────────────────────────────────
  { id:'q006-g1', type:'pattern', step:'Step 006', template:'___ 어때요?', options:['감사합니다','왔어요','대학교','이에요'], correct:'대학교', es:'¿Cómo es la universidad?', audio:'대학교 어때요?', explanation:'El patrón [sustantivo] + 어때요? pide opinión. Solo va con sustantivos, no con verbos.' },
  { id:'q006-g2', type:'grammar', step:'Step 006', prompt:'¿Cuál es la diferencia entre 마실래요? y 어때요?', options:['Son sinónimos — ambas piden opinión','어때요 invita a hacer algo, 마실래요 describe','마실래요 es formal, 어때요 informal','마실래요 invita a hacer algo, 어때요 pide opinión'], correct:'마실래요 invita a hacer algo, 어때요 pide opinión', explanation:'Clave del step006: -ㄹ래요 = propuesta de acción, 어때요 = consulta de opinión.' },
  { id:'q006-g3', type:'fill', step:'Step 006', prefix:'친절한 사람들', suffix:'많아요.', options:['는','가','도','을'], correct:'도', es:'Hay mucha gente amable también.', audio:'친절한 사람들', explanation:'도 adjuntado al sustantivo añade "también". 사람들도 많아요 = también hay mucha gente.' },
  { id:'q006-g4', type:'context', step:'Step 006', prompt:'Minsu pregunta "대학교 어때요?". ¿Cuál es la respuesta más natural y detallada?', options:['네, 주세요','아니에요, 없어요','감사합니다, 잘 지내요','좋아요! 친절한 사람들도 많아요'], correct:'좋아요! 친절한 사람들도 많아요', audio:'좋아요', explanation:'La respuesta natural da una opinión (좋아요) y añade un detalle con 도. ¡Así habla David!' },
  { id:'q006-g5', type:'context', step:'Step 006', prompt:'Eres David. Minsu dice "저는 민수예요." ¿Cómo te presentas?', options:['새로 왔어요?','저는 데이비드예요','저는 민수예요','커피 마실래요?'], correct:'저는 데이비드예요', audio:'저는 데이비드예요', explanation:'저는 [nombre]이에요/예요 — la fórmula de presentación. Nombre termina en vocal → 예요.' },

  // ── Integración cross-steps ───────────────────────────────────────────────
  { id:'q-cross-1', type:'context', step:'Steps 001–006', prompt:'Ves a alguien nuevo en el aula. ¿Cómo empiezas la conversación?', options:['커피 없어요','친절한 사람들이에요','안녕하세요! 새로 왔어요?','감사합니다, 많아요'], correct:'안녕하세요! 새로 왔어요?', audio:'안녕하세요', explanation:'La secuencia natural: saludo (안녕하세요) + pregunta de apertura (새로 왔어요?). ¡Así empieza la historia!' },
  { id:'q-cross-2', type:'es→kr', step:'Steps 001–006', prompt:'¿Qué partícula añade "también" a un sustantivo?', options:['는','가','를','도'], correct:'도', explanation:'도 = también, encima. Se adjunta directamente: 커피도, 사람들도, 대학교도. ¡Un must para el coreano natural!' },
  { id:'q-cross-3', type:'fill', step:'Steps 001–006', prefix:'저는 민수', suffix:'. 이름이 뭐예요?', options:['이에요','있어요','예요','어때요'], correct:'예요', es:'Soy Minsu. ¿Cómo te llamas?', audio:'저는 민수예요', explanation:'민수 termina en vocal (수) → 예요. Consonante → 이에요. Este contraste es esencial en coreano.' },
];
...
export default function SmartReview006({ onComplete }: Props) {
    ...
    return (
      <div style={{ ...base, padding:'28px 20px', textAlign:'center', display:'flex', flexDirection:'column', alignItems:'center', gap:18 }}>
        ...
        <p style={{ margin:0, fontSize:13, color:'var(--muted-foreground)', maxWidth:320, lineHeight:1.6 }}>
          Repasaste vocabulario y gramática de Steps 001 → 006 en una sola sesión. La circularidad es clave para la memoria.
        </p>
