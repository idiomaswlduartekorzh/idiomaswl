...
import { KR_VIDEO_004, KR_PODCAST_004, playAudio } from '@/lib/storage';

// Video y podcast vienen de storage.ts

/* ─── Chapter map (timestamps en segundos) ────────────────────────────────── */
interface Chapter { startSec: number; emoji: string; labelEs: string; videoKey?: keyof typeof KR_VIDEO_004 }
