...
const VOCAB: VocabItem[] = [
  { hangul: '새로',               rom: 'sae-ro',                      es: 'nuevo / recién llegado',    img: KR_IMG_004.saero_wasseoyo,       audio: '새로' },
  { hangul: '사람',               rom: 'sa-ram',                      es: 'persona / gente',           img: KR_IMG_004.saram,                audio: '사람' },
  { hangul: '새로 왔어요?',        rom: 'sae-ro wa-sseo-yo?',          es: '¿Eres nuevo/a?',            img: KR_IMG_004.classroom_meeting,    audio: '새로 왔어요?' },
  { hangul: '반갑습니다',          rom: 'ban-gap-seum-ni-da',          es: 'encantado/a de conocerte',  img: KR_IMG_004.hallway_introduction, audio: '반갑습니다' },
  { hangul: '저는 민수예요',        rom: 'jeo-neun min-su-ye-yo',       es: 'Soy Minsu',                 img: KR_IMG_004.classroom_meeting,    audio: '저는 민수예요' },
  { hangul: '콜롬비아 사람이에요',  rom: 'kol-lom-bi-a sa-ra-mi-e-yo', es: 'Soy colombiano/a',          img: KR_IMG_004.campus_arrival,       audio: '콜롬비아 사람이에요' },
  { hangul: '커피 마실래요?',      rom: 'keo-pi ma-sil-rae-yo?',       es: '¿Quieres tomar un café?',   img: KR_IMG_004.masilraeyo,           audio: '커피 마실래요?' },
  { hangul: '어때요?',             rom: 'eo-ttae-yo?',                 es: '¿Cómo es? / ¿Qué tal?',    img: KR_IMG_004.eottaeyo,             audio: '어때요?' },
  { hangul: '많아요',              rom: 'ma-na-yo',                    es: 'hay muchos/as / es mucho',  img: KR_IMG_004.campus_people,        audio: '많아요' },
  { hangul: '좋아요',              rom: 'jo-a-yo',                     es: 'está bien / me gusta',      img: KR_IMG_004.david_minsu_cafe,     audio: '좋아요' },
  ...
  { hangul: '있어요',     rom: 'i-sseo-yo',          es: 'hay / tiene / está', img: KR_IMG_004.campus_people, audio: '있어요', recycled: true },
];
