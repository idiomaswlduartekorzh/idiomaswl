    ...
    bubbles: [
      {
        ...
        words: [
          ...
          { kr: '어때요', rom: 'eo-ttae-yo', es: '¿cómo es? / ¿qué tal?', note: 'pregunta de opinión universal — patrón clave del step004' },
        ],
      },
      {
