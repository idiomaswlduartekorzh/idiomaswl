  ...
  return (
    <section className="wl-card" style={{ padding: '1.1rem', borderRadius: 8, marginTop: '1.2rem', borderTop: `3px solid ${accent}` }}>
      ...
      <h2 style={{ margin: '0 0 0.55rem', fontSize: '1.18rem', letterSpacing: 0 }}>
        Cómo revisamos esta habilidad de {skillName}
      </h2>
      <p style={{ margin: '0 0 0.85rem', color: 'var(--muted)', lineHeight: 1.65, fontSize: '0.9rem' }}>
        Este material fue preparado por el equipo académico de WeLearn y revisado en julio de 2026 para mantener separado el formato oficial de IELTS Reading de la estrategia pedagógica usada en esta página.
      </p>
      ...
      <p style={{ margin: '0.85rem 0 0', color: 'var(--muted)', lineHeight: 1.6, fontSize: '0.86rem' }}>
        Alcance: los ejercicios son originales de WeLearn y sirven para practicar lectura académica; no son preguntas oficiales de IELTS ni prometen una banda específica por sí solos.
      </p>
    </section>
  );
}
