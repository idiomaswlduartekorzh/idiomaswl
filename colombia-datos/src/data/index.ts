...
export const CONTEXT_EVENTS: ContextEvent[] = [
  ...
  {
    year: 2024,
    name: 'Reforma Pensional Petro aprobada',
    category: 'social',
    description: 'El Congreso aprueba la Reforma Pensional (Ley 2381 de 2024) en junio. Crea un sistema de pilares: solidario, semicontributivo y contributivo. Colpensiones manejará aportes hasta 3 SMMLV. Debate sobre impacto fiscal a largo plazo.',
    affectedIndicators: ['pobreza-extrema', 'gini'],
    impact: 'alto',
  },
  {
    year: 2024,
    name: 'Crisis fiscal y recorte presupuestal $23 billones',
    category: 'economico',
    description: 'El gobierno Petro recorta $23 billones COP del Presupuesto General de la Nación. El FMI alerta sobre la brecha fiscal. El déficit fiscal sube a −5.5% del PIB, el más alto desde la pandemia. La regla fiscal sigue suspendida.',
    affectedIndicators: ['deficit-fiscal', 'deuda-pib', 'pib-crecimiento'],
    impact: 'alto',
  },
  {
    year: 2024,
    name: 'Crisis del sistema de salud (ADRES y EPS)',
    category: 'social',
    description: 'La ADRES acumula deudas millonarias con hospitales y EPS. Varias EPS son intervenidas (Sanitas, Sura, Nueva EPS). La Reforma a la Salud de Petro es archivada en el Congreso. El sistema opera bajo tensión financiera estructural.',
    affectedIndicators: ['gasto-salud'],
    impact: 'alto',
  },
  {
    year: 2025,
    name: 'Banrep completa ciclo de recortes de tasas',
    category: 'economico',
    description: 'El Banco de la República recorta la tasa de interés de 13.25% a 7.25% entre 2023 y 2025, completando uno de los ciclos de flexibilización más agresivos en su historia. La inflación baja hacia el 4.9% anual. El crédito empieza a reactivarse.',
    affectedIndicators: ['pib-crecimiento', 'inflacion', 'desempleo', 'ied'],
    impact: 'alto',
  },
  {
    year: 2025,
    name: 'Reforma Laboral aprobada',
    category: 'social',
    description: 'El Congreso aprueba la Reforma Laboral de Petro en 2025 tras múltiples intentos fallidos. Incluye recargos nocturnos y dominicales más altos, eliminación del contrato por horas y mayores protecciones sindicales. Debate sobre impacto en informalidad y empleo formal.',
    affectedIndicators: ['desempleo', 'informalidad'],
    impact: 'medio',
  },
];
