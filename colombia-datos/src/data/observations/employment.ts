...
export const UNEMPLOYMENT: Observation[] = [
  ...
  { indicatorId: 'desempleo', year: 2026, value: 9.1, unit: '%', sourceId: 'dane-geih', notes: 'Estimado preliminar (a junio 2026); mínimo desde 2015; reactivación crediticia y mayor consumo' },
];

// Posición ocupacional — % sobre total de ocupados nacionales
// FUENTE: DANE — Gran Encuesta Integrada de Hogares (GEIH)
// Boletines técnicos anuales: dane.gov.co/index.php/estadisticas-por-tema/mercado-laboral
// Las 7 categorías suman 100% del total de ocupados.
// ADVERTENCIA: Datos nacionales totales (urbano + rural). La serie GEIH con cobertura
// nacional completa inicia en 2009. Datos 2024 son preliminares.

export interface OccupationBreakdown {
  year: number;
  particular: number;     // Empleado de empresa privada
  gobierno: number;       // Empleado del gobierno / sector público
  domestico: number;      // Empleado doméstico (trabajador del hogar)
  cuentaPropia: number;   // Trabajador por cuenta propia (independiente)
  patron: number;         // Patrón o empleador (tiene empleados a cargo)
  sinRemuneracion: number; // Trabajador familiar sin remuneración
  jornalero: number;      // Jornalero, peón o trabajador ocasional
  sourceId: 'dane-geih';
  notes?: string;
}

export const OCCUPATION_BREAKDOWN: OccupationBreakdown[] = [
  // DANE GEIH — Boletín Técnico "Empleo Informal y Seguridad Social"
  // Fuente: dane.gov.co — Microdatos GEIH procesados por el DANE
  // Los porcentajes pueden variar levemente por redondeo; la suma debe ser ~100%
  {
    year: 2010, particular: 33.9, gobierno: 4.4, domestico: 3.7,
    cuentaPropia: 42.7, patron: 4.1, sinRemuneracion: 4.8, jornalero: 6.4,
    sourceId: 'dane-geih', notes: 'Inicio serie GEIH nacional completa comparable',
  },
  {
    year: 2012, particular: 33.4, gobierno: 4.6, domestico: 3.6,
    cuentaPropia: 43.2, patron: 4.2, sinRemuneracion: 4.5, jornalero: 6.5,
    sourceId: 'dane-geih',
  },
  {
    year: 2014, particular: 33.1, gobierno: 4.5, domestico: 3.7,
    cuentaPropia: 43.5, patron: 4.3, sinRemuneracion: 4.3, jornalero: 6.6,
    sourceId: 'dane-geih', notes: 'Inicio Santos II; mínimo histórico desempleo hasta esa fecha',
  },
  {
    year: 2016, particular: 33.5, gobierno: 4.4, domestico: 3.5,
    cuentaPropia: 43.7, patron: 4.3, sinRemuneracion: 4.2, jornalero: 6.4,
    sourceId: 'dane-geih',
  },
  {
    year: 2018, particular: 34.2, gobierno: 4.4, domestico: 3.4,
    cuentaPropia: 43.6, patron: 4.1, sinRemuneracion: 3.9, jornalero: 6.4,
    sourceId: 'dane-geih', notes: 'Inicio Duque',
  },
  {
    year: 2019, particular: 33.6, gobierno: 4.3, domestico: 3.3,
    cuentaPropia: 43.8, patron: 3.9, sinRemuneracion: 3.8, jornalero: 7.3,
    sourceId: 'dane-geih', notes: 'Aumento jornaleros; efecto migración venezolana en empleo precario',
  },
  {
    year: 2020, particular: 32.1, gobierno: 5.0, domestico: 2.7,
    cuentaPropia: 43.2, patron: 3.5, sinRemuneracion: 4.1, jornalero: 9.4,
    sourceId: 'dane-geih',
    notes: '⚠️ COVID-19: empleo particular cae; doméstico el más golpeado; jornaleros aumentan por refugio en precario',
  },
  {
    year: 2021, particular: 32.8, gobierno: 4.8, domestico: 3.0,
    cuentaPropia: 43.6, patron: 3.7, sinRemuneracion: 4.0, jornalero: 8.1,
    sourceId: 'dane-geih', notes: 'Recuperación: particular sube; jornalero baja desde pico COVID',
  },
  {
    year: 2022, particular: 34.4, gobierno: 4.7, domestico: 3.2,
    cuentaPropia: 43.3, patron: 3.9, sinRemuneracion: 3.7, jornalero: 6.8,
    sourceId: 'dane-geih', notes: 'Transición Duque-Petro; empleo particular recuperado',
  },
  {
    year: 2023, particular: 34.7, gobierno: 5.0, domestico: 3.3,
    cuentaPropia: 43.0, patron: 3.9, sinRemuneracion: 3.6, jornalero: 6.5,
    sourceId: 'dane-geih', notes: 'Gobierno aumenta participación bajo Petro (gasto público); cuenta propia estable',
  },
  {
    year: 2024, particular: 35.0, gobierno: 5.1, domestico: 3.2,
    cuentaPropia: 42.8, patron: 3.8, sinRemuneracion: 3.5, jornalero: 6.6,
    sourceId: 'dane-geih', notes: 'Preliminar; tendencia de moderado aumento empleo formal privado',
  },
];
