...
const T = {
  ...
  3: { A: ['—', 'sin nombre'], B: ['—', 'sin nombre'], manda: ['—', 'poder igual, los dos anónimos'], fuera: ['Aníbal', 'H', '«Aníbal said in front of everybody that nobody pays for a shift here» — cambiado el 23 ago 2026 por fase13-conjunto MEDIO 5'], carta: ['el centro de examen', '—', '«Email · exam center»'], gana: ['—', 'acuerdo parcial'], culpa: ['A', 'A se examina el sábado que le toca abrir'] },
